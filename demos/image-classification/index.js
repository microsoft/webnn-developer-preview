...
log(
  '[Transformer.js] env.allowRemoteModels: ' +
    transformers.env.allowRemoteModels,
);
log(
  '[Transformer.js] env.allowLocalModels: ' + transformers.env.allowLocalModels,
);
if (transformers.env.allowLocalModels) {
  transformers.env.localModelPath = './models/';
  log(
    '[Transformer.js] env.localModelPath: ' + transformers.env.localModelPath,
  );
}
