...
`),q.push(A+`};
`),l=wi(q)(...te),y=`methodCaller<(${f.map(le=>le.name).join(", ")}) => ${_.name}>`,qr(It(y,l))},r:function(l,f){return f>>>=0,l=Qe(l>>>0),f=Qe(f),mt(l[f])},d:function(l){l>>>=0,9<l&&(Ae[l+1]+=1)},t:function(){return mt([])},l:function(l){l=Qe(l>>>0);for(var f=Array(l.length),y=0;y<l.length;y++)f[y]=l[y];return mt(f)},f:function(l){return mt(st(l>>>0))},k:function(){return mt({})},h:function(l){l>>>=0;for(var f=Qe(l);f.length;){var y=f.pop();f.pop()(y)}wr(l)},g:function(l,f,y){f>>>=0,y>>>=0,l=Qe(l>>>0),f=Qe(f),y=Qe(y),l[f]=y},c:function(l,f){return f>>>=0,l=_r(l>>>0,"_emval_take_value"),l=l.readValueFromPointer(f),mt(l)},X:function(l,f){l=-9007199254740992>l||9007199254740992<l?NaN:Number(l),f>>>=0,l=new Date(1e3*l),N[f>>>2>>>0]=l.getUTCSeconds(),N[f+4>>>2>>>0]=l.getUTCMinutes(),N[f+8>>>2>>>0]=l.getUTCHours(),N[f+12>>>2>>>0]=l.getUTCDate(),N[f+16>>>2>>>0]=l.getUTCMonth(),N[f+20>>>2>>>0]=l.getUTCFullYear()-1900,N[f+24>>>2>>>0]=l.getUTCDay(),N[f+28>>>2>>>0]=(l.getTime()-Date.UTC(l.getUTCFullYear(),0,1,0,0,0,0))/864e5|0},Y:function(l,f){l=-9007199254740992>l||9007199254740992<l?NaN:Number(l),f>>>=0,l=new Date(1e3*l),N[f>>>2>>>0]=l.getSeconds(),N[f+4>>>2>>>0]=l.getMinutes(),N[f+8>>>2>>>0]=l.getHours(),N[f+12>>>2>>>0]=l.getDate(),N[f+16>>>2>>>0]=l.getMonth(),N[f+20>>>2>>>0]=l.getFullYear()-1900,N[f+24>>>2>>>0]=l.getDay(),N[f+28>>>2>>>0]=(tt(l.getFullYear())?jr:Cr)[l.getMonth()]+l.getDate()-1|0,N[f+36>>>2>>>0]=-(60*l.getTimezoneOffset());var y=new Date(l.getFullYear(),6,1).getTimezoneOffset(),_=new Date(l.getFullYear(),0,1).getTimezoneOffset();N[f+32>>>2>>>0]=(y!=_&&l.getTimezoneOffset()==Math.min(_,y))|0},Z:function(l){l>>>=0;var f=new Date(N[l+20>>>2>>>0]+1900,N[l+16>>>2>>>0],N[l+12>>>2>>>0],N[l+8>>>2>>>0],N[l+4>>>2>>>0],N[l>>>2>>>0],0),y=N[l+32>>>2>>>0],_=f.getTimezoneOffset(),A=new Date(f.getFullYear(),6,1).getTimezoneOffset(),z=new Date(f.getFullYear(),0,1).getTimezoneOffset(),G=Math.min(z,A);return 0>y?N[l+32>>>2>>>0]=+(A!=z&&G==_):0<y!=(G==_)&&(A=Math.max(z,A),f.setTime(f.getTime()+6e4*((0<y?G:A)-_))),N[l+24>>>2>>>0]=f.getDay(),N[l+28>>>2>>>0]=(tt(f.getFullYear())?jr:Cr)[f.getMonth()]+f.getDate()-1|0,N[l>>>2>>>0]=f.getSeconds(),N[l+4>>>2>>>0]=f.getMinutes(),N[l+8>>>2>>>0]=f.getHours(),N[l+12>>>2>>>0]=f.getDate(),N[l+16>>>2>>>0]=f.getMonth(),N[l+20>>>2>>>0]=f.getYear(),l=f.getTime(),BigInt(isNaN(l)?-1:l/1e3)},V:function(){return-52},W:function(){},O:function(l,f,y,_){y>>>=0,_>>>=0;var A=new Date().getFullYear(),z=new Date(A,0,1),G=new Date(A,6,1);A=z.getTimezoneOffset();var q=G.getTimezoneOffset();se[l>>>0>>>2>>>0]=60*Math.max(A,q),N[f>>>0>>>2>>>0]=+(A!=q),l=te=>te.toLocaleTimeString(void 0,{hour12:!1,timeZoneName:"short"}).split(" ")[1],z=l(z),G=l(G),q<A?(ct(z,Y,y,17),ct(G,Y,_,17)):(ct(z,Y,_,17),ct(G,Y,y,17))},v:()=>{ne("")},e:function(l,f,y){return l>>>=0,f=Ir(f>>>0,y>>>0),Nt[l](...f)},I:function(l,f,y){return l>>>=0,f=Ir(f>>>0,y>>>0),Nt[l](...f)},H:()=>Date.now(),P:function(){return 4294901760},q:()=>performance.now(),N:function(l){l>>>=0;var f=Y.length;if(4294901760<l)return!1;for(var y=1;4>=y;y*=2){var _=f*(1+.2/y);_=Math.min(_,l+100663296);var A=Math;_=Math.max(l,_);e:{A=(A.min.call(A,4294901760,_+(65536-_%65536)%65536)-P.buffer.byteLength+65535)/65536;try{P.grow(A),Ie();var z=1;break e}catch{}z=void 0}if(z)return!0}return!1},aa:function(l,f){l>>>=0,f>>>=0;var y=0;return ut().forEach((_,A)=>{var z=f+y;for(A=se[l+4*A>>>2>>>0]=z,z=0;z<_.length;++z)V[A++>>>0]=_.charCodeAt(z);V[A>>>0]=0,y+=_.length+1}),0},ba:function(l,f){l>>>=0,f>>>=0;var y=ut();se[l>>>2>>>0]=y.length;var _=0;return y.forEach(A=>_+=A.length+1),se[f>>>2>>>0]=_,0},z:()=>52,F:function(){return 52},$:function(){return 70},E:function(l,f,y,_){f>>>=0,y>>>=0,_>>>=0;for(var A=0,z=0;z<y;z++){var G=se[f>>>2>>>0],q=se[f+4>>>2>>>0];f+=8;for(var te=0;te<q;te++){var Z=Y[G+te>>>0],le=$i[l];Z===0||Z===10?((l===1?E:k)(rr(le,0)),le.length=0):le.push(Z)}A+=q}return se[_>>>2>>>0]=A,0},ea:_n,p:function(l,f,y,_){return _n(l>>>0,f>>>0,y>>>0,_>>>0)}},pe=function(){function l(y){return pe=y.exports,pe=fn(),pe=Cn(),P=pe.ja,Ie(),oe.unshift(pe.ka),de--,de==0&&(je!==null&&(clearInterval(je),je=null),H&&(y=H,H=null,y())),pe}var f={a:xi};if(de++,r.instantiateWasm)try{return r.instantiateWasm(f,l)}catch(y){k(`Module.instantiateWasm callback failed with error: ${y}`),i(y)}return bt(f,function(y){l(y.instance)}).catch(i),{}}(),Yr=l=>(Yr=pe.la)(l);r._OrtInit=(l,f)=>(r._OrtInit=pe.ma)(l,f),r._OrtGetLastError=(l,f)=>(r._OrtGetLastError=pe.na)(l,f),r._OrtCreateSessionOptions=(l,f,y,_,A,z,G,q,te,Z)=>(r._OrtCreateSessionOptions=pe.oa)(l,f,y,_,A,z,G,q,te,Z),r._OrtAppendExecutionProvider=(l,f)=>(r._OrtAppendExecutionProvider=pe.pa)(l,f),r._OrtAddFreeDimensionOverride=(l,f,y)=>(r._OrtAddFreeDimensionOverride=pe.qa)(l,f,y),r._OrtAddSessionConfigEntry=(l,f,y)=>(r._OrtAddSessionConfigEntry=pe.ra)(l,f,y),r._OrtReleaseSessionOptions=l=>(r._OrtReleaseSessionOptions=pe.sa)(l),r._OrtCreateSession=(l,f,y)=>(r._OrtCreateSession=pe.ta)(l,f,y),r._OrtReleaseSession=l=>(r._OrtReleaseSession=pe.ua)(l),r._OrtGetInputOutputCount=(l,f,y)=>(r._OrtGetInputOutputCount=pe.va)(l,f,y),r._OrtGetInputName=(l,f)=>(r._OrtGetInputName=pe.wa)(l,f),r._OrtGetOutputName=(l,f)=>(r._OrtGetOutputName=pe.xa)(l,f),r._OrtFree=l=>(r._OrtFree=pe.ya)(l),r._OrtCreateTensor=(l,f,y,_,A,z)=>(r._OrtCreateTensor=pe.za)(l,f,y,_,A,z),r._OrtGetTensorData=(l,f,y,_,A)=>(r._OrtGetTensorData=pe.Aa)(l,f,y,_,A),r._OrtReleaseTensor=l=>(r._OrtReleaseTensor=pe.Ba)(l),r._OrtCreateRunOptions=(l,f,y,_)=>(r._OrtCreateRunOptions=pe.Ca)(l,f,y,_),r._OrtAddRunConfigEntry=(l,f,y)=>(r._OrtAddRunConfigEntry=pe.Da)(l,f,y),r._OrtReleaseRunOptions=l=>(r._OrtReleaseRunOptions=pe.Ea)(l),r._OrtCreateBinding=l=>(r._OrtCreateBinding=pe.Fa)(l),r._OrtBindInput=(l,f,y)=>(r._OrtBindInput=pe.Ga)(l,f,y),r._OrtBindOutput=(l,f,y,_)=>(r._OrtBindOutput=pe.Ha)(l,f,y,_),r._OrtClearBoundOutputs=l=>(r._OrtClearBoundOutputs=pe.Ia)(l),r._OrtReleaseBinding=l=>(r._OrtReleaseBinding=pe.Ja)(l),r._OrtRunWithBinding=(l,f,y,_,A)=>(r._OrtRunWithBinding=pe.Ka)(l,f,y,_,A),r._OrtRun=(l,f,y,_,A,z,G,q)=>(r._OrtRun=pe.La)(l,f,y,_,A,z,G,q),r._OrtEndProfiling=l=>(r._OrtEndProfiling=pe.Ma)(l),r._JsepOutput=(l,f,y)=>(r._JsepOutput=pe.Na)(l,f,y),r._JsepGetNodeName=l=>(r._JsepGetNodeName=pe.Oa)(l);var Kt=r._malloc=l=>(Kt=r._malloc=pe.Pa)(l),it=r._free=l=>(it=r._free=pe.Qa)(l),Ar=l=>(Ar=pe.Sa)(l),Er=l=>(Er=pe.Ta)(l),Xr=()=>(Xr=pe.Ua)(),sr=l=>(sr=pe.Wa)(l),Sn=()=>(Sn=pe.Xa)(),Tt=l=>(Tt=pe.Ya)(l),gt=()=>(gt=pe.Za)();r.___start_em_js=796944,r.___stop_em_js=797105;function Cn(){var l=pe;l=Object.assign({},l);var f=y=>_=>y(_)>>>0;return l.la=f(l.la),l.Pa=f(l.Pa),l.Ta=f(l.Ta),l.Ua=(y=>()=>y()>>>0)(l.Ua),l}r.stackSave=()=>Xr(),r.stackRestore=l=>Ar(l),r.stackAlloc=l=>Er(l),r.UTF8ToString=Ke,r.stringToUTF8=(l,f,y)=>ct(l,Y,f,y),r.lengthBytesUTF8=jt;var Ht;H=function l(){Ht||Zr(),Ht||(H=l)};function Zr(){if(!(0<de)){if(r.preRun)for(typeof r.preRun=="function"&&(r.preRun=[r.preRun]);r.preRun.length;){var l=r.preRun.shift();me.unshift(l)}for(;0<me.length;)me.shift()(r);if(!(0<de||Ht||(Ht=!0,r.calledRun=!0,R))){for(;0<oe.length;)oe.shift()(r);for(n(r);0<ue.length;)ue.shift()(r)}}}return Zr(),s}})();typeof Ba=="object"&&typeof Ni=="object"?Ni.exports=za:typeof define=="function"&&define.amd&&define([],()=>za)});var Ma=kr(()=>{});var Ua=kr(()=>{});var Wa={};lr(Wa,{cpus:()=>fc});var fc,Na=j(()=>{fc=void 0});var Ga=kr((Ha,Vi)=>{"use strict";var Va=(()=>{var e=typeof document<"u"?document.currentScript?.src:void 0;return typeof __filename<"u"&&(e||=__filename),function(t={}){function r(){return ae.buffer!=ue.buffer&&He(),ue}function n(){return ae.buffer!=ue.buffer&&He(),de}function i(){return ae.buffer!=ue.buffer&&He(),je}function s(){return ae.buffer!=ue.buffer&&He(),H}function a(){return ae.buffer!=ue.buffer&&He(),ne}function d(){return ae.buffer!=ue.buffer&&He(),Se}function c(){return ae.buffer!=ue.buffer&&He(),Ye}function m(){return ae.buffer!=ue.buffer&&He(),Ft}var u=t,g,b,$=new Promise((o,p)=>{g=o,b=p});u.mountExternalData=(o,p)=>{(u.Db||(u.Db=new Map)).set(o,p)},u.unmountExternalData=()=>{delete u.Db};let w=()=>{let o=(h,v,I)=>(...O)=>{let W=gt,F=v?.();O=h(...O);let re=v?.();return F!==re&&(h=re,I(F),v=I=null),gt!=W?A():O},p=h=>async(...v)=>{try{if(u.Cb)throw Error("Session already started");let I=u.Cb={ec:v[0],errors:[]},O=await h(...v);if(u.Cb!==I)throw Error("Session mismatch");u.Kb?.flush();let W=I.errors;if(0<W.length){let F=await Promise.all(W);if(F=F.filter(re=>re),0<F.length)throw Error(F.join(`
`))}return O}finally{u.Cb=null}};u._OrtCreateSession=o(u._OrtCreateSession,()=>u._OrtCreateSession,h=>u._OrtCreateSession=h),u._OrtRun=p(o(u._OrtRun,()=>u._OrtRun,h=>u._OrtRun=h)),u._OrtRunWithBinding=p(o(u._OrtRunWithBinding,()=>u._OrtRunWithBinding,h=>u._OrtRunWithBinding=h)),u._OrtBindInput=o(u._OrtBindInput,()=>u._OrtBindInput,h=>u._OrtBindInput=h),w=void 0};u.jsepInit=(o,p)=>{if(w?.(),o==="webgpu"){[u.Kb,u.Wb,u.$b,u.Lb,u.Zb,u.ob,u.ac,u.cc,u.Xb,u.Yb,u.bc]=p;let h=u.Kb;u.jsepRegisterBuffer=(v,I,O,W)=>h.registerBuffer(v,I,O,W),u.jsepGetBuffer=v=>h.getBuffer(v),u.jsepCreateDownloader=(v,I,O)=>h.createDownloader(v,I,O),u.jsepOnReleaseSession=v=>{h.onReleaseSession(v)},u.jsepOnRunStart=v=>h.onRunStart(v)}};var x=Object.assign({},u),C="./this.program",T=(o,p)=>{throw p},S=typeof window=="object",E=typeof importScripts=="function",k=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string",P=u.ENVIRONMENT_IS_PTHREAD||!1,R="";function L(o){return u.locateFile?u.locateFile(o,R):R+o}var V,Y,Q;if(k){var he=(Mi(),Yt(Di)),N=(Wi(),Yt(Ui));R=E?N.dirname(R)+"/":__dirname+"/",V=(o,p)=>(o=jt(o)?new URL(o):N.normalize(o),he.readFileSync(o,p?void 0:"utf8")),Q=o=>(o=V(o,!0),o.buffer||(o=new Uint8Array(o)),o),Y=(o,p,h,v=!0)=>{o=jt(o)?new URL(o):N.normalize(o),he.readFile(o,v?void 0:"utf8",(I,O)=>{I?h(I):p(v?O.buffer:O)})},!u.thisProgram&&1<process.argv.length&&(C=process.argv[1].replace(/\\/g,"/")),process.argv.slice(2),T=(o,p)=>{throw process.exitCode=o,p},global.Worker=Ma().Worker}else(S||E)&&(E?R=self.location.href:typeof document<"u"&&document.currentScript&&(R=document.currentScript.src),typeof e<"u"&&e&&(R=e),R.startsWith("blob:")?R="":R=R.substr(0,R.replace(/[?#].*/,"").lastIndexOf("/")+1),k||(V=o=>{var p=new XMLHttpRequest;return p.open("GET",o,!1),p.send(null),p.responseText},E&&(Q=o=>{var p=new XMLHttpRequest;return p.open("GET",o,!1),p.responseType="arraybuffer",p.send(null),new Uint8Array(p.response)}),Y=(o,p,h)=>{var v=new XMLHttpRequest;v.open("GET",o,!0),v.responseType="arraybuffer",v.onload=()=>{v.status==200||v.status==0&&v.response?p(v.response):h()},v.onerror=h,v.send(null)}));k&&typeof performance>"u"&&(global.performance=Ua().performance);var se=console.log.bind(console),Ce=console.error.bind(console);k&&(se=(...o)=>he.writeSync(1,o.join(" ")+`
`),Ce=(...o)=>he.writeSync(2,o.join(" ")+`
`));var Ve=se,ee=Ce;Object.assign(u,x),x=null;var ae,Ie,me=!1,oe,ue,de,je,H,ne,Se,Ye,Be,Ge,Ft;function He(){var o=ae.buffer;u.HEAP8=ue=new Int8Array(o),u.HEAP16=je=new Int16Array(o),u.HEAPU8=de=new Uint8Array(o),u.HEAPU16=H=new Uint16Array(o),u.HEAP32=ne=new Int32Array(o),u.HEAPU32=Se=new Uint32Array(o),u.HEAPF32=Ye=new Float32Array(o),u.HEAPF64=Ft=new Float64Array(o),u.HEAP64=Be=new BigInt64Array(o),u.HEAPU64=Ge=new BigUint64Array(o)}var Xe=16777216;if(P)ae=u.wasmMemory;else if(u.wasmMemory)ae=u.wasmMemory;else if(ae=new WebAssembly.Memory({initial:Xe/65536,maximum:65536,shared:!0}),!(ae.buffer instanceof SharedArrayBuffer))throw ee("requested a shared WebAssembly.Memory but the returned buffer is not a SharedArrayBuffer, indicating that while the browser has SharedArrayBuffer it does not have WebAssembly threads support - you may need to set a flag"),k&&ee("(on node you may need: --experimental-wasm-threads --experimental-wasm-bulk-memory and/or recent version)"),Error("bad memory");He(),Xe=ae.buffer.byteLength;var bt=[],Nt=[],er=[],qt=0,br=null,tr=null;function Dr(){if(qt--,qt==0&&(br!==null&&(clearInterval(br),br=null),tr)){var o=tr;tr=null,o()}}function rr(o){throw o="Aborted("+o+")",ee(o),me=!0,oe=1,o=new WebAssembly.RuntimeError(o+". Build with -sASSERTIONS for more info."),b(o),o}var Ke=o=>o.startsWith("data:application/octet-stream;base64,"),jt=o=>o.startsWith("file://"),ct;ct="ort-wasm-simd-threaded.wasm",Ke(ct)||(ct=L(ct));function Mr(o){if(Q)return Q(o);throw"both async and sync fetching of the wasm failed"}function vt(o){if(S||E){if(typeof fetch=="function"&&!jt(o))return fetch(o,{credentials:"same-origin"}).then(p=>{if(!p.ok)throw`failed to load wasm binary file at '${o}'`;return p.arrayBuffer()}).catch(()=>Mr(o));if(Y)return new Promise((p,h)=>{Y(o,v=>p(new Uint8Array(v)),h)})}return Promise.resolve().then(()=>Mr(o))}function vr(o,p,h){return vt(o).then(v=>WebAssembly.instantiate(v,p)).then(h,v=>{ee(`failed to asynchronously prepare wasm: ${v}`),rr(v)})}function Ur(o,p){var h=ct;return typeof WebAssembly.instantiateStreaming!="function"||Ke(h)||jt(h)||k||typeof fetch!="function"?vr(h,o,p):fetch(h,{credentials:"same-origin"}).then(v=>WebAssembly.instantiateStreaming(v,o).then(p,function(I){return ee(`wasm streaming compile failed: ${I}`),ee("falling back to ArrayBuffer instantiation"),vr(h,o,p)}))}var Wr={784732:(o,p,h,v)=>{if(typeof u>"u"||!u.Db)return 1;if(o=Le(o>>>0),o.startsWith("./")&&(o=o.substring(2)),o=u.Db.get(o),!o)return 2;if(p>>>=0,h>>>=0,v>>>=0,p+h>o.byteLength)return 3;try{return n().set(o.subarray(p,p+h),v>>>0),0}catch{return 4}},785233:()=>{u.Xb()},785264:()=>{u.Yb()},785293:()=>{u.bc()},785318:o=>u.Wb(o),785351:o=>u.$b(o),785383:(o,p,h)=>{u.Lb(o,p,h,!0)},785422:(o,p,h)=>{u.Lb(o,p,h)},785455:o=>{u.ob("Abs",o,void 0)},785506:o=>{u.ob("Neg",o,void 0)},785557:o=>{u.ob("Floor",o,void 0)},785610:o=>{u.ob("Ceil",o,void 0)},785662:o=>{u.ob("Reciprocal",o,void 0)},785720:o=>{u.ob("Sqrt",o,void 0)},785772:o=>{u.ob("Exp",o,void 0)},785823:o=>{u.ob("Erf",o,void 0)},785874:o=>{u.ob("Sigmoid",o,void 0)},785929:(o,p,h)=>{u.ob("HardSigmoid",o,{alpha:p,beta:h})},786008:o=>{u.ob("Log",o,void 0)},786059:o=>{u.ob("Sin",o,void 0)},786110:o=>{u.ob("Cos",o,void 0)},786161:o=>{u.ob("Tan",o,void 0)},786212:o=>{u.ob("Asin",o,void 0)},786264:o=>{u.ob("Acos",o,void 0)},786316:o=>{u.ob("Atan",o,void 0)},786368:o=>{u.ob("Sinh",o,void 0)},786420:o=>{u.ob("Cosh",o,void 0)},786472:o=>{u.ob("Asinh",o,void 0)},786525:o=>{u.ob("Acosh",o,void 0)},786578:o=>{u.ob("Atanh",o,void 0)},786631:o=>{u.ob("Tanh",o,void 0)},786683:o=>{u.ob("Not",o,void 0)},786734:(o,p,h)=>{u.ob("Clip",o,{min:p,max:h})},786803:o=>{u.ob("Clip",o,void 0)},786855:(o,p)=>{u.ob("Elu",o,{alpha:p})},786913:o=>{u.ob("Relu",o,void 0)},786965:(o,p)=>{u.ob("LeakyRelu",o,{alpha:p})},787029:(o,p)=>{u.ob("ThresholdedRelu",o,{alpha:p})},787099:(o,p)=>{u.ob("Cast",o,{to:p})},787157:o=>{u.ob("Add",o,void 0)},787208:o=>{u.ob("Sub",o,void 0)},787259:o=>{u.ob("Mul",o,void 0)},787310:o=>{u.ob("Div",o,void 0)},787361:o=>{u.ob("Pow",o,void 0)},787412:o=>{u.ob("Equal",o,void 0)},787465:o=>{u.ob("Greater",o,void 0)},787520:o=>{u.ob("GreaterOrEqual",o,void 0)},787582:o=>{u.ob("Less",o,void 0)},787634:o=>{u.ob("LessOrEqual",o,void 0)},787693:(o,p,h,v,I)=>{u.ob("ReduceMean",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},787852:(o,p,h,v,I)=>{u.ob("ReduceMax",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788010:(o,p,h,v,I)=>{u.ob("ReduceMin",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788168:(o,p,h,v,I)=>{u.ob("ReduceProd",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788327:(o,p,h,v,I)=>{u.ob("ReduceSum",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788485:(o,p,h,v,I)=>{u.ob("ReduceL1",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788642:(o,p,h,v,I)=>{u.ob("ReduceL2",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788799:(o,p,h,v,I)=>{u.ob("ReduceLogSum",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},788960:(o,p,h,v,I)=>{u.ob("ReduceSumSquare",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},789124:(o,p,h,v,I)=>{u.ob("ReduceLogSumExp",o,{keepDims:!!p,noopWithEmptyAxes:!!h,axes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},789288:o=>{u.ob("Where",o,void 0)},789341:(o,p,h)=>{u.ob("Transpose",o,{perm:p?Array.from(a().subarray(p>>>0,h>>>0)):[]})},789449:(o,p,h,v)=>{u.ob("DepthToSpace",o,{blocksize:p,mode:Le(h),format:v?"NHWC":"NCHW"})},789582:(o,p,h,v)=>{u.ob("DepthToSpace",o,{blocksize:p,mode:Le(h),format:v?"NHWC":"NCHW"})},789715:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve)=>{u.ob("ConvTranspose",o,{format:re?"NHWC":"NCHW",autoPad:p,dilations:[h],group:v,kernelShape:[I],pads:[O,W],strides:[F],wIsConst:()=>!!r()[J>>>0],outputPadding:ce?Array.from(a().subarray(ce>>>0,ze>>>0)):[],outputShape:Me?Array.from(a().subarray(Me>>>0,D>>>0)):[],activation:Le(ve)})},790116:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D)=>{u.ob("ConvTranspose",o,{format:F?"NHWC":"NCHW",autoPad:p,dilations:Array.from(a().subarray(h>>>0,(h>>>0)+2>>>0)),group:v,kernelShape:Array.from(a().subarray(I>>>0,(I>>>0)+2>>>0)),pads:Array.from(a().subarray(O>>>0,(O>>>0)+4>>>0)),strides:Array.from(a().subarray(W>>>0,(W>>>0)+2>>>0)),wIsConst:()=>!!r()[re>>>0],outputPadding:J?Array.from(a().subarray(J>>>0,ce>>>0)):[],outputShape:ze?Array.from(a().subarray(ze>>>0,Me>>>0)):[],activation:Le(D)})},790681:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve)=>{u.ob("ConvTranspose",o,{format:re?"NHWC":"NCHW",autoPad:p,dilations:[h],group:v,kernelShape:[I],pads:[O,W],strides:[F],wIsConst:()=>!!r()[J>>>0],outputPadding:ce?Array.from(a().subarray(ce>>>0,ze>>>0)):[],outputShape:Me?Array.from(a().subarray(Me>>>0,D>>>0)):[],activation:Le(ve)})},791082:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D)=>{u.ob("ConvTranspose",o,{format:F?"NHWC":"NCHW",autoPad:p,dilations:Array.from(a().subarray(h>>>0,(h>>>0)+2>>>0)),group:v,kernelShape:Array.from(a().subarray(I>>>0,(I>>>0)+2>>>0)),pads:Array.from(a().subarray(O>>>0,(O>>>0)+4>>>0)),strides:Array.from(a().subarray(W>>>0,(W>>>0)+2>>>0)),wIsConst:()=>!!r()[re>>>0],outputPadding:J?Array.from(a().subarray(J>>>0,ce>>>0)):[],outputShape:ze?Array.from(a().subarray(ze>>>0,Me>>>0)):[],activation:Le(D)})},791647:(o,p)=>{u.ob("GlobalAveragePool",o,{format:p?"NHWC":"NCHW"})},791738:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve,Oe)=>{u.ob("AveragePool",o,{format:Oe?"NHWC":"NCHW",auto_pad:p,ceil_mode:h,count_include_pad:v,storage_order:I,dilations:[O,W],kernel_shape:[F,re],pads:[J,ce,ze,Me],strides:[D,ve]})},792022:(o,p)=>{u.ob("GlobalAveragePool",o,{format:p?"NHWC":"NCHW"})},792113:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve,Oe)=>{u.ob("AveragePool",o,{format:Oe?"NHWC":"NCHW",auto_pad:p,ceil_mode:h,count_include_pad:v,storage_order:I,dilations:[O,W],kernel_shape:[F,re],pads:[J,ce,ze,Me],strides:[D,ve]})},792397:(o,p)=>{u.ob("GlobalMaxPool",o,{format:p?"NHWC":"NCHW"})},792484:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve,Oe)=>{u.ob("MaxPool",o,{format:Oe?"NHWC":"NCHW",auto_pad:p,ceil_mode:h,count_include_pad:v,storage_order:I,dilations:[O,W],kernel_shape:[F,re],pads:[J,ce,ze,Me],strides:[D,ve]})},792764:(o,p)=>{u.ob("GlobalMaxPool",o,{format:p?"NHWC":"NCHW"})},792851:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve,Oe)=>{u.ob("MaxPool",o,{format:Oe?"NHWC":"NCHW",auto_pad:p,ceil_mode:h,count_include_pad:v,storage_order:I,dilations:[O,W],kernel_shape:[F,re],pads:[J,ce,ze,Me],strides:[D,ve]})},793131:(o,p,h,v,I)=>{u.ob("Gemm",o,{alpha:p,beta:h,transA:v,transB:I})},793235:o=>{u.ob("MatMul",o,void 0)},793289:(o,p,h,v)=>{u.ob("ArgMax",o,{keepDims:!!p,selectLastIndex:!!h,axis:v})},793397:(o,p,h,v)=>{u.ob("ArgMin",o,{keepDims:!!p,selectLastIndex:!!h,axis:v})},793505:(o,p)=>{u.ob("Softmax",o,{axis:p})},793568:(o,p)=>{u.ob("Concat",o,{axis:p})},793628:(o,p,h,v,I)=>{u.ob("Split",o,{axis:p,numOutputs:h,splitSizes:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},793768:o=>{u.ob("Expand",o,void 0)},793822:(o,p)=>{u.ob("Gather",o,{axis:Number(p)})},793893:(o,p)=>{u.ob("GatherElements",o,{axis:Number(p)})},793972:(o,p,h,v,I,O,W,F,re,J,ce)=>{u.ob("Resize",o,{antialias:p,axes:h?Array.from(a().subarray(h>>>0,v>>>0)):[],coordinateTransformMode:Le(I),cubicCoeffA:O,excludeOutside:W,extrapolationValue:F,keepAspectRatioPolicy:Le(re),mode:Le(J),nearestMode:Le(ce)})},794318:(o,p,h,v,I,O,W)=>{u.ob("Slice",o,{starts:p?Array.from(a().subarray(p>>>0,h>>>0)):[],ends:v?Array.from(a().subarray(v>>>0,I>>>0)):[],axes:O?Array.from(a().subarray(O>>>0,W>>>0)):[]})},794534:o=>{u.ob("Tile",o,void 0)},794586:(o,p,h,v)=>{u.ob("LayerNormalization",o,{axis:p,epsilon:h,simplified:!!v})},794697:(o,p,h)=>{u.ob("InstanceNormalization",o,{epsilon:p,format:h?"NHWC":"NCHW"})},794811:(o,p,h)=>{u.ob("InstanceNormalization",o,{epsilon:p,format:h?"NHWC":"NCHW"})},794925:o=>{u.ob("Range",o,void 0)},794978:(o,p)=>{u.ob("Einsum",o,{equation:Le(p)})},795059:(o,p,h,v,I)=>{u.ob("Pad",o,{mode:p,value:h,pads:v?Array.from(a().subarray(v>>>0,I>>>0)):[]})},795186:(o,p,h,v,I,O)=>{u.ob("BatchNormalization",o,{epsilon:p,momentum:h,spatial:!!I,trainingMode:!!v,format:O?"NHWC":"NCHW"})},795355:(o,p,h,v,I,O)=>{u.ob("BatchNormalization",o,{epsilon:p,momentum:h,spatial:!!I,trainingMode:!!v,format:O?"NHWC":"NCHW"})},795524:(o,p,h)=>{u.ob("CumSum",o,{exclusive:Number(p),reverse:Number(h)})},795621:(o,p,h,v,I,O,W,F,re)=>{u.ob("Attention",o,{numHeads:p,isUnidirectional:h,maskFilterValue:v,scale:I,doRotary:O,qkvHiddenSizes:W?Array.from(a().subarray(Number(F)>>>0,Number(F)+W>>>0)):[],pastPresentShareBuffer:!!re})},795893:o=>{u.ob("BiasAdd",o,void 0)},795948:o=>{u.ob("BiasSplitGelu",o,void 0)},796009:o=>{u.ob("FastGelu",o,void 0)},796065:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me)=>{u.ob("Conv",o,{format:re?"NHWC":"NCHW",auto_pad:p,dilations:[h],group:v,kernel_shape:[I],pads:O?Array.from(a().subarray(O>>>0,W>>>0)):[],strides:[F],w_is_const:()=>!!r()[J>>>0],activation:Le(ce),activation_params:ze?Array.from(c().subarray(ze>>>0,Me>>>0)):[]})},796435:(o,p,h,v,I,O,W,F,re,J,ce,ze,Me,D,ve,Oe)=>{u.ob("Conv",o,{format:ze?"NHWC":"NCHW",auto_pad:p,dilations:[h,v],group:I,kernel_shape:[O,W],pads:F?Array.from(a().subarray(F>>>0,re>>>0)):[],strides:[J,ce],w_is_const:()=>!!r()[Me>>>0],activation:Le(D),activation_params:ve?Array.from(c().subarray(ve>>>0,Oe>>>0)):[]})},796826:o=>{u.ob("Gelu",o,void 0)},796878:(o,p,h,v,I,O)=>{u.ob("MatMulNBits",o,{k:p,n:h,accuracyLevel:v,bits:I,blockSize:O})},797005:(o,p,h,v,I,O)=>{u.ob("MultiHeadAttention",o,{numHeads:p,isUnidirectional:h,maskFilterValue:v,scale:I,doRotary:O})},797164:(o,p,h,v,I)=>{u.ob("RotaryEmbedding",o,{interleaved:!!p,numHeads:h,rotaryEmbeddingDim:v,scale:I})},797303:(o,p,h)=>{u.ob("SkipLayerNormalization",o,{epsilon:p,simplified:!!h})},797405:(o,p,h)=>{u.ob("SkipLayerNormalization",o,{epsilon:p,simplified:!!h})},797507:(o,p,h,v)=>{u.ob("LayerNormalization",o,{axis:p,epsilon:h,simplified:!!v})},797618:o=>{u.ac(o)},797652:(o,p)=>u.cc(o,p,u.Cb.ec,u.Cb.errors)};function pt(o){this.name="ExitStatus",this.message=`Program terminated with exit(${o})`,this.status=o}var Nr=o=>{o.terminate(),o.onmessage=()=>{}},wt=o=>{ge.xb.length==0&&($r(),ge.Mb(ge.xb[0]));var p=ge.xb.pop();if(!p)return 6;ge.yb.push(p),ge.ub[o.wb]=p,p.wb=o.wb;var h={cmd:"run",start_routine:o.fc,arg:o.Rb,pthread_ptr:o.wb};return k&&p.unref(),p.postMessage(h,o.mc),0},Ct=0,Vr=o=>{var p=ki();return o=o(),En(p),o},Ae=(o,p,...h)=>Vr(()=>{for(var v=2*h.length,I=Ei(8*v),O=I>>>3,W=0;W<h.length;W++){var F=h[W];typeof F=="bigint"?(Be[O+2*W]=1n,Be[O+2*W+1]=F):(Be[O+2*W]=0n,m()[O+2*W+1>>>0]=F)}return qo(o,0,v,I,p)});function wr(o){if(P)return Ae(0,1,o);oe=o,0<Ct||(ge.hc(),u.onExit?.(o),me=!0),T(o,new pt(o))}var Qe=o=>{if(oe=o,P)throw ln(o),"unwind";wr(o)};function mt(){for(var o=u.numThreads;o--;)$r();bt.unshift(()=>{qt++,gi(()=>Dr())})}function $r(){var o=L("ort-wasm-simd-threaded.worker.js");o=new Worker(o),ge.xb.push(o)}function gi(o){P?o():Promise.all(ge.xb.map(ge.Mb)).then(o)}var ge={xb:[],yb:[],Qb:[],ub:{},Gb(){P?(ge.receiveObjectTransfer=ge.dc,ge.threadInitTLS=ge.Pb,ge.setExitStatus=ge.Ob):mt()},Ob:o=>oe=o,pc:["$terminateWorker"],hc:()=>{for(var o of ge.yb)Nr(o);for(o of ge.xb)Nr(o);ge.xb=[],ge.yb=[],ge.ub=[]},Nb:o=>{var p=o.wb;delete ge.ub[p],ge.xb.push(o),ge.yb.splice(ge.yb.indexOf(o),1),o.wb=0,Ti(p)},dc(){},Pb(){ge.Qb.forEach(o=>o())},Mb:o=>new Promise(p=>{o.onmessage=O=>{O=O.data;var W=O.cmd;if(O.targetThread&&O.targetThread!=Tn()){var F=ge.ub[O.targetThread];F?F.postMessage(O,O.transferList):ee(`Internal error! Worker sent a message "${W}" to target pthread ${O.targetThread}, but that thread no longer exists!`)}else W==="checkMailbox"?it():W==="spawnThread"?wt(O):W==="cleanupThread"?ge.Nb(ge.ub[O.thread]):W==="killThread"?(O=O.thread,W=ge.ub[O],delete ge.ub[O],Nr(W),Ti(O),ge.yb.splice(ge.yb.indexOf(W),1),W.wb=0):W==="cancelThread"?ge.ub[O.thread].postMessage({cmd:"cancel"}):W==="loaded"?(o.loaded=!0,k&&!o.wb&&o.unref(),p(o)):W==="alert"?alert(`Thread ${O.threadId}: ${O.text}`):O.target==="setimmediate"?o.postMessage(O):W==="callHandler"?u[O.handler](...O.args):W&&ee(`worker sent an unknown command ${W}`)},o.onerror=O=>{throw ee(`worker sent an error! ${O.filename}:${O.lineno}: ${O.message}`),O},k&&(o.on("message",O=>o.onmessage({data:O})),o.on("error",O=>o.onerror(O)));var h=[],v=["onExit"],I;for(I of v)u.hasOwnProperty(I)&&h.push(I);o.postMessage({cmd:"load",handlers:h,urlOrBlob:u.mainScriptUrlOrBlob||e,wasmMemory:ae,wasmModule:Ie})})};u.PThread=ge;var nr=o=>{for(;0<o.length;)o.shift()(u)};u.establishStackSpace=()=>{var o=Tn(),p=d()[o+52>>>2>>>0];o=d()[o+56>>>2>>>0],Ko(p,p-o),En(p)};function ln(o){if(P)return Ae(1,0,o);Qe(o)}u.invokeEntryPoint=(o,p)=>{Ct=0,o=Yo(o,p),0<Ct?ge.Ob(o):Ai(o)};class yi{constructor(p){this.Ib=p-24}Gb(p,h){d()[this.Ib+16>>>2>>>0]=0,d()[this.Ib+4>>>2>>>0]=p,d()[this.Ib+8>>>2>>>0]=h}}var dn=0,bi=0;function cn(o,p,h,v){return P?Ae(2,1,o,p,h,v):pn(o,p,h,v)}function pn(o,p,h,v){if(o>>>=0,p>>>=0,h>>>=0,v>>>=0,typeof SharedArrayBuffer>"u")return ee("Current environment does not support SharedArrayBuffer, pthreads are not available!"),6;var I=[];return P&&I.length===0?cn(o,p,h,v):(o={fc:h,wb:o,Rb:v,mc:I},P?(o.oc="spawnThread",postMessage(o,I),0):wt(o))}var _r=typeof TextDecoder<"u"?new TextDecoder("utf8"):void 0,Hr=(o,p,h)=>{p>>>=0;var v=p+h;for(h=p;o[h]&&!(h>=v);)++h;if(16<h-p&&o.buffer&&_r)return _r.decode(o.buffer instanceof SharedArrayBuffer?o.slice(p,h):o.subarray(p,h));for(v="";p<h;){var I=o[p++];if(I&128){var O=o[p++]&63;if((I&224)==192)v+=String.fromCharCode((I&31)<<6|O);else{var W=o[p++]&63;I=(I&240)==224?(I&15)<<12|O<<6|W:(I&7)<<18|O<<12|W<<6|o[p++]&63,65536>I?v+=String.fromCharCode(I):(I-=65536,v+=String.fromCharCode(55296|I>>10,56320|I&1023))}}else v+=String.fromCharCode(I)}return v},Le=(o,p)=>(o>>>=0)?Hr(n(),o,p):"";function mn(o,p,h){return P?Ae(3,1,o,p,h):0}function fn(o,p){if(P)return Ae(4,1,o,p)}var $t=o=>{for(var p=0,h=0;h<o.length;++h){var v=o.charCodeAt(h);127>=v?p++:2047>=v?p+=2:55296<=v&&57343>=v?(p+=4,++h):p+=3}return p},ft=(o,p,h,v)=>{if(h>>>=0,!(0<v))return 0;var I=h;v=h+v-1;for(var O=0;O<o.length;++O){var W=o.charCodeAt(O);if(55296<=W&&57343>=W){var F=o.charCodeAt(++O);W=65536+((W&1023)<<10)|F&1023}if(127>=W){if(h>=v)break;p[h++>>>0]=W}else{if(2047>=W){if(h+1>=v)break;p[h++>>>0]=192|W>>6}else{if(65535>=W){if(h+2>=v)break;p[h++>>>0]=224|W>>12}else{if(h+3>=v)break;p[h++>>>0]=240|W>>18,p[h++>>>0]=128|W>>12&63}p[h++>>>0]=128|W>>6&63}p[h++>>>0]=128|W&63}}return p[h>>>0]=0,h-I},Vt=(o,p,h)=>ft(o,n(),p,h);function ir(o,p){if(P)return Ae(5,1,o,p)}function Gr(o,p,h){if(P)return Ae(6,1,o,p,h)}function Lr(o,p,h){return P?Ae(7,1,o,p,h):0}function hn(o,p){if(P)return Ae(8,1,o,p)}function xr(o,p,h){if(P)return Ae(9,1,o,p,h)}function gn(o,p,h,v){if(P)return Ae(10,1,o,p,h,v)}function yn(o,p,h,v){if(P)return Ae(11,1,o,p,h,v)}function bn(o,p,h,v){if(P)return Ae(12,1,o,p,h,v)}function vn(o){if(P)return Ae(13,1,o)}function Fr(o,p){if(P)return Ae(14,1,o,p)}function or(o,p,h){if(P)return Ae(15,1,o,p,h)}var wn,st=o=>{for(var p="";n()[o>>>0];)p+=wn[n()[o++>>>0]];return p},Sr={},qr={},vi={},It;function wi(o,p,h={}){var v=p.name;if(!o)throw new It(`type "${v}" must have a positive integer typeid pointer`);if(qr.hasOwnProperty(o)){if(h.Ub)return;throw new It(`Cannot register type '${v}' twice`)}qr[o]=p,delete vi[o],Sr.hasOwnProperty(o)&&(p=Sr[o],delete Sr[o],p.forEach(I=>I()))}function tt(o,p,h={}){if(!("argPackAdvance"in p))throw new TypeError("registerType registeredInstance requires argPackAdvance");return wi(o,p,h)}var jr=(o,p,h)=>{switch(p){case 1:return h?v=>r()[v>>>0]:v=>n()[v>>>0];case 2:return h?v=>i()[v>>>1>>>0]:v=>s()[v>>>1>>>0];case 4:return h?v=>a()[v>>>2>>>0]:v=>d()[v>>>2>>>0];case 8:return h?v=>Be[v>>>3]:v=>Ge[v>>>3];default:throw new TypeError(`invalid integer width (${p}): ${o}`)}},Cr=[],ht=[];function Ir(o){o>>>=0,9<o&&--ht[o+1]===0&&(ht[o]=void 0,Cr.push(o))}var Je=o=>{if(!o)throw new It("Cannot use deleted val. handle = "+o);return ht[o]},ut=o=>{switch(o){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:let p=Cr.pop()||ht.length;return ht[p]=o,ht[p+1]=1,p}};function ar(o){return this.fromWireType(d()[o>>>2>>>0])}var $i={name:"emscripten::val",fromWireType:o=>{var p=Je(o);return Ir(o),p},toWireType:(o,p)=>ut(p),argPackAdvance:8,readValueFromPointer:ar,Bb:null},$n=(o,p)=>{switch(p){case 4:return function(h){return this.fromWireType(c()[h>>>2>>>0])};case 8:return function(h){return this.fromWireType(m()[h>>>3>>>0])};default:throw new TypeError(`invalid float width (${p}): ${o}`)}},Kr=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,_i=(o,p)=>{for(var h=o>>1,v=h+p/2;!(h>=v)&&s()[h>>>0];)++h;if(h<<=1,32<h-o&&Kr)return Kr.decode(n().slice(o,h));for(h="",v=0;!(v>=p/2);++v){var I=i()[o+2*v>>>1>>>0];if(I==0)break;h+=String.fromCharCode(I)}return h},_n=(o,p,h)=>{if(h??=2147483647,2>h)return 0;h-=2;var v=p;h=h<2*o.length?h/2:o.length;for(var I=0;I<h;++I){var O=o.charCodeAt(I);i()[p>>>1>>>0]=O,p+=2}return i()[p>>>1>>>0]=0,p-v},xn=o=>2*o.length,Tr=(o,p)=>{for(var h=0,v="";!(h>=p/4);){var I=a()[o+4*h>>>2>>>0];if(I==0)break;++h,65536<=I?(I-=65536,v+=String.fromCharCode(55296|I>>10,56320|I&1023)):v+=String.fromCharCode(I)}return v},xi=(o,p,h)=>{if(p>>>=0,h??=2147483647,4>h)return 0;var v=p;h=v+h-4;for(var I=0;I<o.length;++I){var O=o.charCodeAt(I);if(55296<=O&&57343>=O){var W=o.charCodeAt(++I);O=65536+((O&1023)<<10)|W&1023}if(a()[p>>>2>>>0]=O,p+=4,p+4>h)break}return a()[p>>>2>>>0]=0,p-v},pe=o=>{for(var p=0,h=0;h<o.length;++h){var v=o.charCodeAt(h);55296<=v&&57343>=v&&++h,p+=4}return p},Yr=o=>{if(!me)try{if(o(),!(0<Ct))try{P?Ai(oe):Qe(oe)}catch(p){p instanceof pt||p=="unwind"||T(1,p)}}catch(p){p instanceof pt||p=="unwind"||T(1,p)}};function Kt(o){o>>>=0,typeof Atomics.nc=="function"&&(Atomics.nc(a(),o>>>2,o).value.then(it),o+=128,Atomics.store(a(),o>>>2,1))}u.__emscripten_thread_mailbox_await=Kt;var it=()=>{var o=Tn();o&&(Kt(o),Yr(jo))};u.checkMailbox=it;var Ar=[],Er=(o,p)=>{var h=qr[o];if(h===void 0)throw o=Lo(o),h=st(o),Rt(o),new It(`${p} has unknown type ${h}`);return h},Xr=(o,p,h)=>{var v=[];return o=o.toWireType(v,h),v.length&&(d()[p>>>2>>>0]=ut(v)),o},sr=o=>{try{o()}catch(p){rr(p)}};function Sn(){var o=ie,p={};for(let[h,v]of Object.entries(o))p[h]=typeof v=="function"?(...I)=>{Ht.push(h);try{return v(...I)}finally{me||(Ht.pop(),gt&&Tt===1&&Ht.length===0&&(Tt=0,Ct+=1,sr(Zo),typeof Fibers<"u"&&Fibers.rc()))}}:v;return p}var Tt=0,gt=null,Cn=0,Ht=[],Zr={},l={},f=0,y=null,_=[];function A(){return new Promise((o,p)=>{y={resolve:o,reject:p}})}function z(){var o=An(65548),p=o+12;d()[o>>>2>>>0]=p,d()[o+4>>>2>>>0]=p+65536,p=Ht[0];var h=Zr[p];return h===void 0&&(h=f++,Zr[p]=h,l[h]=p),p=h,a()[o+8>>>2>>>0]=p,o}function G(){var o=a()[gt+8>>>2>>>0];return o=ie[l[o]],--Ct,o()}function q(o){if(!me){if(Tt===0){var p=!1,h=!1;o((v=0)=>{if(!me&&(Cn=v,p=!0,h)){Tt=2,sr(()=>Qo(gt)),typeof Browser<"u"&&Browser.Hb.Tb&&Browser.Hb.resume(),v=!1;try{var I=G()}catch(F){I=F,v=!0}var O=!1;if(!gt){var W=y;W&&(y=null,(v?W.reject:W.resolve)(I),O=!0)}if(v&&!O)throw I}}),h=!0,p||(Tt=1,gt=z(),typeof Browser<"u"&&Browser.Hb.Tb&&Browser.Hb.pause(),sr(()=>Xo(gt)))}else Tt===2?(Tt=0,sr(Jo),Rt(gt),gt=null,_.forEach(Yr)):rr(`invalid state: ${Tt}`);return Cn}}function te(o){return q(p=>{o().then(p)})}var Z=[],le={},Ee=o=>{var p=le[o];return p===void 0?st(o):p},Re=()=>typeof globalThis=="object"?globalThis:Function("return this")(),B=o=>{var p=Z.length;return Z.push(o),p},be=(o,p)=>{for(var h=Array(o),v=0;v<o;++v)h[v]=Er(d()[p+4*v>>>2>>>0],"parameter "+v);return h},Te=(o,p)=>Object.defineProperty(p,"name",{value:o});function Gt(o){var p=Function;if(!(p instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof p} which is not a function`);var h=Te(p.name||"unknownFunctionName",function(){});return h.prototype=p.prototype,h=new h,o=p.apply(h,o),o instanceof Object?o:h}var Lt=o=>o%4===0&&(o%100!==0||o%400===0),Ao=[0,31,60,91,121,152,182,213,244,274,305,335],Eo=[0,31,59,90,120,151,181,212,243,273,304,334];function ko(o,p,h,v,I,O,W){return P?Ae(16,1,o,p,h,v,I,O,W):-52}function Oo(o,p,h,v,I,O){if(P)return Ae(17,1,o,p,h,v,I,O)}var Si=[],Po=(o,p)=>{Si.length=0;for(var h;h=n()[o++>>>0];){var v=h!=105;v&=h!=112,p+=v&&p%8?4:0,Si.push(h==112?d()[p>>>2>>>0]:h==106?Be[p>>>3]:h==105?a()[p>>>2>>>0]:m()[p>>>3>>>0]),p+=v?8:4}return Si},Ci={},Ro=()=>{if(!Ii){var o={USER:"web_user",LOGNAME:"web_user",PATH:"/",PWD:"/",HOME:"/home/web_user",LANG:(typeof navigator=="object"&&navigator.languages&&navigator.languages[0]||"C").replace("-","_")+".UTF-8",_:C||"./this.program"},p;for(p in Ci)Ci[p]===void 0?delete o[p]:o[p]=Ci[p];var h=[];for(p in o)h.push(`${p}=${o[p]}`);Ii=h}return Ii},Ii;function zo(o,p){if(P)return Ae(18,1,o,p);o>>>=0,p>>>=0;var h=0;return Ro().forEach((v,I)=>{var O=p+h;for(I=d()[o+4*I>>>2>>>0]=O,O=0;O<v.length;++O)r()[I++>>>0]=v.charCodeAt(O);r()[I>>>0]=0,h+=v.length+1}),0}function Bo(o,p){if(P)return Ae(19,1,o,p);o>>>=0,p>>>=0;var h=Ro();d()[o>>>2>>>0]=h.length;var v=0;return h.forEach(I=>v+=I.length+1),d()[p>>>2>>>0]=v,0}function Do(o){return P?Ae(20,1,o):52}function Mo(o,p,h,v){return P?Ae(21,1,o,p,h,v):52}function Uo(o,p,h,v){return P?Ae(22,1,o,p,h,v):70}var Jd=[null,[],[]];function Wo(o,p,h,v){if(P)return Ae(23,1,o,p,h,v);p>>>=0,h>>>=0,v>>>=0;for(var I=0,O=0;O<h;O++){var W=d()[p>>>2>>>0],F=d()[p+4>>>2>>>0];p+=8;for(var re=0;re<F;re++){var J=n()[W+re>>>0],ce=Jd[o];J===0||J===10?((o===1?Ve:ee)(Hr(ce,0)),ce.length=0):ce.push(J)}I+=F}return d()[v>>>2>>>0]=I,0}var No=[31,29,31,30,31,30,31,31,30,31,30,31],Vo=[31,28,31,30,31,30,31,31,30,31,30,31];function ec(o){var p=Array($t(o)+1);return ft(o,p,0,p.length),p}var tc=(o,p)=>{r().set(o,p>>>0)};function Ho(o,p,h,v){function I(D,ve,Oe){for(D=typeof D=="number"?D.toString():D||"";D.length<ve;)D=Oe[0]+D;return D}function O(D,ve){return I(D,ve,"0")}function W(D,ve){function Oe(ta){return 0>ta?-1:0<ta?1:0}var ur;return(ur=Oe(D.getFullYear()-ve.getFullYear()))===0&&(ur=Oe(D.getMonth()-ve.getMonth()))===0&&(ur=Oe(D.getDate()-ve.getDate())),ur}function F(D){switch(D.getDay()){case 0:return new Date(D.getFullYear()-1,11,29);case 1:return D;case 2:return new Date(D.getFullYear(),0,3);case 3:return new Date(D.getFullYear(),0,2);case 4:return new Date(D.getFullYear(),0,1);case 5:return new Date(D.getFullYear()-1,11,31);case 6:return new Date(D.getFullYear()-1,11,30)}}function re(D){var ve=D.zb;for(D=new Date(new Date(D.Ab+1900,0,1).getTime());0<ve;){var Oe=D.getMonth(),ur=(Lt(D.getFullYear())?No:Vo)[Oe];if(ve>ur-D.getDate())ve-=ur-D.getDate()+1,D.setDate(1),11>Oe?D.setMonth(Oe+1):(D.setMonth(0),D.setFullYear(D.getFullYear()+1));else{D.setDate(D.getDate()+ve);break}}return Oe=new Date(D.getFullYear()+1,0,4),ve=F(new Date(D.getFullYear(),0,4)),Oe=F(Oe),0>=W(ve,D)?0>=W(Oe,D)?D.getFullYear()+1:D.getFullYear():D.getFullYear()-1}o>>>=0,p>>>=0,h>>>=0,v>>>=0;var J=d()[v+40>>>2>>>0];v={kc:a()[v>>>2>>>0],jc:a()[v+4>>>2>>>0],Eb:a()[v+8>>>2>>>0],Jb:a()[v+12>>>2>>>0],Fb:a()[v+16>>>2>>>0],Ab:a()[v+20>>>2>>>0],vb:a()[v+24>>>2>>>0],zb:a()[v+28>>>2>>>0],qc:a()[v+32>>>2>>>0],ic:a()[v+36>>>2>>>0],lc:J?Le(J):""},h=Le(h),J={"%c":"%a %b %d %H:%M:%S %Y","%D":"%m/%d/%y","%F":"%Y-%m-%d","%h":"%b","%r":"%I:%M:%S %p","%R":"%H:%M","%T":"%H:%M:%S","%x":"%m/%d/%y","%X":"%H:%M:%S","%Ec":"%c","%EC":"%C","%Ex":"%m/%d/%y","%EX":"%H:%M:%S","%Ey":"%y","%EY":"%Y","%Od":"%d","%Oe":"%e","%OH":"%H","%OI":"%I","%Om":"%m","%OM":"%M","%OS":"%S","%Ou":"%u","%OU":"%U","%OV":"%V","%Ow":"%w","%OW":"%W","%Oy":"%y"};for(var ce in J)h=h.replace(new RegExp(ce,"g"),J[ce]);var ze="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),Me="January February March April May June July August September October November December".split(" ");J={"%a":D=>ze[D.vb].substring(0,3),"%A":D=>ze[D.vb],"%b":D=>Me[D.Fb].substring(0,3),"%B":D=>Me[D.Fb],"%C":D=>O((D.Ab+1900)/100|0,2),"%d":D=>O(D.Jb,2),"%e":D=>I(D.Jb,2," "),"%g":D=>re(D).toString().substring(2),"%G":re,"%H":D=>O(D.Eb,2),"%I":D=>(D=D.Eb,D==0?D=12:12<D&&(D-=12),O(D,2)),"%j":D=>{for(var ve=0,Oe=0;Oe<=D.Fb-1;ve+=(Lt(D.Ab+1900)?No:Vo)[Oe++]);return O(D.Jb+ve,3)},"%m":D=>O(D.Fb+1,2),"%M":D=>O(D.jc,2),"%n":()=>`
`,"%p":D=>0<=D.Eb&&12>D.Eb?"AM":"PM","%S":D=>O(D.kc,2),"%t":()=>"	","%u":D=>D.vb||7,"%U":D=>O(Math.floor((D.zb+7-D.vb)/7),2),"%V":D=>{var ve=Math.floor((D.zb+7-(D.vb+6)%7)/7);if(2>=(D.vb+371-D.zb-2)%7&&ve++,ve)ve==53&&(Oe=(D.vb+371-D.zb)%7,Oe==4||Oe==3&&Lt(D.Ab)||(ve=1));else{ve=52;var Oe=(D.vb+7-D.zb-1)%7;(Oe==4||Oe==5&&Lt(D.Ab%400-1))&&ve++}return O(ve,2)},"%w":D=>D.vb,"%W":D=>O(Math.floor((D.zb+7-(D.vb+6)%7)/7),2),"%y":D=>(D.Ab+1900).toString().substring(2),"%Y":D=>D.Ab+1900,"%z":D=>{D=D.ic;var ve=0<=D;return D=Math.abs(D)/60,(ve?"+":"-")+("0000"+(D/60*100+D%60)).slice(-4)},"%Z":D=>D.lc,"%%":()=>"%"},h=h.replace(/%%/g,"\0\0");for(ce in J)h.includes(ce)&&(h=h.replace(new RegExp(ce,"g"),J[ce](v)));return h=h.replace(/\0\0/g,"%"),ce=ec(h),ce.length>p?0:(tc(ce,o),ce.length-1)}ge.Gb();for(var Go=Array(256),In=0;256>In;++In)Go[In]=String.fromCharCode(In);wn=Go,It=u.BindingError=class extends Error{constructor(o){super(o),this.name="BindingError"}},u.InternalError=class extends Error{constructor(o){super(o),this.name="InternalError"}},ht.push(0,1,void 0,1,null,1,!0,1,!1,1),u.count_emval_handles=()=>ht.length/2-5-Cr.length;var rc=[wr,ln,cn,mn,fn,ir,Gr,Lr,hn,xr,gn,yn,bn,vn,Fr,or,ko,Oo,zo,Bo,Do,Mo,Uo,Wo],nc={ua:function(o,p,h){return te(async()=>{await u.Zb(o,p,h)})},b:function(o,p,h){throw o>>>=0,new yi(o).Gb(p>>>0,h>>>0),dn=o,bi++,dn},ka:function(o){Fo(o>>>0,!E,1,!S,131072,!1),ge.Pb()},I:function(o){o>>>=0,P?postMessage({cmd:"cleanupThread",thread:o}):ge.Nb(ge.ub[o])},$:pn,A:mn,qa:fn,X:ir,Z:Gr,Q:Lr,oa:hn,ga:xr,na:gn,K:yn,Y:bn,V:vn,pa:Fr,W:or,E:function(o,p,h){o>>>=0,h>>>=0,p=st(p>>>0),tt(o,{name:p,fromWireType:v=>v,toWireType:function(v,I){if(typeof I!="bigint"&&typeof I!="number")throw I===null?I="null":(v=typeof I,I=v==="object"||v==="array"||v==="function"?I.toString():""+I),new TypeError(`Cannot convert "${I}" to ${this.name}`);return typeof I=="number"&&(I=BigInt(I)),I},argPackAdvance:8,readValueFromPointer:jr(p,h,p.indexOf("u")==-1),Bb:null})},O:function(o,p,h,v){o>>>=0,p=st(p>>>0),tt(o,{name:p,fromWireType:function(I){return!!I},toWireType:function(I,O){return O?h:v},argPackAdvance:8,readValueFromPointer:function(I){return this.fromWireType(n()[I>>>0])},Bb:null})},N:function(o){return tt(o>>>0,$i)},D:function(o,p,h){o>>>=0,h>>>=0,p=st(p>>>0),tt(o,{name:p,fromWireType:v=>v,toWireType:(v,I)=>I,argPackAdvance:8,readValueFromPointer:$n(p,h),Bb:null})},t:function(o,p,h,v,I){if(o>>>=0,h>>>=0,p=st(p>>>0),I===-1&&(I=4294967295),I=F=>F,v===0){var O=32-8*h;I=F=>F<<O>>>O}var W=p.includes("unsigned")?function(F,re){return re>>>0}:function(F,re){return re};tt(o,{name:p,fromWireType:I,toWireType:W,argPackAdvance:8,readValueFromPointer:jr(p,h,v!==0),Bb:null})},p:function(o,p,h){function v(O){var W=d()[O>>>2>>>0];return O=d()[O+4>>>2>>>0],new I(r().buffer,O,W)}o>>>=0;var I=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array][p];h=st(h>>>0),tt(o,{name:h,fromWireType:v,argPackAdvance:8,readValueFromPointer:v},{Ub:!0})},F:function(o,p){o>>>=0,p=st(p>>>0);var h=p==="std::string";tt(o,{name:p,fromWireType:function(v){var I=d()[v>>>2>>>0],O=v+4;if(h)for(var W=O,F=0;F<=I;++F){var re=O+F;if(F==I||n()[re>>>0]==0){if(W=Le(W,re-W),J===void 0)var J=W;else J+=String.fromCharCode(0),J+=W;W=re+1}}else{for(J=Array(I),F=0;F<I;++F)J[F]=String.fromCharCode(n()[O+F>>>0]);J=J.join("")}return Rt(v),J},toWireType:function(v,I){I instanceof ArrayBuffer&&(I=new Uint8Array(I));var O=typeof I=="string";if(!(O||I instanceof Uint8Array||I instanceof Uint8ClampedArray||I instanceof Int8Array))throw new It("Cannot pass non-string to std::string");var W=h&&O?$t(I):I.length,F=An(4+W+1),re=F+4;if(d()[F>>>2>>>0]=W,h&&O)Vt(I,re,W+1);else if(O)for(O=0;O<W;++O){var J=I.charCodeAt(O);if(255<J)throw Rt(re),new It("String has UTF-16 code units that do not fit in 8 bits");n()[re+O>>>0]=J}else for(O=0;O<W;++O)n()[re+O>>>0]=I[O];return v!==null&&v.push(Rt,F),F},argPackAdvance:8,readValueFromPointer:ar,Bb(v){Rt(v)}})},z:function(o,p,h){if(o>>>=0,p>>>=0,h>>>=0,h=st(h),p===2)var v=_i,I=_n,O=xn,W=F=>s()[F>>>1>>>0];else p===4&&(v=Tr,I=xi,O=pe,W=F=>d()[F>>>2>>>0]);tt(o,{name:h,fromWireType:F=>{for(var re=d()[F>>>2>>>0],J,ce=F+4,ze=0;ze<=re;++ze){var Me=F+4+ze*p;(ze==re||W(Me)==0)&&(ce=v(ce,Me-ce),J===void 0?J=ce:(J+=String.fromCharCode(0),J+=ce),ce=Me+p)}return Rt(F),J},toWireType:(F,re)=>{if(typeof re!="string")throw new It(`Cannot pass non-string to C++ string type ${h}`);var J=O(re),ce=An(4+J+p);return d()[ce>>>2>>>0]=J/p,I(re,ce+4,J+p),F!==null&&F.push(Rt,ce),ce},argPackAdvance:8,readValueFromPointer:ar,Bb(F){Rt(F)}})},P:function(o,p){o>>>=0,p=st(p>>>0),tt(o,{Vb:!0,name:p,argPackAdvance:0,fromWireType:()=>{},toWireType:()=>{}})},ta:()=>1,T:function(o,p){o>>>=0,o==p>>>0?setTimeout(it):P?postMessage({targetThread:o,cmd:"checkMailbox"}):(o=ge.ub[o])&&o.postMessage({cmd:"checkMailbox"})},aa:function(o,p,h,v,I){p>>>=0,h>>>=0,v/=2,Ar.length=v,I=I>>>0>>>3;for(var O=0;O<v;O++)Ar[O]=Be[I+2*O]?Be[I+2*O+1]:m()[I+2*O+1>>>0];return o=p?Wr[p]:rc[o],ge.Sb=h,h=o(...Ar),ge.Sb=0,h},ja:Kt,sa:function(o){k&&ge.ub[o>>>0].ref()},w:function(o,p,h){return p>>>=0,h>>>=0,o=Je(o>>>0),p=Er(p,"emval::as"),Xr(p,h,o)},y:function(o){return o>>>=0,te(()=>(o=Je(o),o.then(ut)))},o:function(o,p,h,v){return h>>>=0,v>>>=0,o=Z[o>>>0],p=Je(p>>>0),o(null,p,h,v)},k:function(o,p,h,v,I){return h>>>=0,v>>>=0,I>>>=0,o=Z[o>>>0],p=Je(p>>>0),h=Ee(h),o(p,p[h],v,I)},c:Ir,C:function(o,p){return p>>>=0,o=Je(o>>>0),p=Je(p),o==p},n:function(o){return o>>>=0,o===0?ut(Re()):(o=Ee(o),ut(Re()[o]))},j:function(o,p,h){p=be(o,p>>>0);var v=p.shift();o--;var I=`return function (obj, func, destructorsRef, args) {
...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=r=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(r)];return this.uniforms.map(r=>[t(r.type),r.length??1])}},us=(e,t)=>new Ji(e,t),Pr=(e,t)=>{let r=e.length,n=[];for(let i=0;i<r;i++){let s=r-1-i,a=e[s]||1;(t[t.length-1-i]||1)>1&&a===1&&n.unshift(s)}return n}});var Ec,ls,kc,Oc,xt,ds,cs,Rr=j(()=>{"use strict";ye();xe();Ze();_e();Ec=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},ls=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,kc=(e,t)=>M.sortBasedOnPerm(e,ls(e.length,t)),Oc=(e,t,r,n)=>{let i=[];i.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)i.push(r.indicesSet("a",e[s],`i[${s}]`));return i.push("return a;}"),i.join(`
`)},xt=(e,t)=>{let r=e.dataType,n=e.dims.length,i=ls(n,t),s=kc(e.dims,i),a=K("output",r,s.length),d=U("a",r,n),c=m=>`
...
`)}`,`var value = ${n.getByIndices("input_indices")};`,`value = min(value, ${n.getByIndices("input_indices")});`,""]})},Xc=(e,t)=>{Dt(e.inputs),Mt(e,"ReduceProd",t,(n,i)=>[`var value = ${i.type.storage}(1);`,"",`value *= ${n.getByIndices("input_indices")};`,""])},Zc=(e,t)=>{Dt(e.inputs),Mt(e,"ReduceSum",t,(n,i)=>[`var value = ${i.type.storage}(0);`,"",`value += ${n.getByIndices("input_indices")};`,""])},Qc=(e,t)=>{Dt(e.inputs),Mt(e,"ReduceSumSquare",t,(n,i)=>[`var t = ${i.type.value}(0); var value = ${i.type.value}(0);`,"",`t = ${n.getByIndices("input_indices")}; value += t * t;`,""])},Ut=(e,t,r)=>{if(t.length===0)return r;let n=1,i=1;for(let s=0;s<t.length;s++)t.indexOf(s)===-1?n*=e[s]:i*=e[s];return i<32&&n>1024},xs=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Kc(e,t):ps(e,t)},Ss=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Lc(e,t):ms(e,t)},Cs=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Fc(e,t):fs(e,t)},Is=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?qc(e,t):hs(e,t)},Ts=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?jc(e,t):gs(e,t)},As=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Yc(e,t):ys(e,t)},Es=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Xc(e,t):bs(e,t)},ks=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Zc(e,t):vs(e,t)},Os=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Qc(e,t):ws(e,t)},Ps=(e,t)=>{Ut(e.inputs[0].dims,t.axes,t.noopWithEmptyAxes)?Gc(e,t):$s(e,t)}});var Rs,zs,Bs,no,Ds=j(()=>{"use strict";ye();Ze();jn();Rs=e=>{if(!e||e.length===0||e.length>2)throw new Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(e[0].dataType!==1)throw new Error("Invalid input type.")},zs=(e,t)=>{Rs(e.inputs);let r=(n,i,s)=>{let a=[];for(let d=0;d<n.rank;d++)(s.indexOf(d)>=0||s.length===0)&&a.push(`input_indices[${d}] = 0;`);return[`${a.join(`
`)}`,`var value = ${n.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?"<=":"<"} value) {
         value = ${n.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]};e.compute(Kn("ArgMin",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],r,[t.axis],7,t.keepDims),{inputs:[0]})},Bs=(e,t)=>{Rs(e.inputs);let r=(n,i,s)=>{let a=[];for(let d=0;d<n.rank;d++)(s.indexOf(d)>=0||s.length===0)&&a.push(`input_indices[${d}] = 0;`);return[`${a.join(`
`)}`,`var value = ${n.getByIndices("input_indices")};
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
         value = ${n.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]};e.compute(Kn("argMax",{hint:t.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],r,[t.axis],7,t.keepDims),{inputs:[0]})},no=e=>we(e)});var Jc,ep,tp,Yn,Ms,Us,io=j(()=>{"use strict";ye();xe();Ze();_e();Jc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,n=e[r],i=n.dataType,s=n.dims.length;e.forEach((a,d)=>{if(d!==r){if(a.dataType!==i)throw new Error("input tensors should be one type");if(a.dims.length!==s)throw new Error("input tensors should have the same shape");a.dims.forEach((c,m)=>{if(m!==t&&c!==n.dims[m])throw new Error("non concat dimensions must match")})}})},ep=(e,t)=>`
...
`)},Yn=(e,t,r,n)=>{let i=M.size(r),s=new Array(e.length),a=new Array(e.length),d=0,c=[],m=[],u=[{type:12,data:i}];for(let x=0;x<e.length;++x)d+=e[x].dims[t],s[x]=d,m.push(e[x].dims.length),a[x]=U(`input${x}`,n,m[x]),c.push("rank"),u.push({type:12,data:s[x]});for(let x=0;x<e.length;++x)u.push(...X(e[x].dims));u.push(...X(r));let g=K("output",n,r.length),b=g.indicesGet("indices",t),$=Array.from(Array(s.length).keys()).map(x=>`uniforms.sizeInConcatAxis${x}`).join(","),w=x=>`
  ...
  ${u.mainStart()}
    ...
    ${c.setByOffset("global_idx","value")}
  }`}},Hs=e=>{dp(e.inputs),e.compute(cp(e.inputs))}});var pp,Pe,Ls,Fs,qs,js,Ks,Ys,Xs,Zs,Qs,mp,Js,eu,tu,ru,Zn,nu,Qn,iu,ou,au,su,uu,lu,du,cu,pu,mu,fu,hu,gu,yu,bu,vu,wu,$u,ao,so,_u,xu,Su,Jn=j(()=>{"use strict";ye();xe();Ze();_e();pp=(e,t,r,n,i,s)=>{let a=Math.ceil(t/4),d="";typeof i=="string"?d=`${i}(a)`:d=i("a");let c=U("inputData",r,[a],4),m=K("outputData",n,[a],4);return`
...
}`,iu=e=>{let t=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Qn(t)))},ou=e=>{e.compute(Pe(e.inputs[0],"Exp","exp"))},au=e=>{e.compute(Pe(e.inputs[0],"Floor","floor"))},su=e=>{let t=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Qn(t)))},uu=(e,t)=>{let r=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},lu=e=>{e.compute(Pe(e.inputs[0],"Not",t=>`!${t}`))},du=e=>{e.compute(Pe(e.inputs[0],"Neg",t=>`-${t}`))},cu=e=>{e.compute(Pe(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},pu=e=>{let t=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},mu=e=>{e.compute(Pe(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},fu=e=>we(e),hu=(e,t)=>{let r=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},gu=e=>{e.compute(Pe(e.inputs[0],"Sin","sin"))},yu=e=>{e.compute(Pe(e.inputs[0],"Sinh","sinh"))},bu=e=>{e.compute(Pe(e.inputs[0],"Sqrt","sqrt"))},vu=e=>{e.compute(Pe(e.inputs[0],"Tan","tan"))},wu=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,$u=e=>{e.compute(Pe(e.inputs[0],"Tanh",wu))},ao=(e="f32")=>`
...
`,so=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,_u=e=>{let t=rt(e.inputs[0].dataType);e.compute(Pe(e.inputs[0],"FastGelu",so,ao(t),void 0,e.inputs[0].dataType))},xu=(e,t)=>{let r=rt(e.inputs[0].dataType);return e.compute(Pe(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Su=e=>{e.compute(Pe(e.inputs[0],"Log","log"))}});var fp,hp,Iu,Tu=j(()=>{"use strict";xe();_e();Jn();fp=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},hp=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=U("input",e[0].dataType,e[0].dims,4),n=U("bias",e[0].dataType,[e[0].dims[2]],4),i=K("output",e[0].dataType,t,4),s=M.size(t)/4,a=De(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:c=>`
  ...
  ${c.mainStart()}
    ...
    ${i.setByOffset("global_idx","valueLeft * geluRight")}
  }`}},Iu=e=>{fp(e.inputs),e.compute(hp(e.inputs))}});var gp,yp,Wt,Au,Eu,ku,Ou,Pu,Ru,zu,Bu,Du,Mu,Uu=j(()=>{"use strict";ye();xe();_e();gp=(e,t,r,n,i,s,a,d,c,m,u,g)=>{let b,$;typeof d=="string"?b=$=(S,E)=>`${d}((${S}),(${E}))`:typeof d=="function"?b=$=d:(b=d.scalar,$=d.vector);let w=K("outputData",u,n.length,4),x=U("aData",c,t.length,4),C=U("bData",m,r.length,4),T;if(i)if(s){let S=M.size(t)===1,E=M.size(r)===1,k=t.length>0&&t[t.length-1]%4===0,P=r.length>0&&r[r.length-1]%4===0;S||E?T=w.setByOffset("global_idx",$(S?`${x.type.value}(${x.getByOffset("0")}.x)`:x.getByOffset("global_idx"),E?`${C.type.value}(${C.getByOffset("0")}.x)`:C.getByOffset("global_idx"))):T=`
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${T}
      }`},yp=(e,t,r,n,i,s,a=r.dataType)=>{let d=!M.areEqual(r.dims,n.dims),c=r.dims,m=M.size(r.dims),u=!1,g=!1,b=[d];if(d){let $=zt.calcShape(r.dims,n.dims,!1);if(!$)throw new Error("Can't perform binary op on the given tensors");c=$,m=M.size(c);let w=M.size(r.dims)===1,x=M.size(n.dims)===1,C=r.dims.length>0&&r.dims[r.dims.length-1]%4===0,T=n.dims.length>0&&n.dims[n.dims.length-1]%4===0;b.push(w),b.push(x),b.push(C),b.push(T);let S=1;for(let E=1;E<c.length;E++){let k=r.dims[r.dims.length-E]??1,P=n.dims[n.dims.length-E]??1;if(k===P)S*=k;else break}S%4===0?(g=!0,u=!0):(w||x||C||T)&&(u=!0)}else u=!0;return b.push(u),{name:e,shaderCache:{hint:t+b.map($=>$.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:$=>gp($,r.dims,n.dims,c,u,d,g,i,r.dataType,n.dataType,a,s),getRunData:()=>({outputs:[{dims:c,dataType:a}],dispatchGroup:{x:Math.ceil(m/64/4)},programUniforms:[{type:12,data:Math.ceil(M.size(c)/4)},...X(r.dims,n.dims,c)]})}},Wt=(e,t,r,n,i,s)=>{e.compute(yp(t,i??"",e.inputs[0],e.inputs[1],r,n,s))},Au=e=>{Wt(e,"Add",(t,r)=>`${t}+${r}`)},Eu=e=>{Wt(e,"Div",(t,r)=>`${t}/${r}`)},ku=e=>{Wt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},Ou=e=>{Wt(e,"Mul",(t,r)=>`${t}*${r}`)},Pu=e=>{let t=U("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;Wt(e,"Pow",{scalar:(n,i)=>`pow_custom(${n},${i})`,vector:(n,i)=>`pow_vector_custom(${n},${i})`},`
...
`});var vp,wp,nn,Wu,$p,on,_p,ii,an=j(()=>{"use strict";ye();xe();_e();Jt();ri();vp=(e,t)=>e?`
        ...
        }`,nn=(e,t,r="f32",n,i=!1,s=32,a=!1,d=32)=>{let c=t[1]*e[1],m=t[0]*e[0],u=i?c:s,g=i?s:c,b=u/t[0],$=s/t[1];if(!((i&&b===4&&e[1]===4||!i&&(b===3||b===4))&&u%t[0]===0&&s%t[1]===0&&e[0]===4))throw new Error(`If transposeA ${i} is true, innerElementSize ${b} and workPerThread[1] ${e[1]} must be 4.
  ...
  fn mm_write(batch: i32, row : i32, colIn : i32, valueInput : ${n}) {
    ...
    if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
      ...
      result[getIndexFromCoords4D(coords, vec4<i32>(uniforms.result_shape))/${i}] = value;
        ...
        ${w?nn(S,T,oe,void 0,!c,P):on(S,T,oe,void 0,!c,P,!1,void 0,d)}`};return{name:"Conv2DTransposeMatMul",shaderCache:{hint:`${t.cacheKey};${S};${T};${w}`,inputDependencies:he},getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:E[0],y:E[1],z:E[2]},programUniforms:Q}),getShaderSource:N}}});var Ep,yo,Ku=j(()=>{"use strict";ye();Qt();xe();_e();Ep=(e,t,r,n,i,s=!1,a,d,c=!1)=>{let m=c?1:2,u=c?2:3,g=c?3:1,b=s?2:1,$=`
...
`)};
    ...
    ${b}`},c=[{type:12,data:a},...X(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c})}},cl=e=>{Lp(e.inputs),e.compute(qp(e.inputs),{inputs:[0]})}});var jp,ml,fl=j(()=>{"use strict";ye();xe();_e();Jn();jp=e=>{let t=e[0].dataType,r=M.size(e[0].dims),n=M.size(e[1].dims),i=n%4===0,s=a=>{let d=U("x",t,[1],4),c=U("bias",t,[1],4),m=K("y",t,[1],4),u=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],g=$=>`
      ...
      `},cm=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
          ...
          `},fm=(e,t,r)=>{switch(r.mode){case 0:return dm(e,t,r.pads.length);case 1:return cm(e,t,r.pads.length);case 2:return pm(e,t,r.pads.length);case 3:return mm(e,t,r.pads.length);default:throw new Error("Invalid mode")}},hm=(e,t)=>{let r=M.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,i=M.size(r),s=[{type:12,data:i},{type:6,data:t.pads}];t.mode===0&&s.push({type:e[0].dataType,data:t.value}),s.push(...X(e[0].dims,r));let a=["rank"],d=c=>{let m=K("output",e[0].dataType,r.length),u=U("x",e[0].dataType,n.length),g=u.type.value,b=fm(m,n.length,t),$=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&$.push({name:"constant_value",type:g}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},Nl=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,ym=e=>`${Nl(e)};${e.countIncludePad}`,bm=e=>`${Nl(e)};${e.storageOrder};${e.dilations}`,Vl=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),Hl=(e,t,r,n)=>{let[i,s]=Ml(t,n,r),a=U("x",t.dataType,t.dims.length),d=a.type.value,c="value += x_val;",m="";i.countIncludePad?m+=`value /= ${d}(uniforms.kernelSize);`:m+=`value /= ${d}(i32(uniforms.kernelSize) - pad);`;let[u,g,b,$,w]=Ul(s,i);u.push(...X(t.dims,s));let x=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${w}`,inputDependencies:x},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(M.size(s)/64)},programUniforms:u}),getShaderSource:C=>Wl(C,a,t.dims.length,s.length,i,c,m,0,g,b,$,w)}},Gl=e=>{let t=e.count_include_pad!==0,r=Vl(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:ym(n)}},Ll=(e,t)=>{si(e.inputs),e.compute(Hl("AveragePool",e.inputs[0],!1,t))},Fl={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ql=e=>{let t=e.format;return{format:t,...Fl,cacheKey:t}},jl=(e,t)=>{si(e.inputs),e.compute(Hl("GlobalAveragePool",e.inputs[0],!0,t))},Kl=(e,t,r,n)=>{let[i,s]=Ml(t,n,r),a=`
      value = max(x_val, value);
    `,d="",c=U("x",t.dataType,t.dims.length),m=["rank"],[u,g,b,$,w]=Ul(s,i);return u.push(...X(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${b};${$};${w}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(M.size(s)/64)},programUniforms:u}),getShaderSource:x=>Wl(x,c,t.dims.length,s.length,i,a,d,t.dataType===10?-65504:-1e5,g,b,$,w)}},Yl=(e,t)=>{si(e.inputs),e.compute(Kl("MaxPool",e.inputs[0],!1,t))},Xl=e=>{let t=e.storage_order,r=e.dilations,n=Vl(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:r,...n,cacheKey:""};return{...i,cacheKey:bm(i)}},Zl=e=>{let t=e.format;return{format:t,...Fl,cacheKey:t}},Ql=(e,t)=>{si(e.inputs),e.compute(Kl("GlobalMaxPool",e.inputs[0],!0,t))}});var wm,$m,ed,td=j(()=>{"use strict";_t();ye();_e();wm=(e,t,r)=>{let n=e===t,i=e<t&&r<0,s=e>t&&r>0;if(n||i||s)throw new Error("Range these inputs' contents are invalid.")},$m=(e,t,r,n)=>{let i=Math.abs(Math.ceil((t-e)/r)),s=[i],a=i,d=[{type:12,data:a},{type:n,data:e},{type:n,data:r},...X(s)],c=m=>{let u=K("output",n,s.length),g=u.type.value,b=[{name:"outputSize",type:"u32"},{name:"start",type:g},{name:"delta",type:g}];return`
        ${m.registerUniforms(b).declareVariables(u)}
        ${m.mainStart()}
        ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${g}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:c,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d})}},ed=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),ke.webgpu.validateInputContent&&wm(t,r,n),e.compute($m(t,r,n,e.inputs[0].dataType),{inputs:[]})}});var _m,xm,Sm,Cm,Im,Tm,Am,Em,km,Om,Pm,rd,Rm,zm,Bm,Dm,Mm,nd,id,od=j(()=>{"use strict";ye();xe();Ze();_e();_m=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${c.length}_${a.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:C,getRunData:()=>({outputs:[u],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:x})}},cd=(e,t)=>{Hm(e.inputs,t);let r=Gm(e.inputs,t);e.compute(Fm(e.inputs,r),{inputs:[0]})},pd=e=>{let t=e.starts,r=e.ends,n=e.axes;return we({starts:t,ends:r,axes:n})}});var qm,jm,fd,hd,gd=j(()=>{"use strict";ye();xe();Ze();_e();qm=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},jm=(e,t)=>{let r=e.dims,n=M.size(r),i=64,s=t.axis;if(s<0&&(s=r.length+s),s<r.length-1)throw new Error("softmax only supports last axis for now.");let a=r[s],d=n/a,c=Ue(a),m=a/c,u=(C,T)=>T===4?`max(max(${C}.x, ${C}.y), max(${C}.z, ${C}.w))`:T===2?`max(${C}.x, ${C}.y)`:T===3?`max(max(${C}.x, ${C}.y), ${C}.z)`:C,g=U("x",e.dataType,e.dims,c),b=K("result",e.dataType,e.dims,c),$=g.type.value,w=De(e.dataType)==="f32"?`var threadMax = ${$}(-3.402823e+38f);`:`var threadMax = ${$}(-65504.0h);`,x=C=>`
