...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let t=n=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(n)];return this.uniforms.map(n=>[t(n.type),n.length??1])}},lo=(e,t)=>new On(e,t)});var Fu,co,Ku,ju,Zu,ce,po,mo,Oe=A(()=>{"use strict";V();W();oe();F();Fu=e=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.")},co=(e,t)=>t&&t.length!==e?[...new Array(e).keys()].reverse():t,Ku=(e,t)=>x.sortBasedOnPerm(e,co(e.length,t)),ju=(e,t,n,r)=>{let o=`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
    var a: ${n.type.indices};`;for(let i=0;i<t;++i)o+=n.indicesSet("a",e[i],`i[${i}]`);return o+="return a;}"},Zu=(e,t)=>{let n=[],r=[];for(let o=0;o<e.length;++o)e[o]!==1&&n.push(e[o]),e[t[o]]!==1&&r.push(t[o]);return{newShape:n,newPerm:r}},ce=(e,t)=>{let n=e.dataType,r=e.dims.length,o=co(r,t),i=Ku(e.dims,o),{newShape:s,newPerm:a}=Zu(e.dims,o),u=x.areEqual(a,[2,3,1]),l=x.areEqual(a,[3,1,2]),d=s.length===2&&a[0]>a[1]||u||l,c=d?s:e.dims,p=i;d&&(c=u?[s[0],s[1]*s[2]]:l?[s[0]*s[1],s[2]]:s,p=[c[1],c[0]]);let f=S("a",n,c.length),m=C("output",n,p.length),h=16,_;return d?_=y=>`
  ...
  ${y.mainStart()}
    ...
    ${m.setByOffset("global_idx",f.getByIndices("aIndices"))}
       ...
       `,m=h=>`
        ...
        }`;return{name:e,shaderCache:{hint:`${t};${p}`,inputDependencies:["type"]},getShaderSource:m,getRunData:()=>({outputs:[{dims:i,dataType:o}],dispatchGroup:{x:u},programUniforms:[{type:12,data:l}]})}},ke=(e,t,n,r)=>{let o=e.inputs.length===1?n:Un(e.inputs,n),i=o.axes;i.length===0&&!o.noopWithEmptyAxes&&(i=e.inputs[0].dims.map((f,m)=>m));let s=x.normalizeAxes(i,e.inputs[0].dims.length),a=s,u=e.inputs[0],l=ol(a,e.inputs[0].dims.length);l.length>0&&(u=e.compute(ce(e.inputs[0],l),{inputs:[0],outputs:[-1]})[0],a=el(a.length,u.dims.length));let[d,c]=tl(u.dims,a),p=d;o.keepDims&&(p=nl(d,s)),e.compute(il(t,o.cacheKey,[u],r,e.inputs[0].dataType,p,c),{inputs:[u]})},fo=(e,t)=>{ke(e,"ReduceMeanShared",t,"mean")},ho=(e,t)=>{ke(e,"ReduceL1Shared",t,"l1")},go=(e,t)=>{ke(e,"ReduceL2Shared",t,"l2")},yo=(e,t)=>{ke(e,"ReduceLogSumExpShared",t,"logSumExp")},bo=(e,t)=>{ke(e,"ReduceMaxShared",t,"max")},_o=(e,t)=>{ke(e,"ReduceMinShared",t,"min")},wo=(e,t)=>{ke(e,"ReduceProdShared",t,"prod")},$o=(e,t)=>{ke(e,"ReduceSumShared",t,"sum")},vo=(e,t)=>{ke(e,"ReduceSumSquareShared",t,"sumSquare")},xo=(e,t)=>{ke(e,"ReduceLogSumShared",t,"logSum")}});var Ee,sl,Ft,Un,ze,al,ul,ll,dl,cl,pl,ml,fl,hl,gl,Pe,To,Io,Co,Ao,ko,Eo,zo,Po,Bo,Oo,qt=A(()=>{"use strict";V();W();oe();F();So();Ee=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},sl=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ft=(e,t,n,r,o,i,s=!1,a=!1)=>{let u=[],l=n[0].dims,d=l.length,c=x.normalizeAxes(o,d),p=!a&&c.length===0;l.forEach((_,y)=>{p||c.indexOf(y)>=0?s&&u.push(1):u.push(_)});let f=u.length,m=x.size(u);return{name:e,shaderCache:t,getShaderSource:_=>{let y=[],g=S("_A",n[0].dataType,d),b=C("output",i,f),w=r(g,b,c),$=w[2];for(let v=0,T=0;v<d;v++)p||c.indexOf(v)>=0?(s&&T++,$=`for(var j${v}: u32 = 0; j${v} < ${l[v]}; j${v}++) {
...
var best_index : i32 = 0;`,`if (${r.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${r}_${s}`,inputDependencies:l?["rank","type","type","type","type"]:void 0},getShaderSource:g,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l?[{type:12,data:u},...E(i)]:[{type:12,data:u}]})}},Sl=e=>N(e),No=(e,t)=>{let{inputs:n,outputCount:r}=e,o=Sl({...t,outputCount:r});if(X.webgpu.validateInputContent&&vl(n,o),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(xl(n,o))}});var Tl,Il,Wo,Go=A(()=>{"use strict";W();F();Tl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Il=e=>{let t=e[0].dims,n=e[0].dims[2],r=x.size(t)/4,o=e[0].dataType,i=S("input",o,t,4),s=S("bias",o,[n],4),a=S("residual",o,t,4),u=C("output",o,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)}}),getShaderSource:d=>`
  ...
  }`}},Wo=e=>{Tl(e.inputs),e.compute(Il(e.inputs))}});var Cl,J,Ho,qo,Fo,Ko,jo,Zo,Qo,Xo,Yo,Al,Jo,ei,ti,ni,pt,ri,jt,oi,ii,si,ai,ui,li,di,ci,pi,mi,fi,hi,gi,yi,bi,_i,wi,$i,Ln,Wn,vi,xi,Si,kl,El,Ti,Zt=A(()=>{"use strict";V();W();oe();F();Cl=(e,t,n,r,o,i,s)=>{let a=Math.ceil(t/4),u="";typeof o=="string"?u=`${o}(a)`:u=o("a");let l=S("inputData",n,[a],4),d=C("outputData",r,[a],4),c=[{name:"vec_size",type:"u32"}];return s&&c.push(...s),`
  ...
  }`},J=(e,t,n,r,o,i=e.dataType,s,a)=>{let u=[{type:12,data:Math.ceil(x.size(e.dims)/4)}];return s&&u.push(...s),{name:t,shaderCache:{hint:o,inputDependencies:["type"]},getShaderSource:l=>Cl(l,x.size(e.dims),e.dataType,i,n,r,a),getRunData:l=>({outputs:[{dims:e.dims,dataType:i}],dispatchGroup:{x:Math.ceil(x.size(l[0].dims)/64/4)},programUniforms:u})}},Ho=e=>{e.compute(J(e.inputs[0],"Abs","abs"))},qo=e=>{e.compute(J(e.inputs[0],"Acos","acos"))},Fo=e=>{e.compute(J(e.inputs[0],"Acosh","acosh"))},Ko=e=>{e.compute(J(e.inputs[0],"Asin","asin"))},jo=e=>{e.compute(J(e.inputs[0],"Asinh","asinh"))},Zo=e=>{e.compute(J(e.inputs[0],"Atan","atan"))},Qo=e=>{e.compute(J(e.inputs[0],"Atanh","atanh"))},Xo=e=>N(e),Yo=(e,t)=>{let n;switch(t.to){case 10:n="vec4<f16>";break;case 1:n="vec4<f32>";break;case 12:n="vec4<u32>";break;case 6:n="vec4<i32>";break;case 9:n="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(J(e.inputs[0],"Cast",n,void 0,t.cacheKey,t.to))},Al=e=>{let t,n,r=e.length>=2&&e[1].data!==0,o=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=r?e[1].getFloat32Array()[0]:-34028234663852886e22,n=o?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=r?e[1].getUint16Array()[0]:64511,n=o?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return N({min:t,max:n})},Jo=(e,t)=>{let n=t||Al(e.inputs),r=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Clip",o=>`clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`,void 0,n.cacheKey,void 0,[{type:e.inputs[0].dataType,data:n.min},{type:e.inputs[0].dataType,data:n.max}],[{name:"min",type:r},{name:"max",type:r}]),{inputs:[0]})},ei=e=>{e.compute(J(e.inputs[0],"Ceil","ceil"))},ti=e=>{e.compute(J(e.inputs[0],"Cos","cos"))},ni=e=>{e.compute(J(e.inputs[0],"Cosh","cosh"))},pt=e=>N(e),ri=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Elu",r=>`elu_vf32(${r})`,`
...
}`,oi=e=>{let t=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Erf",n=>`erf_vf32(${n})`,jt(t)))},ii=e=>{e.compute(J(e.inputs[0],"Exp","exp"))},si=e=>{e.compute(J(e.inputs[0],"Floor","floor"))},ai=e=>{let t=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Gelu",n=>`0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`,jt(t)))},ui=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"LeakyRelu",r=>`select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`,`const leaky_relu_alpha_ = ${n}(${t.alpha});`,t.cacheKey))},li=e=>{e.compute(J(e.inputs[0],"Not",t=>`!${t}`))},di=e=>{e.compute(J(e.inputs[0],"Neg",t=>`-${t}`))},ci=e=>{e.compute(J(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},pi=e=>{let t=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"Relu",n=>`select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`))},mi=e=>{e.compute(J(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},fi=e=>N(e),hi=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"HardSigmoid",r=>`max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`,void 0,t.cacheKey))},gi=e=>{e.compute(J(e.inputs[0],"Sin","sin"))},yi=e=>{e.compute(J(e.inputs[0],"Sinh","sinh"))},bi=e=>{e.compute(J(e.inputs[0],"Sqrt","sqrt"))},_i=e=>{e.compute(J(e.inputs[0],"Tan","tan"))},wi=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,$i=e=>{e.compute(J(e.inputs[0],"Tanh",wi))},Ln=(e="f32")=>`
...
`,Wn=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,vi=e=>{let t=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"FastGelu",Wn,Ln(t),void 0,e.inputs[0].dataType))},xi=(e,t)=>{let n=de(e.inputs[0].dataType);return e.compute(J(e.inputs[0],"ThresholdedRelu",r=>`select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`,t.cacheKey)),0},Si=e=>{e.compute(J(e.inputs[0],"Log","log"))},kl=(e,t)=>`
...
`,El=e=>`quick_gelu_impl(${e})`,Ti=(e,t)=>{let n=de(e.inputs[0].dataType);e.compute(J(e.inputs[0],"QuickGelu",El,kl(n,t.alpha),t.cacheKey,e.inputs[0].dataType))}});var zl,Pl,Ci,Ai=A(()=>{"use strict";W();F();Zt();zl=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Pl=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let n=S("input",e[0].dataType,e[0].dims,4),r=S("bias",e[0].dataType,[e[0].dims[2]],4),o=C("output",e[0].dataType,t,4),i=x.size(t)/4,s=ee(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},Oi=e=>{Be(e,"Sub",(t,n)=>`${t}-${n}`)},Di=e=>{Be(e,"Greater",{scalar:(t,n)=>`u32(${t}>${n})`,vector:(t,n)=>`vec4<u32>(${t}>${n})`},void 0,void 0,9)},Mi=e=>{Be(e,"Less",{scalar:(t,n)=>`u32(${t}<${n})`,vector:(t,n)=>`vec4<u32>(${t}<${n})`},void 0,void 0,9)},Ri=e=>{Be(e,"GreaterOrEqual",{scalar:(t,n)=>`u32(${t}>=${n})`,vector:(t,n)=>`vec4<u32>(${t}>=${n})`},void 0,void 0,9)},Ui=e=>{Be(e,"LessOrEqual",{scalar:(t,n)=>`u32(${t}<=${n})`,vector:(t,n)=>`vec4<u32>(${t}<=${n})`},void 0,void 0,9)}});var Ml,Rl,Ul,Vl,Ni,Li,Wi=A(()=>{"use strict";V();W();oe();F();Ml=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let n=0,r=e[n],o=r.dataType,i=r.dims.length;e.forEach((s,a)=>{if(a!==n){if(s.dataType!==o)throw new Error("input tensors should be one type");if(s.dims.length!==i)throw new Error("input tensors should have the same shape");s.dims.forEach((u,l)=>{if(l!==t&&u!==r.dims[l])throw new Error("non concat dimensions must match")})}})},Rl=(e,t)=>`
...
`)},Vl=(e,t,n,r)=>{let o=x.size(n),i=new Array(e.length),s=new Array(e.length),a=0,u=[],l=[],d=[{type:12,data:o}];for(let h=0;h<e.length;++h)a+=e[h].dims[t],i[h]=a,l.push(e[h].dims.length),s[h]=S(`input${h}`,r,l[h]),u.push("rank"),d.push({type:12,data:i[h]});for(let h=0;h<e.length;++h)d.push(...E(e[h].dims));d.push(...E(n));let c=C("output",r,n.length),p=c.indicesGet("indices",t),f=Array.from(Array(i.length).keys()).map(h=>`uniforms.sizeInConcatAxis${h}`).join(","),m=h=>`
  ...
  ${h.mainStart()}
    ...
    ${Ul(s,c)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:u},getRunData:()=>({outputs:[{dims:n,dataType:r}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:d}),getShaderSource:m}},Ni=(e,t)=>{let n=e.inputs,r=n[0].dims,o=x.normalizeAxis(t.axis,r.length);Ml(n,o);let i=r.slice();i[o]=n.reduce((a,u)=>a+(u.dims.length>o?u.dims[o]:0),0);let s=n.filter(a=>x.size(a.dims)>0);e.compute(Vl(s,o,i,n[0].dataType),{inputs:s})},Li=e=>N({axis:e.axis})});var Se,Te,Ie,Qt,Ne=A(()=>{"use strict";V();W();Se=(e,t,n="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${n}(uniforms.clip_min)), ${t}(${n}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${n}(uniforms.alpha) * value + ${n}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${n}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},Te=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},Ie=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Qt=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[n,r]=e?.activation_params||[.2,.5];return{activation:t,alpha:n,beta:r}}else if(t==="Clip"){let[n,r]=e?.activation_params||[ao,uo];return{activation:t,clipMax:r,clipMin:n}}else if(t==="LeakyRelu"){let[n]=e?.activation_params||[.01];return{activation:t,alpha:n}}return{activation:t}}});var me,Gi,Xt=A(()=>{"use strict";me=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},Gi=e=>`
      ${e?"value = value + getBiasByOutputCoords(coords);":""}
      `});var Hi,qi=A(()=>{"use strict";Hi=e=>`
...
`});var mt,Yt,Jt=A(()=>{"use strict";V();W();F();Ne();mt=(e,t,n,r,o)=>{let i=r-n;return`
...
`}return U};return`
  ...
  ${$.mainStart()}
    ...
    ${mt("a_indices",T,T.rank-2,v.rank,"batch_indices")}
    ...
    ${mt("b_indices",I,I.rank-2,v.rank,"batch_indices")}
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${c};${p};${f};${o}`,inputDependencies:h?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:w}}});var Nl,Ll,Gn,Fi,Wl,Hn,Gl,ft,en=A(()=>{"use strict";V();W();F();Ne();Jt();Xt();Nl=(e,t)=>e?`
...
`},Gl=(e,t,n,r,o=!1)=>{let[i,s,a,u]=r,l=ee(r[0].type.tensor);return`
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${me(e,l)} {
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${me(e,l)} {
      var value = ${me(e,l)}(0.0);
      let col = colIn * ${e};
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${me(e,l)}) {
      ...
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        ...
        ${t?`value = value + ${o?"bias[colIn]":`${me(e,l)}(bias[row])`};`:""}
        ${n}
        ${u.setByIndices("vec3<u32>(coords)","value")}
      }
    }
    `},ft=(e,t,n,r,o=!1,i)=>{let s=e[0].dims,a=e[1].dims,u=s.slice(0,-2),l=a.slice(0,-2),d=r?r.slice(0,-2):n.slice(0,-2),c=x.size(d),p=s[s.length-2],f=s[s.length-1],m=a[a.length-1],h=f%4===0&&m%4===0,_=p<=8?[4,1,1]:[4,4,1],y=[8,8,1],g=[Math.ceil(m/y[0]/_[0]),Math.ceil(p/y[1]/_[1]),Math.ceil(c/y[2]/_[2])],b=h?4:1,w=[...u,p,f/b],$=w.length,v=[...l,f,m/b],T=v.length,I=[c,p,m/b],k=[{type:6,data:p},{type:6,data:m},{type:6,data:f}];Te(t,k),k.push(...E(d,w,v));let B=["rank","rank"],D=e.length>2;D&&(k.push(...E(e[2].dims)),B.push("rank")),k.push(...E(I));let L=P=>{let R=d.length,ne=Ht("batchDims",e[0].dataType,R,1),U=ee(e[0].dataType),H=S("a",e[0].dataType,$,b),K=S("b",e[1].dataType,T,b),q=C("result",e[0].dataType,I.length,b),se=[H,K];if(D){let M=o?b:1;se.push(S("bias",e[2].dataType,e[2].dims.length,M))}let be=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];Ie(t,be);let ae=ee(q.type.tensor),Q=Se(t,q.type.value,ae),z=Gl(b,D,Q,[ne,H,K,q],o);return`
  ${P.registerUniforms(be).registerInternalVariables(ne).declareVariables(...se,q)}
  ${z}
  ${h?Gn(_,y,U,ne):Hn(_,y,U,ne)}
                   `};return{name:"MatMul",shaderCache:{hint:`${_};${t.activation};${h};${o}`,inputDependencies:B},getRunData:()=>({outputs:[{dims:i?i(n):n,dataType:e[0].dataType}],dispatchGroup:{x:g[0],y:g[1],z:g[2]},programUniforms:k}),getShaderSource:L}}});var Hl,Ki,ji=A(()=>{"use strict";V();Ce();F();Ne();Xt();qi();en();Hl=(e,t,n,r,o=!1,i,s=4,a=4,u=4,l="f32")=>{let d=B=>{switch(B){case 1:return"resData = x[xIndex];";case 3:return`resData = vec3<${l}>(x[xIndex], x[xIndex + 1], x[xIndex + 2]);`;case 4:return"resData = x[xIndex / 4];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},c=B=>{switch(B){case 1:return"return w[row * i32(uniforms.w_shape[3]) + colIn];";case 4:return"return w[row * i32(uniforms.w_shape[3]) / 4 + colIn];";default:throw new Error(`innerElementSize ${B} is not supported.`)}},p=e?`
    ...
    return ${me(s,l)}(0.0);`,w=`${c(a)}`,$=me(u,l),v=e?me(s,l):me(a,l),T=e?me(a,l):me(s,l),I=Se(i,$,l);return`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${$}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h?`vec4<${q}>`:q}) {
      ...
      }`,be=S("x",e[0].dataType,e[0].dims.length,$===3?1:$),ae=S("w",e[1].dataType,e[1].dims.length,K),Q=[be,ae],z=C("result",e[0].dataType,n.length,K);if(s){let M=S("bias",e[2].dataType,e[2].dims.length,K);Q.push(M),se+=`
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${u?`vec4<${$}>`:$} {
          ...
          }`};return{name:"Conv3DNaive",shaderCache:{hint:`${t.cacheKey};${s};${p};${_}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:c[0],y:c[1],z:c[2]},programUniforms:m}),getShaderSource:y}}});var es,ts,ns=A(()=>{"use strict";V();W();F();Ne();es=(e,t,n,r)=>{let o=e.length>2,i=o?"value += b[output_channel];":"",s=e[0].dims,a=e[1].dims,u=t.format==="NHWC",l=u?n[3]:n[1],d=l/t.group,c=u&&d>=4?Y(l):1,p=x.size(n)/c,f=[{type:12,data:p},{type:12,data:t.dilations},{type:12,data:[t.strides[0],t.strides[1]]},{type:12,data:[t.pads[0],t.pads[1]]},{type:12,data:d}];Te(t,f),f.push(...E(s,[a[0],a[1],a[2],a[3]/c]));let m=o?["rank","rank","rank"]:["rank","rank"];f.push(...E([n[0],n[1],n[2],n[3]/c]));let h=_=>{let y=C("output",e[0].dataType,n.length,c),g=ee(y.type.tensor),b=Se(t,y.type.value,g),w=S("x",e[0].dataType,s.length),$=S("w",e[1].dataType,a.length,c),v=[w,$];o&&v.push(S("b",e[2].dataType,e[2].dims,c));let T=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:t.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];Ie(t,T);let I=u?`
  ...
  }`};return{name:"GroupedConv",shaderCache:{hint:`${t.cacheKey}_${c}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:r?r(n):n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f}),getShaderSource:h}},ts=(e,t,n,r)=>{let o=e.length>2,i=Y(n[3]),s=Y(n[2]),a=x.size(n)/i/s,u=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/i],l=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/i],d=[n[0],n[1],n[2],n[3]/i],c=[{type:12,data:a},{type:6,data:[t.strides[0],t.strides[1]]},{type:6,data:[t.pads[0],t.pads[1]]}];Te(t,c),c.push(...E(u,l,d));let p=(s-1)*t.strides[1]+l[1],f=m=>{let h=C("output",e[0].dataType,d.length,i),_=ee(h.type.tensor),y=Se(t,h.type.value,_),g=S("x",e[0].dataType,u.length,i),b=S("w",e[1].dataType,l.length,i),w=[g,b];o&&w.push(S("b",e[2].dataType,e[2].dims,i));let $=o?"value += b[output_channel];":"",v=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return Ie(t,v),`
  ...
  ${m.mainStart()}
    ...
    ${ne}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${d}`,inputDependencies:f},getRunData:()=>({dispatchGroup:{x:p[0],y:p[1],z:p[2]},outputs:[{dims:n?n(o):o,dataType:e[0].dataType}],programUniforms:b}),getShaderSource:w}}});var Yl,Jl,ed,as,us,td,ls,nd,ds,cs=A(()=>{"use strict";ss();Ne();Oe();Yl=(e,t,n,r,o,i)=>(e-1)*t+n+(r-1)*o+1-i,Jl=(e,t,n,r,o)=>{let i=Math.floor(e/2);t==="SAME_UPPER"?(n[r]=i,n[o]=e-i):t==="SAME_LOWER"&&(n[r]=e-i,n[o]=i)},ed=(e,t,n,r,o,i,s,a,u,l)=>{let d=e.length-2,c=l.length===0;u.length<d&&u.push(...Array(d-u.length).fill(0));let p=e[0],f=t[a?3:1]*o;for(let m=0,h=e.length-d-(a?1:0);m<d;++m,++h){let _=e[h],y=c?_*s[m]:l[m],g=Yl(_,s[m],i[m],t[h],n[m],y);Jl(g,r,i,m,m+d),c&&l.push(s[m]*(_-1)+u[m]+(t[h]-1)*n[m]+1-i[m]-i[m+d])}l.splice(0,0,p),l.splice(a?3:1,0,f)},as=(e,t)=>{let n=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((c,p)=>c*p,1)===0){n.length=0;for(let c=2;c<t[1].dims.length;++c)n.push(t[1].dims[c])}let r=e.format==="NHWC";n.splice(0,0,t[1].dims[0]),n.splice(r?3:1,0,t[1].dims[1]);let o=e.pads.slice(),i=e.outputShape.slice(),s=e.outputPadding.slice(),a=t[0].dims,u=e.dilations.slice();if(u.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;u=new Array(c).fill(1)}let l=e.strides.slice();if(l.reduce((c,p)=>c+p,0)===0){let c=t[0].dims.length-2;l=new Array(c).fill(1)}ed(a,n,u,e.autoPad,e.group,o,l,r,s,i);let d=Object.assign({},e);return Object.assign(d,{kernelShape:n,pads:o,outputPadding:s,outputShape:i,dilations:u,strides:l}),d},us=e=>{let t=Qt(e),n=e.format,r=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],o=e.dilations,i=e.group,s=e.kernelShape,a=e.pads,u=e.strides,l=e.wIsConst(),d=e.outputPadding,c=e.outputShape;return{autoPad:r,format:n,dilations:o,group:i,kernelShape:s,outputPadding:d,outputShape:c,pads:a,strides:u,wIsConst:l,...t,cacheKey:`${e.format};${t.activation};`}},td=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let n=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],r=e[1].dims[0];if(n!==r)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let o=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==o))throw new Error("invalid bias");let i=e[0].dims.length-2;if(t.dilations.reduce((d,c)=>d+c,0)>0&&t.dilations.length!==i)throw new Error(`dilations should be ${i}D`);if(t.strides.reduce((d,c)=>d+c,0)>0&&t.strides.length!==i)throw new Error(`strides should be ${i}D`);if(t.pads.reduce((d,c)=>d+c,0)>0&&t.pads.length!==i*2)throw new Error(`pads should be ${i*2}D`);if(t.outputPadding.length!==i&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${i}D`);if(t.kernelShape.reduce((d,c)=>d+c,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},ls=(e,t,n,r)=>{let o=e.kernelCustomData.wT??e.compute(ce(t[1],[2,3,0,1]),{inputs:[1],outputs:[n.wIsConst?-2:-1]})[0];n.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=o);let i=[t[0],o];t.length===3&&i.push(t[2]),e.compute(is(i,n,r),{inputs:i})},nd=(e,t)=>{let n=t.format==="NHWC",r=[e.inputs[0].reshape(n?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&r.push(e.inputs[2]);let o=t.kernelShape;(o.length===0||o[0]===0)&&(o=[e.inputs[1].dims[2]]);let i=t.dilations;(i.length===0||i[0]===0)&&(i=[1]);let s=t.strides;(s.length===0||s[0]===0)&&(s=[1]);let a=t.pads;a.length===0&&(a=[0,0]),a=[0,a[0],0,a[1]],s=[1].concat(s),i=[1].concat(i),o=[1].concat(o);let u=as({...t,pads:a,strides:s,dilations:i,kernelShape:o},r);ls(e,r,u,l=>n?[l[0],l[2],l[3]]:[l[0],l[1],l[3]])},ds=(e,t)=>{if(td(e.inputs,t),e.inputs[0].dims.length===3)nd(e,t);else{let n=as(t,e.inputs);ls(e,e.inputs,n)}}});var rd,ps,ms,fs=A(()=>{"use strict";V();W();oe();F();rd=(e,t,n,r)=>{let o=x.size(t),i=t.length,s=S("input",e,i),a=C("output",e,i),u=n.dataType===6?n.getInt32Array()[0]:Number(n.getBigInt64Array()[0]),l=x.normalizeAxis(u,i),d=c=>{let p=` i32(${s.indicesGet("inputIndices","uniforms.axis")}) `,f=O("uniforms.input_shape","uniforms.axis",i),m=r.reverse?p+(r.exclusive?" + 1":""):"0",h=r.reverse?f:p+(r.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:r.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(o/64)},programUniforms:[{type:12,data:o},{type:12,data:l},...E(t,t)]}),getShaderSource:d}},ps=(e,t)=>{let n=e.inputs[0].dims,r=e.inputs[0].dataType,o=e.inputs[1];e.compute(rd(r,n,o,t),{inputs:[0]})},ms=e=>{let t=e.exclusive===1,n=e.reverse===1;return N({exclusive:t,reverse:n})}});var od,id,sd,hs,gs,ys=A(()=>{"use strict";V();W();oe();F();od=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},id=(e,t,n,r)=>{let o=[];o.push(`fn perm(i: ${r.type.indices}) -> ${n.type.indices} {
...
`)};
            ${a.setByOffset("global_idx","sum")};
          }`};return{name:"Einsum",shaderCache:{hint:n.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let d=u.filter(p=>n.symbolToInfo.has(p)).map(p=>({type:12,data:n.symbolToInfo.get(p)?.dimValue||0}));d.push({type:12,data:s});let c=e.map((p,f)=>[...E(p)]).reduce((p,f)=>p.concat(f),d);return c.push(...E(r)),{outputs:[{dims:r,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:c}},getShaderSource:l}},ws=(e,t)=>{let n=new Xn(e.inputs,t.equation),r=n.outputDims,o=e.inputs.map((i,s)=>i.dims);e.compute(ld(o,e.inputs[0].dataType,n,r))},$s=e=>{let t=e.equation.replace(/\s+/g,"");return N({equation:t})}});var dd,xs,cd,pd,Ss,Ts=A(()=>{"use strict";V();W();F();dd=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=n.length<t.length?0:n.length-t.length,o=t.length<n.length?0:t.length-n.length;for(;r<n.length&&o<t.length;++r,++o)if(n[r]!==t[o]&&n[r]!==1&&t[o]!==1)throw new Error("Expand requires shape to be broadcastable to input")},xs=(e,t)=>{let n=e.length-t.length,r=[];for(let o=0;o<n;++o)r.push(e[o]);for(let o=0;o<t.length;++o)r.push(t[o]===1?e[o+n]:t[o]);return r},cd=(e,t)=>e.length>t.length?xs(e,t):xs(t,e),pd=e=>{let t=e[0].dims,n=Array.from(e[1].getBigInt64Array(),Number),r=cd(t,n),o=e[0].dataType,i=o===9||x.size(t)===1,s=o===9||t.length>0&&t[t.length-1]%4===0?4:1,a=i||r.length>0&&r[r.length-1]%4===0?4:1,u=Math.ceil(x.size(r)/a),l=c=>{let p=S("input",o,t.length,s),f=C("output",o,r.length,a),m;if(o===9){let h=(_,y,g="")=>`
    ...
    ${m}`},d=[{type:12,data:u},...E(t,r)];return{name:"Expand",shaderCache:{hint:`${r.length};${s}${a}`,inputDependencies:["rank"]},getShaderSource:l,getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:d})}},Ss=e=>{dd(e.inputs),e.compute(pd(e.inputs),{inputs:[0]})}});var md,Is,Cs=A(()=>{"use strict";V();W();F();Zt();md=e=>{let t=e[0].dataType,n=x.size(e[0].dims),r=x.size(e[1].dims),o=r%4===0,i=s=>{let a=S("x",t,[1],4),u=S("bias",t,[1],4),l=C("y",t,[1],4),d=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],c=f=>`
    ...
    }`};return{name:"FastGeluWithBias",shaderCache:{hint:`${o}`,inputDependencies:["type","type"]},getShaderSource:i,getRunData:s=>({outputs:[{dims:s[0].dims,dataType:s[0].dataType}],programUniforms:[{type:12,data:Math.ceil(n/4)},{type:12,data:r}],dispatchGroup:{x:Math.ceil(n/je/4)}})}},Is=e=>{e.inputs.length<2||x.size(e.inputs[1].dims)===0?vi(e):e.compute(md(e.inputs))}});var fd,hd,As,ks,Es=A(()=>{"use strict";V();W();oe();F();fd=e=>{if(!e||e.length!==2)throw new Error("Gather requires 2 inputs.")},hd=(e,t)=>{let n=e[0].dims,r=e[1].dims,o=n.length,i=x.normalizeAxis(t.axis,o),s=n.slice(0);s.splice(i,1,...r);let a=n[i],u=e[0].dataType===9?4:1,l=Math.ceil(x.size(s)/u),d=[{type:12,data:l},{type:6,data:a},{type:12,data:i},...E(e[0].dims,e[1].dims,s)],c=p=>{let f=S("data",e[0].dataType,e[0].dims.length,u),m=S("inputIndices",e[1].dataType,e[1].dims.length),h=C("output",e[0].dataType,s.length,u),_=g=>{let b=r.length,w=`var indicesIndices${g}  = ${m.type.indices}(0);`;for(let $=0;$<b;$++)w+=`${b>1?`indicesIndices${g}[${$}]`:`indicesIndices${g}`} = ${s.length>1?`outputIndices${g}[uniforms.axis + ${$}]`:`outputIndices${g}`};`;w+=`
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((m,h)=>h!==1).map(m=>m.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(m,h)=>"rank")},getRunData:()=>({outputs:[{dims:a,dataType:l}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:p}),getShaderSource:f}},zs=(e,t)=>{let n=e.inputs;gd(n,t),e.compute(yd(e.inputs,t))},Ps=e=>N({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})});var bd,_d,Os,Ds,Ms=A(()=>{"use strict";V();W();oe();F();bd=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
  ...
  }`};return c?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:l*d},programUniforms:f}),getShaderSource:_}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:m},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:f}),getShaderSource:h}},Rs=e=>{let t=e.transA,n=e.transB,r=e.alpha,o=e.beta;return{transA:t,transB:n,alpha:r,beta:o,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},Us=(e,t)=>{wd(e.inputs),e.compute($d(e.inputs,t))}});var De,Le,Je,et,vd,xd,Sd,Td,Id,Cd,Ad,kd,Ns,Ls,Ws=A(()=>{"use strict";V();W();oe();F();[De,Le,Je,et]=[0,1,2,3],vd=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},xd=`
...
`,Ad=(e,t,n)=>(()=>{switch(n.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d},{inputs:[t,n],outputs:[-1]})[0]},ht=(e,t,n,r,o,i,s,a)=>{let u=i;if(s&&x.size(s.dims)>0){if(r===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return u=Bd(e,i,s,t,r,n*o,a),u=u.reshape([t,r,n,o]),n===1||r===1?u:e.compute(ce(u,Gs.perm),{inputs:[u],outputs:[-1]})[0]}else return i.dims.length===3&&(u=i.reshape([t,r,n,o])),n===1||r===1?u:e.compute(ce(u,Gs.perm),{inputs:[u],outputs:[-1]})[0]},qs=(e,t)=>{let n=Pd(e.inputs,t),r=e.inputs[0],o=ye(e.inputs,1),i=ye(e.inputs,2),s=ye(e.inputs,3),a=ye(e.inputs,4),u=ye(e.inputs,5),l=ye(e.inputs,6),d=ye(e.inputs,7);if(r.dims.length===5)throw new Error("Packed QKV is not implemented");if(o?.dims.length===5)throw new Error("Packed KV is not implemented");let c=o&&i&&o.dims.length===4&&i.dims.length===4,p=ht(e,n.batchSize,n.numHeads,n.sequenceLength,n.headSize,r,s,0);if(c)return Ye(e,p,o,i,a,void 0,l,d,u,n);if(!o||!i)throw new Error("key and value must be provided");let f=ht(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.headSize,o,s,n.hiddenSize),m=ht(e,n.batchSize,n.numHeads,n.kvSequenceLength,n.vHeadSize,i,s,2*n.hiddenSize);Ye(e,p,f,m,a,void 0,l,d,u,n)}});var Od,Dd,Md,Rd,Jn,Fs,Ks,er=A(()=>{"use strict";V();W();oe();F();Od=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Dd=(e,t)=>{let n=[],r=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(o=>n.push(Number(o))),r=n.length),N({numOutputs:r,axis:t.axis,splitSizes:n})},Md=e=>`
...
`)}
  ...
  }`};return e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${u};${a};${p}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:_}),getShaderSource:y},{inputs:[t,n,r],outputs:[-1]})[0]},Nd=(e,t,n)=>{let r=t[0].dims,o=r,i=2,s=r[0],a=r[1],u=x.sizeFromDimension(r,i),l=Y(u),d=x.size(o)/l,c=Xs(e,t[0],t[1],t[2],s,u,a,n.epsilon),p=[s,a,u/l],f=[s,a],m=["type","none"],h=_=>{let y=S("x",t[0].dataType,p.length,l),g=S("scale_shift",1,f.length,2),b=C("output",t[0].dataType,p.length,l),w=[y,g,b];return`
  ...
  ${$.mainStart()}
    ...
    ${g?"inv_std_output[global_idx] = inv_std_dev":""};
  }`},w=[{dims:a,dataType:e[0].dataType}];return y&&w.push({dims:f,dataType:1}),g&&w.push({dims:f,dataType:1}),{name:"LayerNormalization",shaderCache:{hint:`${m};${n};${r}`,inputDependencies:h},getRunData:()=>({outputs:w,dispatchGroup:{x:Math.ceil(l/64)},programUniforms:_}),getShaderSource:b}},ea=(e,t)=>{Wd(e.inputs),e.compute(Gd(e.inputs,t,e.outputCount))}});var Hd,na,ra=A(()=>{"use strict";W();Jt();en();Hd=e=>{if(!e||e.length!==2)throw new Error("MatMul requires 2 inputs.");if(e[0].dims[e[0].dims.length-1]!==e[1].dims[e[1].dims.length-2])throw new Error("shared dimension does not match.")},na=e=>{Hd(e.inputs);let t=Ae.calcShape(e.inputs[0].dims,e.inputs[1].dims,!0);if(!t)throw new Error("Can't use matmul on the given tensors");let n=t[t.length-1],r=e.inputs[0].dims[e.inputs[0].dims.length-1];if(n<8&&r<8)e.compute(Yt(e.inputs,{activation:""},t));else{let o=t[t.length-2],i=x.size(e.inputs[0].dims.slice(0,-2)),s=x.size(e.inputs[1].dims.slice(0,-2));if(i!==1&&o===1&&s===1){let a=e.inputs[0].reshape([1,i,r]),u=e.inputs[1].reshape([1,r,n]),l=[1,i,n],d=[a,u];e.compute(ft(d,{activation:""},t,l),{inputs:d})}else e.compute(ft(e.inputs,{activation:""},t))}}});var qd,Fd,Kd,oa,ia,sa=A(()=>{"use strict";V();W();oe();F();qd=(e,t)=>{if(e.length<3||e.length>4)throw new Error("MatMulNBits requires 3 or 4 inputs");let n=e[0],r=n.dims.length;if(n.dims[r-1]!==t.k)throw new Error("The last dim of input shape does not match the k value");let o=Math.floor((t.k+t.blockSize-1)/t.blockSize),i=t.blockSize/8*t.bits,s=e[1];if(!x.areEqual(s.dims,[t.n,o,i]))throw new Error("The second inputs must be 3D tensor with shape N X nBlocksPerCol X blobSize");let u=e[2].dims;if(x.size(u)!==t.n*o)throw new Error("scales input size error.");if(e.length===4){let d=e[3].dims,c=t.bits>4?t.n*o:t.n*Math.floor((o+1)/2);if(x.size(d)!==c)throw new Error("zeroPoints input size error.")}},Fd=(e,t)=>{let n=e[0].dims,r=n.length,o=n[r-2],i=t.k,s=t.n,a=n.slice(0,r-2),u=x.size(a),d=e[1].dims[2]/4,c=e[0].dataType,p=Y(t.k),f=Y(d),m=Y(s),h=a.concat([o,s]),_=o>1&&s/m%2===0?2:1,y=x.size(h)/m/_,g=64,b=[],w=[u,o,i/p],$=x.convertShape(e[1].dims).slice();$.splice(-1,1,d/f),b.push(...E(w)),b.push(...E($)),b.push(...E(e[2].dims)),e.length===4&&b.push(...E(x.convertShape(e[3].dims)));let v=[u,o,s/m];b.push(...E(v));let T=I=>{let k=w.length,B=S("a",e[0].dataType,k,p),D=S("b",12,$.length,f),L=S("scales",e[2].dataType,e[2].dims.length),P=[B,D,L],R=e.length===4?S("zero_points",12,e[3].dims.length):void 0;R&&P.push(R);let ne=v.length,U=C("output",e[0].dataType,ne,m),H=ee(e[0].dataType),K=(()=>{switch(p){case 1:return`array<${H}, 8>`;case 2:return`mat4x2<${H}>`;case 4:return`mat2x4<${H}>`;default:throw new Error(`${p}-component is not supported.`)}})(),q=()=>{let ae=`
          // reuse a data
          ...
          `;return ae},se=()=>{let ae=`
            ...
            col_index += 1;`;return ae},be=()=>{let ae=`col_index = col * ${m};`;for(let Q=0;Q<m*_;Q++)ae+=`
        ...
        }`};return{name:"MatMulNBits",shaderCache:{hint:`${t.blockSize};${t.bits};${p};${f};${m};${_};${g}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:h,dataType:c}],dispatchGroup:{x:y},programUniforms:b}),getShaderSource:T}},Kd=(e,t)=>{let n=e[0].dims,r=n.length,o=n[r-2],i=t.k,s=t.n,a=n.slice(0,r-2),u=x.size(a),d=e[1].dims[2]/4,c=e[0].dataType,p=Y(t.k),f=Y(d),m=a.concat([o,s]),h=128,_=s%8===0?8:s%4===0?4:1,y=h/_,g=y*f*8,b=g/p,w=g/t.blockSize,$=x.size(m)/_,v=[],T=[u,o,i/p],I=x.convertShape(e[1].dims).slice();I.splice(-1,1,d/f),v.push(...E(T)),v.push(...E(I)),v.push(...E(e[2].dims)),e.length===4&&v.push(...E(x.convertShape(e[3].dims)));let k=[u,o,s];v.push(...E(k));let B=D=>{let L=T.length,P=S("a",e[0].dataType,L,p),R=S("b",12,I.length,f),ne=S("scales",e[2].dataType,e[2].dims.length),U=[P,R,ne],H=e.length===4?S("zero_points",12,e[3].dims.length):void 0;H&&U.push(H);let K=k.length,q=C("output",e[0].dataType,K),se=ee(e[0].dataType),be=()=>{switch(p){case 1:return`
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${p};${f};${y};${_}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:c}],dispatchGroup:{x:$},programUniforms:v}),getShaderSource:B}},oa=(e,t)=>{qd(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(Kd(e.inputs,t)):e.compute(Fd(e.inputs,t))},ia=e=>N(e)});var jd,Zd,Qd,Xd,Yd,Jd,ec,tc,aa,ua=A(()=>{"use strict";V();W();F();jd=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},Zd=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
      ...
      `},Qd=(e,t,n)=>{let r="";for(let o=t-1;o>=0;--o)r+=`
          ...
          `},Jd=(e,t,n)=>{switch(n.mode){case 0:return Zd(e,t,n.pads.length);case 1:return Qd(e,t,n.pads.length);case 2:return Xd(e,t,n.pads.length);case 3:return Yd(e,t,n.pads.length);default:throw new Error("Invalid mode")}},ec=(e,t)=>{let n=x.padShape(e[0].dims.slice(),t.pads),r=e[0].dims,o=x.size(n),i=[{type:12,data:o},{type:6,data:t.pads}],s=e.length>=3&&e[2].data;t.mode===0&&i.push({type:s?e[2].dataType:1,data:t.value}),i.push(...E(e[0].dims,n));let a=["rank"],u=l=>{let d=C("output",e[0].dataType,n.length),c=S("x",e[0].dataType,r.length),p=c.type.value,f=Jd(d,r.length,t),m=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&m.push({name:"constant_value",type:s?p:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},pa=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,nc=e=>`${pa(e)};${e.countIncludePad}`,rc=e=>`${pa(e)};${e.storageOrder};${e.dilations}`,ma=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),fa=(e,t,n,r)=>{let[o,i]=la(t,r,n),s=S("x",t.dataType,t.dims.length),a=s.type.value,u="value += x_val;",l="";o.countIncludePad?l+=`value /= ${a}(uniforms.kernelSize);`:l+=`value /= ${a}(i32(uniforms.kernelSize) - pad);`;let[d,c,p,f,m]=da(i,o);d.push(...E(t.dims,i));let h=["rank"];return{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(i)/64)},programUniforms:d}),getShaderSource:_=>ca(_,s,t.dims.length,i.length,o,u,l,0,c,p,f,m)}},ha=e=>{let t=e.count_include_pad!==0,n=ma(e);if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let r={countIncludePad:t,...n,cacheKey:""};return{...r,cacheKey:nc(r)}},ga=(e,t)=>{rn(e.inputs),e.compute(fa("AveragePool",e.inputs[0],!1,t))},ya={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ba=e=>{let t=e.format;return{format:t,...ya,cacheKey:t}},_a=(e,t)=>{rn(e.inputs),e.compute(fa("GlobalAveragePool",e.inputs[0],!0,t))},wa=(e,t,n,r)=>{let[o,i]=la(t,r,n),s=`
      value = max(x_val, value);
    `,a="",u=S("x",t.dataType,t.dims.length),l=["rank"],[d,c,p,f,m]=da(i,o);return d.push(...E(t.dims,i)),{name:e,shaderCache:{hint:`${r.cacheKey};${p};${f};${m}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(x.size(i)/64)},programUniforms:d}),getShaderSource:h=>ca(h,u,t.dims.length,i.length,o,s,a,t.dataType===10?-65504:-1e5,c,p,f,m)}},$a=(e,t)=>{rn(e.inputs),e.compute(wa("MaxPool",e.inputs[0],!1,t))},va=e=>{let t=e.storage_order,n=e.dilations,r=ma(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let o={storageOrder:t,dilations:n,...r,cacheKey:""};return{...o,cacheKey:rc(o)}},xa=e=>{let t=e.format;return{format:t,...ya,cacheKey:t}},Sa=(e,t)=>{rn(e.inputs),e.compute(wa("GlobalMaxPool",e.inputs[0],!0,t))}});var ic,sc,Ia,Ca,Aa=A(()=>{"use strict";V();W();oe();F();ic=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((n,r)=>n===e[2].dims[r]).reduce((n,r)=>n&&r,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((o,i)=>i===t.axis||o===e[0].dims[i]).reduce((o,i)=>o&&i,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let n=e[0].dims[t.axis],r=e[1].dims[t.axis];if(t.blockSize<Math.ceil(n/r)||t.blockSize>Math.ceil(n/(r-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},sc=(e,t)=>{let n=x.normalizeAxis(t.axis,e[0].dims.length),r=e[0].dataType,o=r===3,i=e[0].dims,s=e[1].dataType,a=x.size(i),u=r===3||r===2,l=u?[Math.ceil(x.size(e[0].dims)/4)]:e[0].dims,d=e[1].dims,c=e.length>2?e[2]:void 0,p=c?u?[Math.ceil(x.size(c.dims)/4)]:c.dims:void 0,f=d.length===0||d.length===1&&d[0]===1,m=f===!1&&d.length===1,h=Y(a),_=f&&(!u||h===4),y=_?h:1,g=_&&!u?h:1,b=S("input",u?12:r,l.length,g),w=S("scale",s,d.length),$=c?S("zero_point",u?12:r,p.length):void 0,v=C("output",s,i.length,y),T=[b,w];$&&T.push($);let I=[l,d];c&&I.push(p);let k=[{type:12,data:a/y},{type:12,data:n},{type:12,data:t.blockSize},...E(...I,i)],B=D=>{let L=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:$?["rank","rank","rank"]:["rank","rank"]},getShaderSource:B,getRunData:()=>({outputs:[{dims:i,dataType:s}],dispatchGroup:{x:Math.ceil(a/y/64),y:1,z:1},programUniforms:k})}},Ia=(e,t)=>{ic(e.inputs,t),e.compute(sc(e.inputs,t))},Ca=e=>N({axis:e.axis,blockSize:e.blockSize})});var ac,uc,ka,Ea=A(()=>{"use strict";we();V();F();ac=(e,t,n)=>{let r=e===t,o=e<t&&n<0,i=e>t&&n>0;if(r||o||i)throw new Error("Range these inputs' contents are invalid.")},uc=(e,t,n,r)=>{let o=Math.abs(Math.ceil((t-e)/n)),i=[o],s=o,a=[{type:12,data:s},{type:r,data:e},{type:r,data:n},...E(i)],u=l=>{let d=C("output",r,i.length),c=d.type.value,p=[{name:"outputSize",type:"u32"},{name:"start",type:c},{name:"delta",type:c}];return`
        ${l.registerUniforms(p).declareVariables(d)}
        ${l.mainStart()}
        ${l.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${r}`},getShaderSource:u,getRunData:()=>({outputs:[{dims:i,dataType:r}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:a})}},ka=e=>{let t=0,n=0,r=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],n=e.inputs[1].getInt32Array()[0],r=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],n=e.inputs[1].getFloat32Array()[0],r=e.inputs[2].getFloat32Array()[0]),X.webgpu.validateInputContent&&ac(t,n,r),e.compute(uc(t,n,r,e.inputs[0].dataType),{inputs:[]})}});var lc,dc,cc,pc,mc,fc,hc,gc,yc,bc,_c,za,wc,$c,vc,xc,Sc,Pa,Ba,Oa=A(()=>{"use strict";V();W();oe();F();lc=(e,t)=>{if(e.every(n=>n>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
        ...
        }`};return{name:"RotaryEmbedding",shaderCache:{hint:N({interleaved:n}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:h,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(x.size(p)/je)},programUniforms:m})}},Da=(e,t)=>{Tc(e.inputs,t),e.compute(Ic(e.inputs,t))}});var Cc,Ac,Ra,Ua=A(()=>{"use strict";V();W();F();Cc=e=>{if(!e||e.length<3)throw new Error("layerNorm requires at least 3 inputs.");let t=e[0],n=e[1],r=e[2];if(t.dataType!==n.dataType||t.dataType!==r.dataType)throw new Error("All inputs must have the same data type");if(t.dims.length!==3&&t.dims.length!==2)throw new Error("Input must be 2D or 3D");if(n.dims.length!==3&&n.dims.length!==2)throw new Error("Skip must be 2D or 3D");let o=t.dims[t.dims.length-1],i=t.dims[t.dims.length-2];if(n.dims[n.dims.length-1]!==o)throw new Error("Skip must have the same hidden size as input");if(n.dims[n.dims.length-2]!==i)throw new Error("Skip must have the same sequence length as input");if(r.dims.length!==1)throw new Error("Gamma must be 1D");if(r.dims[r.dims.length-1]!==o)throw new Error("Gamma must have the same hidden size as input");if(e.length>3){let s=e[3];if(s.dims.length!==1)throw new Error("Beta must be 1D");if(s.dims[s.dims.length-1]!==o)throw new Error("Beta must have the same hidden size as input")}if(e.length>4){let s=e[4];if(s.dims.length!==1)throw new Error("Bias must be 1D");if(s.dims[s.dims.length-1]!==o)throw new Error("Bias must have the same hidden size as input")}},Ac=(e,t,n,r)=>{let o=t.simplified,i=e[0].dims,s=x.size(i),a=i,u=s,l=i.slice(-1)[0],d=r?i.slice(0,-1).concat(1):[],c=!o&&e.length>3,p=e.length>4,f=r&&n>1,m=r&&n>2,h=n>3,_=64,y=Y(l),g=[{type:12,data:u},{type:12,data:y},{type:12,data:l},{type:1,data:t.epsilon}],b=$=>{let v=[{name:"output_size",type:"u32"},{name:"components",type:"u32"},{name:"hidden_size",type:"u32"},{name:"epsilon",type:"f32"}],T=[S("x",e[0].dataType,e[0].dims,y),S("skip",e[1].dataType,e[1].dims,y),S("gamma",e[2].dataType,e[2].dims,y)];c&&T.push(S("beta",e[3].dataType,e[3].dims,y)),p&&T.push(S("bias",e[4].dataType,e[4].dims,y)),T.push(C("output",e[0].dataType,a,y)),f&&T.push(C("mean_output",1,d)),m&&T.push(C("inv_std_output",1,d)),h&&T.push(C("input_skip_bias_sum",e[0].dataType,a,y));let I=ee(e[0].dataType),k=ee(1,y);return`
      ...
      }`},w=[{dims:a,dataType:e[0].dataType}];return n>1&&w.push({dims:d,dataType:1}),n>2&&w.push({dims:d,dataType:1}),n>3&&w.push({dims:i,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${y};${f};${m};${h}`,inputDependencies:e.map(($,v)=>"type")},getShaderSource:b,getRunData:()=>({outputs:w,dispatchGroup:{x:Math.ceil(u/l)},programUniforms:g})}},Ra=(e,t)=>{Cc(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Ac(e.inputs,t,e.outputCount,!1),{outputs:r})}});var kc,on,Ec,Va,zc,Pc,Na,La,Wa=A(()=>{"use strict";V();W();oe();F();kc=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((n,r)=>{if(e[r+1].dataType!==6&&e[r+1].dataType!==7)throw new Error(`Input ${r} must be an array of int32 or int64`)})},on=(e,t)=>{let n=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(r=>n.push(Number(r)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(r=>n.push(Number(r)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return n},Ec=(e,t)=>{if(e.length>1){let n=on(e,1),r=on(e,2),o=on(e,3);return o.length===0&&(o=[...Array(e[0].dims.length).keys()]),N({starts:n,ends:r,axes:o})}else return t},Va=(e,t,n,r,o)=>{let i=e;return e<0&&(i+=n[r[t]]),o[t]<0?Math.max(0,Math.min(i,n[r[t]]-1)):Math.max(0,Math.min(i,n[r[t]]))},zc=(e,t,n)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${u.length}_${s.length}_${i.length}`,inputDependencies:["rank"]},getShaderSource:_,getRunData:()=>({outputs:[d],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:h})}},Na=(e,t)=>{kc(e.inputs,t);let n=Ec(e.inputs,t);e.compute(Pc(e.inputs,n),{inputs:[0]})},La=e=>{let t=e.starts,n=e.ends,r=e.axes;return N({starts:t,ends:n,axes:r})}});var Bc,Oc,Ga,Ha,qa=A(()=>{"use strict";V();W();oe();Oe();F();Bc=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},Oc=(e,t)=>{let n=e.inputs[0],r=n.dims,o=x.size(r),i=r.length,s=x.normalizeAxis(t.axis,i),a=s<r.length-1,u,l=[];a?(l=Array.from({length:i},(T,I)=>I),l[s]=i-1,l[i-1]=s,u=e.compute(ce(n,l),{inputs:[n],outputs:[-1]})[0]):u=n;let d=u.dims,c=d[i-1],p=o/c,f=Y(c),m=c/f,h=64;p===1&&(h=256);let _=(T,I)=>I===4?`max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))`:I===2?`max(${T}.x, ${T}.y)`:I===3?`max(max(${T}.x, ${T}.y), ${T}.z)`:T,y=S("x",u.dataType,u.dims,f),g=C("result",u.dataType,u.dims,f),b=y.type.value,w=ee(u.dataType)==="f32"?`var threadMax = ${b}(-3.402823e+38f);`:`var threadMax = ${b}(-65504.0h);`,$=T=>`
    ...
    }`;return{name:"Tile",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},...E(e[0].dims,o)]}),getShaderSource:l}},Ka=e=>{Dc(e.inputs),e.compute(Rc(e.inputs),{inputs:[0]})}});var Uc,Vc,Za,Qa=A(()=>{"use strict";V();W();F();Uc=(e,t,n,r,o)=>{let i=C("output_data",o,n.length,4),s=S("a_data",t[1].dataType,t[1].dims.length,4),a=S("b_data",t[2].dataType,t[2].dims.length,4),u=S("c_data",t[0].dataType,t[0].dims.length,4),l,d=(c,p,f)=>`select(${p}, ${c}, ${f})`;if(!r)l=i.setByOffset("global_idx",d(s.getByOffset("global_idx"),a.getByOffset("global_idx"),u.getByOffset("global_idx")));else{let c=(p,f,m="")=>{let h=`a_data[index_a${f}][component_a${f}]`,_=`b_data[index_b${f}][component_b${f}]`,y=`bool(c_data[index_c${f}] & (0xffu << (component_c${f} * 8)))`;return`
