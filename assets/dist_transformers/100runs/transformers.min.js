...
/*!***********************!*\
  !*** ./src/models.js ***!
  \***********************/(e,t,n)=>{n.r(t),n.d(t,{ASTForAudioClassification:()=>Zt,ASTModel:()=>Yt,ASTPreTrainedModel:()=>Kt,AlbertForMaskedLM:()=>at,AlbertForQuestionAnswering:()=>ot,AlbertForSequenceClassification:()=>st,AlbertModel:()=>it,AlbertPreTrainedModel:()=>rt,AutoModel:()=>ao,AutoModelForAudioClassification:()=>$o,AutoModelForAudioFrameClassification:()=>Co,AutoModelForCTC:()=>ko,AutoModelForCausalLM:()=>mo,AutoModelForDepthEstimation:()=>Fo,AutoModelForDocumentQuestionAnswering:()=>Po,AutoModelForImageClassification:()=>yo,AutoModelForImageFeatureExtraction:()=>Io,AutoModelForImageMatting:()=>Eo,AutoModelForImageSegmentation:()=>bo,AutoModelForImageToImage:()=>Ao,AutoModelForMaskGeneration:()=>To,AutoModelForMaskedLM:()=>go,AutoModelForObjectDetection:()=>xo,AutoModelForQuestionAnswering:()=>_o,AutoModelForSemanticSegmentation:()=>vo,AutoModelForSeq2SeqLM:()=>co,AutoModelForSequenceClassification:()=>lo,AutoModelForSpeechSeq2Seq:()=>po,AutoModelForTextToSpectrogram:()=>ho,AutoModelForTextToWaveform:()=>fo,AutoModelForTokenClassification:()=>uo,AutoModelForVision2Seq:()=>wo,AutoModelForXVector:()=>So,AutoModelForZeroShotObjectDetection:()=>Mo,BartForConditionalGeneration:()=>yt,BartForSequenceClassification:()=>bt,BartModel:()=>wt,BartPretrainedModel:()=>_t,BaseModelOutput:()=>R,BeitForImageClassification:()=>wr,BeitModel:()=>_r,BeitPreTrainedModel:()=>gr,BertForMaskedLM:()=>j,BertForQuestionAnswering:()=>q,BertForSequenceClassification:()=>U,BertForTokenClassification:()=>G,BertModel:()=>V,BertPreTrainedModel:()=>N,BlenderbotForConditionalGeneration:()=>Ct,BlenderbotModel:()=>St,BlenderbotPreTrainedModel:()=>$t,BlenderbotSmallForConditionalGeneration:()=>At,BlenderbotSmallModel:()=>Et,BlenderbotSmallPreTrainedModel:()=>Pt,BloomForCausalLM:()=>Qn,BloomModel:()=>Xn,BloomPreTrainedModel:()=>Hn,CLIPModel:()=>ln,CLIPPreTrainedModel:()=>an,CLIPSegForImageSegmentation:()=>yn,CLIPSegModel:()=>wn,CLIPSegPreTrainedModel:()=>_n,CLIPTextModelWithProjection:()=>dn,CLIPVisionModelWithProjection:()=>un,CamembertForMaskedLM:()=>fe,CamembertForQuestionAnswering:()=>_e,CamembertForSequenceClassification:()=>me,CamembertForTokenClassification:()=>ge,CamembertModel:()=>he,CamembertPreTrainedModel:()=>pe,CausalLMOutput:()=>No,CausalLMOutputWithPast:()=>Vo,ChineseCLIPModel:()=>gn,ChineseCLIPPreTrainedModel:()=>mn,ClapAudioModelWithProjection:()=>ps,ClapModel:()=>us,ClapPreTrainedModel:()=>ds,ClapTextModelWithProjection:()=>cs,CodeGenForCausalLM:()=>Ln,CodeGenModel:()=>On,CodeGenPreTrainedModel:()=>Bn,ConvBertForMaskedLM:()=>ne,ConvBertForQuestionAnswering:()=>se,ConvBertForSequenceClassification:()=>re,ConvBertForTokenClassification:()=>ie,ConvBertModel:()=>te,ConvBertPreTrainedModel:()=>ee,ConvNextForImageClassification:()=>Jr,ConvNextModel:()=>Zr,ConvNextPreTrainedModel:()=>Yr,ConvNextV2ForImageClassification:()=>ni,ConvNextV2Model:()=>ti,ConvNextV2PreTrainedModel:()=>ei,DPTForDepthEstimation:()=>Ur,DPTModel:()=>jr,DPTPreTrainedModel:()=>Vr,DebertaForMaskedLM:()=>be,DebertaForQuestionAnswering:()=>Me,DebertaForSequenceClassification:()=>ve,DebertaForTokenClassification:()=>xe,DebertaModel:()=>ye,DebertaPreTrainedModel:()=>we,DebertaV2ForMaskedLM:()=>$e,DebertaV2ForQuestionAnswering:()=>Pe,DebertaV2ForSequenceClassification:()=>Se,DebertaV2ForTokenClassification:()=>Ce,DebertaV2Model:()=>ke,DebertaV2PreTrainedModel:()=>Te,DeiTForImageClassification:()=>Ar,DeiTModel:()=>Er,DeiTPreTrainedModel:()=>Pr,DepthAnythingForDepthEstimation:()=>qr,DepthAnythingPreTrainedModel:()=>Gr,DetrForObjectDetection:()=>vr,DetrForSegmentation:()=>xr,DetrModel:()=>br,DetrObjectDetectionOutput:()=>Mr,DetrPreTrainedModel:()=>yr,DetrSegmentationOutput:()=>Tr,Dinov2ForImageClassification:()=>si,Dinov2Model:()=>ii,Dinov2PreTrainedModel:()=>ri,DistilBertForMaskedLM:()=>Be,DistilBertForQuestionAnswering:()=>ze,DistilBertForSequenceClassification:()=>Fe,DistilBertForTokenClassification:()=>Ie,DistilBertModel:()=>Ae,DistilBertPreTrainedModel:()=>Ee,DonutSwinModel:()=>Kr,DonutSwinPreTrainedModel:()=>Qr,EfficientNetForImageClassification:()=>Ts,EfficientNetModel:()=>Ms,EfficientNetPreTrainedModel:()=>xs,ElectraForMaskedLM:()=>le,ElectraForQuestionAnswering:()=>ce,ElectraForSequenceClassification:()=>de,ElectraForTokenClassification:()=>ue,ElectraModel:()=>ae,ElectraPreTrainedModel:()=>oe,EsmForMaskedLM:()=>De,EsmForSequenceClassification:()=>Re,EsmForTokenClassification:()=>Ne,EsmModel:()=>Le,EsmPreTrainedModel:()=>Oe,FalconForCausalLM:()=>ls,FalconModel:()=>as,FalconPreTrainedModel:()=>os,GLPNForDepthEstimation:()=>Xr,GLPNModel:()=>Hr,GLPNPreTrainedModel:()=>Wr,GPT2LMHeadModel:()=>xn,GPT2Model:()=>vn,GPT2PreTrainedModel:()=>bn,GPTBigCodeForCausalLM:()=>zn,GPTBigCodeModel:()=>In,GPTBigCodePreTrainedModel:()=>Fn,GPTJForCausalLM:()=>An,GPTJModel:()=>En,GPTJPreTrainedModel:()=>Pn,GPTNeoForCausalLM:()=>kn,GPTNeoModel:()=>Tn,GPTNeoPreTrainedModel:()=>Mn,GPTNeoXForCausalLM:()=>Cn,GPTNeoXModel:()=>Sn,GPTNeoXPreTrainedModel:()=>$n,HubertForCTC:()=>Ri,HubertForSequenceClassification:()=>Ni,HubertModel:()=>Di,HubertPreTrainedModel:()=>Li,ImageMattingOutput:()=>jo,LlamaForCausalLM:()=>Nn,LlamaModel:()=>Rn,LlamaPreTrainedModel:()=>Dn,LlavaForConditionalGeneration:()=>on,LlavaPreTrainedModel:()=>sn,LongT5ForConditionalGeneration:()=>ht,LongT5Model:()=>pt,LongT5PreTrainedModel:()=>ct,M2M100ForConditionalGeneration:()=>wi,M2M100Model:()=>_i,M2M100PreTrainedModel:()=>gi,MBartForCausalLM:()=>kt,MBartForConditionalGeneration:()=>Mt,MBartForSequenceClassification:()=>Tt,MBartModel:()=>xt,MBartPreTrainedModel:()=>vt,MPNetForMaskedLM:()=>Xe,MPNetForQuestionAnswering:()=>Ye,MPNetForSequenceClassification:()=>Qe,MPNetForTokenClassification:()=>Ke,MPNetModel:()=>He,MPNetPreTrainedModel:()=>We,MT5ForConditionalGeneration:()=>gt,MT5Model:()=>mt,MT5PreTrainedModel:()=>ft,MarianMTModel:()=>mi,MarianModel:()=>fi,MarianPreTrainedModel:()=>hi,MaskedLMOutput:()=>Do,MistralForCausalLM:()=>ns,MistralModel:()=>ts,MistralPreTrainedModel:()=>es,MobileBertForMaskedLM:()=>Ue,MobileBertForQuestionAnswering:()=>qe,MobileBertForSequenceClassification:()=>Ge,MobileBertModel:()=>je,MobileBertPreTrainedModel:()=>Ve,MobileViTForImageClassification:()=>dr,MobileViTModel:()=>lr,MobileViTPreTrainedModel:()=>ar,ModelOutput:()=>D,MptForCausalLM:()=>Zn,MptModel:()=>Yn,MptPreTrainedModel:()=>Kn,MusicgenForCausalLM:()=>Ss,MusicgenForConditionalGeneration:()=>Cs,MusicgenModel:()=>$s,MusicgenPreTrainedModel:()=>ks,NomicBertModel:()=>H,NomicBertPreTrainedModel:()=>W,OPTForCausalLM:()=>tr,OPTModel:()=>er,OPTPreTrainedModel:()=>Jn,OwlViTForObjectDetection:()=>pr,OwlViTModel:()=>cr,OwlViTPreTrainedModel:()=>ur,Owlv2ForObjectDetection:()=>mr,Owlv2Model:()=>fr,Owlv2PreTrainedModel:()=>hr,PhiForCausalLM:()=>Wn,PhiModel:()=>qn,PhiPreTrainedModel:()=>Gn,PreTrainedModel:()=>L,PretrainedMixin:()=>Ps,QuestionAnsweringModelOutput:()=>Ro,Qwen2ForCausalLM:()=>Un,Qwen2Model:()=>jn,Qwen2PreTrainedModel:()=>Vn,ResNetForImageClassification:()=>zr,ResNetModel:()=>Ir,ResNetPreTrainedModel:()=>Fr,RoFormerForMaskedLM:()=>K,RoFormerForQuestionAnswering:()=>J,RoFormerForSequenceClassification:()=>Y,RoFormerForTokenClassification:()=>Z,RoFormerModel:()=>Q,RoFormerPreTrainedModel:()=>X,RobertaForMaskedLM:()=>zt,RobertaForQuestionAnswering:()=>Lt,RobertaForSequenceClassification:()=>Bt,RobertaForTokenClassification:()=>Ot,RobertaModel:()=>It,RobertaPreTrainedModel:()=>Ft,SamImageSegmentationOutput:()=>pi,SamModel:()=>ci,SamPreTrainedModel:()=>ui,SegformerForImageClassification:()=>_s,SegformerForSemanticSegmentation:()=>ws,SegformerModel:()=>gs,SegformerPreTrainedModel:()=>ms,Seq2SeqLMOutput:()=>zo,SequenceClassifierOutput:()=>Bo,SiglipModel:()=>pn,SiglipPreTrainedModel:()=>cn,SiglipTextModel:()=>hn,SiglipVisionModel:()=>fn,SpeechT5ForSpeechToText:()=>Qi,SpeechT5ForTextToSpeech:()=>Ki,SpeechT5HifiGan:()=>Yi,SpeechT5Model:()=>Xi,SpeechT5PreTrainedModel:()=>Hi,SqueezeBertForMaskedLM:()=>et,SqueezeBertForQuestionAnswering:()=>nt,SqueezeBertForSequenceClassification:()=>tt,SqueezeBertModel:()=>Je,SqueezeBertPreTrainedModel:()=>Ze,StableLmForCausalLM:()=>vs,StableLmModel:()=>bs,StableLmPreTrainedModel:()=>ys,Starcoder2ForCausalLM:()=>ss,Starcoder2Model:()=>is,Starcoder2PreTrainedModel:()=>rs,Swin2SRForImageSuperResolution:()=>Nr,Swin2SRModel:()=>Rr,Swin2SRPreTrainedModel:()=>Dr,SwinForImageClassification:()=>Lr,SwinModel:()=>Or,SwinPreTrainedModel:()=>Br,T5ForConditionalGeneration:()=>ut,T5Model:()=>dt,T5PreTrainedModel:()=>lt,TableTransformerForObjectDetection:()=>Sr,TableTransformerModel:()=>$r,TableTransformerObjectDetectionOutput:()=>Cr,TableTransformerPreTrainedModel:()=>kr,TokenClassifierOutput:()=>Lo,TrOCRForCausalLM:()=>Ji,TrOCRPreTrainedModel:()=>Zi,UniSpeechForCTC:()=>$i,UniSpeechForSequenceClassification:()=>Si,UniSpeechModel:()=>ki,UniSpeechPreTrainedModel:()=>Ti,UniSpeechSatForAudioFrameClassification:()=>Fi,UniSpeechSatForCTC:()=>Ei,UniSpeechSatForSequenceClassification:()=>Ai,UniSpeechSatModel:()=>Pi,UniSpeechSatPreTrainedModel:()=>Ci,ViTForImageClassification:()=>ir,ViTModel:()=>rr,ViTPreTrainedModel:()=>nr,VisionEncoderDecoderModel:()=>rn,VitMatteForImageMatting:()=>or,VitMattePreTrainedModel:()=>sr,VitsModel:()=>fs,VitsModelOutput:()=>Uo,VitsPreTrainedModel:()=>hs,Wav2Vec2BertForCTC:()=>Bi,Wav2Vec2BertForSequenceClassification:()=>Oi,Wav2Vec2BertModel:()=>zi,Wav2Vec2BertPreTrainedModel:()=>Ii,Wav2Vec2ForAudioFrameClassification:()=>Mi,Wav2Vec2ForCTC:()=>vi,Wav2Vec2ForSequenceClassification:()=>xi,Wav2Vec2Model:()=>bi,Wav2Vec2PreTrainedModel:()=>yi,WavLMForAudioFrameClassification:()=>Wi,WavLMForCTC:()=>Ui,WavLMForSequenceClassification:()=>Gi,WavLMForXVector:()=>qi,WavLMModel:()=>ji,WavLMPreTrainedModel:()=>Vi,WhisperForConditionalGeneration:()=>nn,WhisperModel:()=>en,WhisperPreTrainedModel:()=>Jt,XLMForQuestionAnswering:()=>Ut,XLMForSequenceClassification:()=>Vt,XLMForTokenClassification:()=>jt,XLMModel:()=>Rt,XLMPreTrainedModel:()=>Dt,XLMRobertaForMaskedLM:()=>Wt,XLMRobertaForQuestionAnswering:()=>Qt,XLMRobertaForSequenceClassification:()=>Ht,XLMRobertaForTokenClassification:()=>Xt,XLMRobertaModel:()=>qt,XLMRobertaPreTrainedModel:()=>Gt,XLMWithLMHeadModel:()=>Nt,XVectorOutput:()=>Oo,YolosForObjectDetection:()=>li,YolosModel:()=>ai,YolosObjectDetectionOutput:()=>di,YolosPreTrainedModel:()=>oi,getPerf:()=>C});var r=n(/*! ./configs.js */"./src/configs.js"),i=n(/*! ./backends/onnx.js */"./src/backends/onnx.js"),s=n(/*! ./utils/dtypes.js */"./src/utils/dtypes.js"),o=n(/*! ./utils/generic.js */"./src/utils/generic.js"),a=n(/*! ./utils/core.js */"./src/utils/core.js"),l=n(/*! ./utils/hub.js */"./src/utils/hub.js"),d=n(/*! ./generation/logits_process.js */"./src/generation/logits_process.js"),u=n(/*! ./generation/configuration_utils.js */"./src/generation/configuration_utils.js"),c=n(/*! ./utils/tensor.js */"./src/utils/tensor.js"),p=n(/*! ./utils/maths.js */"./src/utils/maths.js"),h=n(/*! ./generation/stopping_criteria.js */"./src/generation/stopping_criteria.js"),f=n(/*! ./generation/logits_sampler.js */"./src/generation/logits_sampler.js");const m=0,g=1,_=2,w=3,y=4,b=5,v=6,x=7,M=new Map,T=new Map,k=new Map;async function $(e,t,n){const r=Object.keys(t),o=await Promise.all(r.map((async r=>async function(e,t,n){let r=n.device;r&&"string"!=typeof r&&(r.hasOwnProperty(t)?r=r[t]:(console.warn(`Device not specified for ${t}. Using the default device.`),r=null));const o=(0,i.deviceToExecutionProviders)(r);console.log("- executionProviders -"),console.log(o);let a=n.dtype;if("string"!=typeof a&&(a&&a.hasOwnProperty(t)?a=a[t]:(a=s.DEFAULT_DEVICE_DTYPE_MAPPING[o[0]],console.warn(`Dtype not specified for ${t}. Using the default dtype: ${a}.`))),!s.DEFAULT_DTYPE_SUFFIX_MAPPING.hasOwnProperty(a))throw new Error(`Invalid dtype: ${a}. Should be one of: ${Object.keys(s.DATA_TYPES).join(", ")}`);if(a===s.DATA_TYPES.fp16&&!await(0,s.isFp16Supported)())throw new Error("The device does not support fp16.");const d=s.DEFAULT_DTYPE_SUFFIX_MAPPING[a],u=`${n.subfolder??""}/${t}${d}.onnx`,c=await(0,l.getModelFile)(e,u,!0,n),p={...n.session_options}??{};if(p.executionProviders??=o,void 0!==p.externalData)for(let t=0;t<p.externalData.length;++t){const r=p.externalData[t];if("string"==typeof r.data){const t=await(0,l.getModelFile)(e,r.data,!0,n);r.data=t}}return{buffer:c,session_options:p}}(e,t[r],n)))),a={};for(let e=0;e<r.length;++e){const{buffer:t,session_options:n}=o[e];console.log(n);const s=await(0,i.createInferenceSession)(t,n);a[r[e]]=s}return a}let S={warmup:0,inference:[],throughput:0};function C(){return S}async function P(e,t){S={warmup:0,inference:[],throughput:0};const n=function(e,t){const n=Object.create(null),r=[];for(const s of e.inputNames){const e=t[s];e instanceof c.Tensor?n[s]=(0,i.isONNXProxy)()?e.clone():e:r.push(s)}if(r.length>0)throw new Error(`An error occurred during model execution: "Missing the following inputs: ${r.join(", ")}.`);const s=Object.keys(t).length,o=e.inputNames.length;if(s>o){let n=Object.keys(t).filter((t=>!e.inputNames.includes(t)));console.warn(`WARNING: Too many inputs were provided (${s} > ${o}). The following inputs will be ignored: "${n.join(", ")}".`)}return n}(e,t);try{const t=Object.fromEntries(Object.entries(n).map((([e,t])=>[e,t.ort_tensor])));let r,i,s,o=1,a=100,l=performance.now(),d=[];for(let n=0;n<o+a;n++)i=performance.now(),r=await e.run(t),s=performance.now()-i,0==n?S.warmup=s:d.push(s),console.log(`Session run time: ${s}ms`);S.inference=d,S.throughput=parseFloat((1e3/((performance.now()-l)/(o+a))).toFixed(2)),r=E(r);for(const[e,t]of Object.entries(n))e.startsWith("past_key_values")&&t.dispose();return r}catch(e){throw console.error(`An error occurred during model execution: "${e}".`),console.error("Inputs given to model:",n),e}}function E(e){for(let t in e)(0,i.isONNXTensor)(e[t])?e[t]=new c.Tensor(e[t]):"object"==typeof e[t]&&E(e[t]);return e}function A(e){return new c.Tensor("bool",[e],[1])}async function F(e,t){let{encoder_outputs:n,past_key_values:r}=t;if(!n){const r=(0,a.pick)(t,e.sessions.model.inputNames);n=(await I(e,r)).last_hidden_state}const{input_ids:i,decoder_input_ids:s,...o}=t;o.input_ids=s,o.encoder_hidden_states=n,e.sessions.decoder_model_merged.inputNames.includes("encoder_attention_mask")&&(o.encoder_attention_mask=t.attention_mask);return await z(e,o,!0)}async function I(e,t){const n=e.sessions.model,r=Object.create(null);for(const e of n.inputNames)r[e]=t[e];return n.inputNames.includes("token_type_ids")&&!r.token_type_ids&&(r.token_type_ids=new c.Tensor("int64",new BigInt64Array(r.input_ids.data.length),r.input_ids.dims)),await P(n,r)}async function z(e,t,n=!1){const r=e.sessions[n?"decoder_model_merged":"model"],{past_key_values:i,...s}=t;r.inputNames.includes("use_cache_branch")&&(s.use_cache_branch=A(!!i)),e.addPastKeyValues(s,i);const o=(0,a.pick)(s,r.inputNames);return await P(r,o)}function B(e,t,n,r){if(e.sessions.model.inputNames.includes("position_ids")&&n.attention_mask&&!n.position_ids){const[e,t]=n.attention_mask.dims,r=new BigInt64Array(n.attention_mask.data.length);for(let i=0;i<e;++i){const e=i*t;let s=BigInt(0);for(let i=0;i<t;++i){const t=e+i;0n===n.attention_mask.data[t]?r[t]=BigInt(1):(r[t]=s,s+=n.attention_mask.data[t])}}n.position_ids=new c.Tensor("int64",r,n.attention_mask.dims),n.past_key_values&&(n.position_ids=n.position_ids.slice(null,-1).unsqueeze_(-1))}return n}function O(e,t,n,r){const{...i}=n;return n.past_key_values&&(t=t.map((e=>[e.at(-1)]))),i.decoder_input_ids=function(e){if(e instanceof c.Tensor)return e;if(0===e.length)throw Error("items must be non-empty");if(Array.isArray(e[0])){if(e.some((t=>t.length!==e[0].length)))throw Error("Unable to create tensor, you should probably activate truncation and/or padding with 'padding=True' and/or 'truncation=True' to have batched tensors with the same length.");return new c.Tensor("int64",BigInt64Array.from(e.flat().map((e=>BigInt(e)))),[e.length,e[0].length])}return new c.Tensor("int64",BigInt64Array.from(e.map((e=>BigInt(e)))),[1,e.length])}(t),i}class L extends o.Callable{main_input_name="input_ids";forward_params=["input_ids","attention_mask"];constructor(e,t){super(),this.config=e,this.sessions=t;const n=k.get(this.constructor),r=M.get(n);this.can_generate=!1,this._forward=null,this._prepare_inputs_for_generation=null,r===y?(this.can_generate=!0,this._forward=z,this._prepare_inputs_for_generation=B):r===_||r===w||r===x?(this.can_generate=!0,this._forward=F,this._prepare_inputs_for_generation=O):r===g?this._forward=F:r===v?(this.can_generate=!0,console.warn("TODO: Implement visionDecoderForward")):this._forward=I}async dispose(){const e=[];for(let t of Object.keys(this)){let n=this[t];void 0!==n?.handler?.dispose&&e.push(n.handler.dispose())}return await Promise.all(e)}static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:i=null,local_files_only:s=!1,revision:o="main",model_file_name:a=null,subfolder:d="onnx",device:u=null,dtype:c=null,session_options:p={}}={}){let h={progress_callback:t,config:n,cache_dir:i,local_files_only:s,revision:o,model_file_name:a,subfolder:d,device:u,dtype:c,session_options:p};const f=k.get(this),T=M.get(f);let S;return T===y?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:h.model_file_name??"model"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===_||T===w?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===b?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"vision_encoder",prompt_encoder_mask_decoder:"prompt_encoder_mask_decoder"},h)]):T===g?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},h)]):T===v?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{embed_tokens:"embed_tokens",vision_encoder:"vision_encoder",decoder_model_merged:"decoder_model_merged"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===x?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"text_encoder",decoder_model_merged:"decoder_model_merged",encodec_decode:"encodec_decode"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):(T!==m&&console.warn(`Model type for '${f??n?.model_type}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`),S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:h.model_file_name??"model"},h)])),new this(...S)}async _call(e){return await this.forward(e)}async forward(e){return await this._forward(this,e)}_get_logits_warper(e){const t=new d.LogitsProcessorList;return null!==e.temperature&&1!==e.temperature&&t.push(new d.TemperatureLogitsWarper(e.temperature)),null!==e.top_k&&0!==e.top_k&&t.push(new d.TopKLogitsWarper(e.top_k)),null!==e.top_p&&e.top_p<1&&t.push(new d.TopPLogitsWarper(e.top_p)),t}_get_logits_processor(e,t,n=null){const r=new d.LogitsProcessorList;if(null!==e.repetition_penalty&&1!==e.repetition_penalty&&r.push(new d.RepetitionPenaltyLogitsProcessor(e.repetition_penalty)),null!==e.no_repeat_ngram_size&&e.no_repeat_ngram_size>0&&r.push(new d.NoRepeatNGramLogitsProcessor(e.no_repeat_ngram_size)),null!==e.bad_words_ids&&r.push(new d.NoBadWordsLogitsProcessor(e.bad_words_ids,e.eos_token_id)),null!==e.min_length&&null!==e.eos_token_id&&e.min_length>0&&r.push(new d.MinLengthLogitsProcessor(e.min_length,e.eos_token_id)),null!==e.min_new_tokens&&null!==e.eos_token_id&&e.min_new_tokens>0&&r.push(new d.MinNewTokensLengthLogitsProcessor(t,e.min_new_tokens,e.eos_token_id)),null!==e.forced_bos_token_id&&r.push(new d.ForcedBOSTokenLogitsProcessor(e.forced_bos_token_id)),null!==e.forced_eos_token_id&&r.push(new d.ForcedEOSTokenLogitsProcessor(e.max_length,e.forced_eos_token_id)),null!==e.begin_suppress_tokens){let n=t>1||null===e.forced_bos_token_id?t:t+1;null!==e.forced_decoder_ids&&(n+=e.forced_decoder_ids[e.forced_decoder_ids.length-1][0]),r.push(new d.SuppressTokensAtBeginLogitsProcessor(e.begin_suppress_tokens,n))}return null!==e.guidance_scale&&e.guidance_scale>1&&r.push(new d.ClassifierFreeGuidanceLogitsProcessor(e.guidance_scale)),null!==n&&r.extend(n),r}_prepare_generation_config(e,t){const n=new u.GenerationConfig(this.config);return"generation_config"in this&&Object.assign(n,this.generation_config),e&&Object.assign(n,e),t&&Object.assign(n,(0,a.pick)(t,Object.getOwnPropertyNames(n))),n}_get_stopping_criteria(e,t=null){const n=new h.StoppingCriteriaList;return null!==e.max_length&&n.push(new h.MaxLengthCriteria(e.max_length,this.config.max_position_embeddings??null)),null!==e.eos_token_id&&n.push(new h.EosTokenCriteria(e.eos_token_id)),t&&n.extend(t),n}_validate_model_class(){if(!this.can_generate){const e=[Rs,js,Ds,Is],t=k.get(this.constructor),n=new Set,r=this.config.model_type;for(const t of e){const e=t.get(r);e&&n.add(e[0])}let i=`The current model class (${t}) is not compatible with \`.generate()\`, as it doesn't have a language model head.`;throw n.size>0&&(i+=` Please use the following class instead: ${[...n].join(", ")}`),Error(i)}}prepare_inputs_for_generation(...e){return this._prepare_inputs_for_generation(this,...e)}_update_model_kwargs_for_generation({generated_input_ids:e,outputs:t,model_inputs:n,is_encoder_decoder:r}){return n.past_key_values=this.getPastKeyValues(t,n.past_key_values),n.input_ids=new c.Tensor("int64",e,[e.length,1]),r||(n.attention_mask=(0,c.cat)([n.attention_mask,(0,c.ones)([n.attention_mask.dims[0],1])],1)),n.position_ids=null,n}_prepare_model_inputs({inputs:e,bos_token_id:t,model_kwargs:n}){const r=(0,a.pick)(n,this.forward_params),i=this.main_input_name;if(i in r){if(e)throw new Error("`inputs`: {inputs}` were passed alongside {input_name} which is not allowed. Make sure to either pass {inputs} or {input_name}=...")}else r[i]=e;return{inputs_tensor:r[i],model_inputs:r,model_input_name:i}}async _prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:e,model_inputs:t,model_input_name:n,generation_config:r}){const i=(0,a.pick)(t,this.sessions.model.inputNames);let{last_hidden_state:s}=await I(this,i);return null!==r.guidance_scale&&r.guidance_scale>1&&(s=(0,c.cat)([s,(0,c.full_like)(s,0)],0),"attention_mask"in t&&(t.attention_mask=(0,c.cat)([t.attention_mask,(0,c.zeros_like)(t.attention_mask)],0))),t.encoder_outputs=s,t}_prepare_decoder_input_ids_for_generation({batch_size:e,model_input_name:t,model_kwargs:n,decoder_start_token_id:r,bos_token_id:i,generation_config:s}){let o;if(r=r??i,"musicgen"===this.config.model_type)o=new Array(e*this.config.decoder.num_codebooks).fill(r);else if(Array.isArray(r)){if(r.length!==e)throw new Error(`\`decoder_start_token_id\` expcted to have length ${e} but got ${r.length}`);o=r}else o=new Array(e).fill(r);const a=new c.Tensor("int64",o,[o.length,1]);return n.decoder_attention_mask=(0,c.ones_like)(a),{input_ids:a,model_inputs:n}}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:r=null,streamer:i=null,...s}){this._validate_model_class(),t=this._prepare_generation_config(t,s);let{inputs_tensor:o,model_inputs:a,model_input_name:l}=this._prepare_model_inputs({inputs:e,model_kwargs:s});const d=this.config.is_encoder_decoder;let u;d&&("encoder_outputs"in a||(a=await this._prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:o,model_inputs:a,model_input_name:l,generation_config:t}))),d?({input_ids:u,model_inputs:a}=this._prepare_decoder_input_ids_for_generation({batch_size:a[l].dims.at(0),model_input_name:l,model_kwargs:a,decoder_start_token_id:t.decoder_start_token_id,bos_token_id:t.bos_token_id,generation_config:t})):u=a[l];let p=u.dims.at(-1);null!==t.max_new_tokens&&(t.max_length=p+t.max_new_tokens);const h=this._get_logits_processor(t,p,n),m=this._get_stopping_criteria(t,r),g=a[l].dims.at(0),_=f.LogitsSampler.getSampler(t),w=new Array(g).fill(0),y=u.tolist();for(i&&i.put(y);;){a=this.prepare_inputs_for_generation(y,a,t);const e=await this.forward(a),n=h(y,e.logits.slice(null,-1,null)),r=[];for(let e=0;e<n.dims.at(0);++e){const t=_(n[e]);for(const[n,i]of t){const t=BigInt(n);w[e]+=i,y[e].push(t),r.push(t)}}i&&i.put(y);if(m(y).every((e=>e)))break;a=this._update_model_kwargs_for_generation({generated_input_ids:r,outputs:e,model_inputs:a,is_encoder_decoder:d})}return i&&i.end(),new c.Tensor("int64",y.flat(),[y.length,y[0].length])}addAttentionsToBeam(e,t){if(this.config.is_encoder_decoder){if(!t.cross_attentions||0===t.cross_attentions.length)throw Error("`output_attentions` is true, but the model did not produce cross-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.cross_attentions||(e.cross_attentions=[]),e.cross_attentions.push(t.cross_attentions)}if(!t.decoder_attentions||0===t.decoder_attentions.length)throw Error("`output_attentions` is true, but the model did not produce decoder-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.decoder_attentions||(e.decoder_attentions=[]),e.decoder_attentions.push(t.decoder_attentions)}groupBeams(e){const t=Object.create(null);for(const n of e)void 0===t[n.id]?t[n.id]=[n]:t[n.id].push(n);return Object.values(t)}getPastKeyValues(e,t){const n=Object.create(null);for(const r in e)if(r.startsWith("present")){let i=r.replace("present","past_key_values");t&&r.includes("encoder")?n[i]=t[i]:n[i]=e[r]}return n}getAttentions(e){const t=Object.create(null);for(const n of["cross_attentions","decoder_attentions"]){const r=[];for(const t in e)if(t.startsWith(n)){r[t.split(".").pop()]=e[t]}t[n]=r}return t}addPastKeyValues(e,t){if(t)Object.assign(e,t);else{const t=1,n="float32",r=[];if(this.config.is_encoder_decoder&&(this.add_encoder_pkv??1)){let i=[t,this.num_encoder_heads,0,this.encoder_dim_kv],s=[t,this.num_decoder_heads,0,this.decoder_dim_kv];for(let t=0;t<this.num_decoder_layers;++t)e[`past_key_values.${t}.encoder.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.encoder.value`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.decoder.key`]=new c.Tensor(n,r,s),e[`past_key_values.${t}.decoder.value`]=new c.Tensor(n,r,s)}else if("falcon"===this.config.model_type){let i=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,i)}else if(this.config.multi_query){let i=[t*this.num_heads,0,2*this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key_value`]=new c.Tensor(n,r,i)}else if("bloom"===this.config.model_type){let i=[t*this.num_heads,this.dim_kv,0],s=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,s)}else{let i=[t,this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,i)}}}}class D{}class R extends D{constructor({last_hidden_state:e,hidden_states:t=null,attentions:n=null}){super(),this.last_hidden_state=e,this.hidden_states=t,this.attentions=n}}class N extends L{}class V extends N{}class j extends N{async _call(e){return new Do(await super._call(e))}}class U extends N{async _call(e){return new Bo(await super._call(e))}}class G extends N{async _call(e){return new Lo(await super._call(e))}}class q extends N{async _call(e){return new Ro(await super._call(e))}}class W extends L{}class H extends W{}class X extends L{}class Q extends X{}class K extends X{async _call(e){return new Do(await super._call(e))}}class Y extends X{async _call(e){return new Bo(await super._call(e))}}class Z extends X{async _call(e){return new Lo(await super._call(e))}}class J extends X{async _call(e){return new Ro(await super._call(e))}}class ee extends L{}class te extends ee{}class ne extends ee{async _call(e){return new Do(await super._call(e))}}class re extends ee{async _call(e){return new Bo(await super._call(e))}}class ie extends ee{async _call(e){return new Lo(await super._call(e))}}class se extends ee{async _call(e){return new Ro(await super._call(e))}}class oe extends L{}class ae extends oe{}class le extends oe{async _call(e){return new Do(await super._call(e))}}class de extends oe{async _call(e){return new Bo(await super._call(e))}}class ue extends oe{async _call(e){return new Lo(await super._call(e))}}class ce extends oe{async _call(e){return new Ro(await super._call(e))}}class pe extends L{}class he extends pe{}class fe extends pe{async _call(e){return new Do(await super._call(e))}}class me extends pe{async _call(e){return new Bo(await super._call(e))}}class ge extends pe{async _call(e){return new Lo(await super._call(e))}}class _e extends pe{async _call(e){return new Ro(await super._call(e))}}class we extends L{}class ye extends we{}class be extends we{async _call(e){return new Do(await super._call(e))}}class ve extends we{async _call(e){return new Bo(await super._call(e))}}class xe extends we{async _call(e){return new Lo(await super._call(e))}}class Me extends we{async _call(e){return new Ro(await super._call(e))}}class Te extends L{}class ke extends Te{}class $e extends Te{async _call(e){return new Do(await super._call(e))}}class Se extends Te{async _call(e){return new Bo(await super._call(e))}}class Ce extends Te{async _call(e){return new Lo(await super._call(e))}}class Pe extends Te{async _call(e){return new Ro(await super._call(e))}}class Ee extends L{}class Ae extends Ee{}class Fe extends Ee{async _call(e){return new Bo(await super._call(e))}}class Ie extends Ee{async _call(e){return new Lo(await super._call(e))}}class ze extends Ee{async _call(e){return new Ro(await super._call(e))}}class Be extends Ee{async _call(e){return new Do(await super._call(e))}}class Oe extends L{}class Le extends Oe{}class De extends Oe{async _call(e){return new Do(await super._call(e))}}class Re extends Oe{async _call(e){return new Bo(await super._call(e))}}class Ne extends Oe{async _call(e){return new Lo(await super._call(e))}}class Ve extends L{}class je extends Ve{}class Ue extends Ve{async _call(e){return new Do(await super._call(e))}}class Ge extends Ve{async _call(e){return new Bo(await super._call(e))}}class qe extends Ve{async _call(e){return new Ro(await super._call(e))}}class We extends L{}class He extends We{}class Xe extends We{async _call(e){return new Do(await super._call(e))}}class Qe extends We{async _call(e){return new Bo(await super._call(e))}}class Ke extends We{async _call(e){return new Lo(await super._call(e))}}class Ye extends We{async _call(e){return new Ro(await super._call(e))}}class Ze extends L{}class Je extends Ze{}class et extends Ze{async _call(e){return new Do(await super._call(e))}}class tt extends Ze{async _call(e){return new Bo(await super._call(e))}}class nt extends Ze{async _call(e){return new Ro(await super._call(e))}}class rt extends L{}class it extends rt{}class st extends rt{async _call(e){return new Bo(await super._call(e))}}class ot extends rt{async _call(e){return new Ro(await super._call(e))}}class at extends rt{async _call(e){return new Do(await super._call(e))}}class lt extends L{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class dt extends lt{}class ut extends lt{}class ct extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class pt extends ct{}class ht extends ct{}class ft extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class mt extends ft{}class gt extends ft{}class _t extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class wt extends _t{}class yt extends _t{}class bt extends _t{async _call(e){return new Bo(await super._call(e))}}class vt extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class xt extends vt{}class Mt extends vt{}class Tt extends vt{async _call(e){return new Bo(await super._call(e))}}class kt extends vt{constructor(e,t,n){super(e,t,n),this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class $t extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class St extends $t{}class Ct extends $t{}class Pt extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Et extends Pt{}class At extends Pt{}class Ft extends L{}class It extends Ft{}class zt extends Ft{async _call(e){return new Do(await super._call(e))}}class Bt extends Ft{async _call(e){return new Bo(await super._call(e))}}class Ot extends Ft{async _call(e){return new Lo(await super._call(e))}}class Lt extends Ft{async _call(e){return new Ro(await super._call(e))}}class Dt extends L{}class Rt extends Dt{}class Nt extends Dt{async _call(e){return new Do(await super._call(e))}}class Vt extends Dt{async _call(e){return new Bo(await super._call(e))}}class jt extends Dt{async _call(e){return new Lo(await super._call(e))}}class Ut extends Dt{async _call(e){return new Ro(await super._call(e))}}class Gt extends L{}class qt extends Gt{}class Wt extends Gt{async _call(e){return new Do(await super._call(e))}}class Ht extends Gt{async _call(e){return new Bo(await super._call(e))}}class Xt extends Gt{async _call(e){return new Lo(await super._call(e))}}class Qt extends Gt{async _call(e){return new Ro(await super._call(e))}}class Kt extends L{}class Yt extends Kt{}class Zt extends Kt{}class Jt extends L{requires_attention_mask=!1;main_input_name="input_features";forward_params=["input_features","attention_mask","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class en extends Jt{}class tn extends u.GenerationConfig{return_timestamps=null;return_token_timestamps=null;num_frames=null;alignment_heads=null;task=null;language=null}class nn extends Jt{_retrieve_init_tokens(e){e.decoder_start_token_id;throw new Error("Not implemented yet")}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:r=null,language:i=null,task:s=null,...o}){throw new Error("WhisperForConditionalGeneration.generate is not yet in Transformers.js v3.")}_extract_token_timestamps(e,t,n=null,r=.02){if(!e.cross_attentions)throw new Error("Model outputs must contain cross attentions to extract timestamps. This is most likely because the model was not exported with `output_attentions=True`.");let i=this.config.median_filter_width;void 0===i&&(console.warn("Model config has no `median_filter_width`, using default value of 7."),i=7);const s=e.cross_attentions.map((e=>{let r=Array.from({length:this.config.decoder_layers},((t,n)=>(0,c.cat)(e.map((e=>e[n])),2))),s=(0,c.stack)(t.map((([e,t])=>n?r[e].slice(null,t,null,[0,n]):r[e].slice(null,t))));s=s.transpose(1,0,2,3);let[o,a]=(0,c.std_mean)(s,-2,0,!0),l=s.clone();for(let e=0;e<l.dims[0];++e){let t=l[e];for(let n=0;n<t.dims[0];++n){let r=t[n];const s=o[e][n][0],l=a[e][n][0];for(let e=0;e<r.dims[0];++e){let t=r[e];for(let e=0;e<t.data.length;++e)t.data[e]=(t.data[e]-l.data[e])/s.data[e];t.data.set((0,p.medianFilter)(t.data,i))}}}return(0,c.mean)(l,1)})),o=[e.sequences.length,e.sequences[0].length],l=new c.Tensor("float32",new Float32Array(o[0]*o[1]),o);for(let e=0;e<o[0];++e){const t=s[e].neg().squeeze_(0);let[n,i]=(0,c.dynamicTimeWarping)(t),o=Array.from({length:n.length-1},((e,t)=>n[t+1]-n[t])),d=(0,a.mergeArrays)([1],o).map((e=>!!e)),u=[];for(let e=0;e<d.length;++e)d[e]&&u.push(i[e]*r);l[e].data.set(u,1)}return l}}class rn extends L{main_input_name="pixel_values";constructor(e,t,n){super(e,t),this.generation_config=n;const r=this.config.encoder,i=this.config.decoder,s=r.model_type;(Es.get(s)??As.get(s))||console.warn(`Model type for encoder '${s}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`);const o=Rs.get(i.model_type);if(!o)throw new Error(`Unable to construct \`VisionEncoderDecoder\` due to unsupported decoder: "${this.config.decoder.model_type}"`);const a=new(0,o[1])(i,{},n);this.add_encoder_pkv="num_decoder_layers"in a,this.add_encoder_pkv?(this.num_decoder_layers=a.num_decoder_layers,this.num_decoder_heads=a.num_decoder_heads,this.decoder_dim_kv=a.decoder_dim_kv,this.num_encoder_layers=a.num_encoder_layers,this.num_encoder_heads=a.num_encoder_heads,this.encoder_dim_kv=a.encoder_dim_kv):(this.num_layers=a.num_layers,this.num_heads=a.num_heads,this.dim_kv=a.dim_kv)}}class sn extends L{forward_params=["input_ids","past_key_values","pixel_values","attention_mask"];constructor(e,t,n){super(e,t),this.generation_config=n;const r=this.config.text_config;this.config.pad_token_id=r.eos_token_id,this.num_heads=r.num_attention_heads,this.num_layers=r.num_hidden_layers,this.dim_kv=r.hidden_size/this.num_heads}}class on extends sn{async encode_image({pixel_values:e}){return(await P(this.sessions.vision_encoder,{pixel_values:e})).image_features}async encode_text({input_ids:e}){return(await P(this.sessions.embed_tokens,{input_ids:e})).inputs_embeds}_merge_input_ids_with_image_features({inputs_embeds:e,image_features:t,input_ids:n,attention_mask:r}){const i=this.config.image_token_index,s=n.tolist().map((e=>e.findIndex((e=>e==i)))),o=s.every((e=>-1===e)),a=s.every((e=>-1!==e));if(!o&&!a)throw new Error("Every input should contain either 0 or 1 image token.");if(o)return{inputs_embeds:e,attention_mask:r,position_ids:null};let l=[],d=[];for(let n=0;n<s.length;++n){const i=s[n],o=e[n],a=t[n],u=r[n];l.push((0,c.cat)([o.slice([0,i]),a,o.slice([i+1,o.dims[0]])],0)),d.push((0,c.cat)([u.slice([0,i]),(0,c.ones)([a.dims[0]]),u.slice([i+1,u.dims[0]])],0))}return{inputs_embeds:(0,c.stack)(l,0),attention_mask:(0,c.stack)(d,0),position_ids:null}}prepare_inputs_for_generation(e,t,n){return t}async forward({input_ids:e=null,attention_mask:t=null,pixel_values:n=null,position_ids:r=null,inputs_embeds:i=null,past_key_values:s=null,generation_config:o=null,logits_processor:a=null,...l}){if(!i)if(i=await this.encode_text({input_ids:e}),n&&1!==e.dims[1]){const s=await this.encode_image({pixel_values:n});({inputs_embeds:i,inputs_embeds:i,attention_mask:t,position_ids:r}=this._merge_input_ids_with_image_features({image_features:s,inputs_embeds:i,input_ids:e,attention_mask:t}))}else if(s&&n&&1===e.dims[1]){const n=e.dims[1],r=Object.values(s)[0].dims.at(-2);t=(0,c.cat)([(0,c.ones)([e.dims[0],r]),t.slice(null,[t.dims[1]-n,t.dims[1]])],1)}return await z(this,{inputs_embeds:i,past_key_values:s,attention_mask:t,generation_config:o,logits_processor:a},!0)}}class an extends L{}class ln extends an{}class dn extends an{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class un extends an{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class cn extends L{}class pn extends cn{}class hn extends cn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class fn extends an{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class mn extends L{}class gn extends mn{}class _n extends L{}class wn extends _n{}class yn extends _n{}class bn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class vn extends bn{}class xn extends bn{}class Mn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_heads,this.num_layers=this.config.num_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Tn extends Mn{}class kn extends Mn{}class $n extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Sn extends $n{}class Cn extends $n{}class Pn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class En extends Pn{}class An extends Pn{}class Fn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class In extends Fn{}class zn extends Fn{}class Bn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class On extends Bn{}class Ln extends Bn{}class Dn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads??this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Rn extends Dn{}class Nn extends Dn{}class Vn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads??this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class jn extends Vn{}class Un extends Vn{}class Gn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class qn extends Gn{}class Wn extends Gn{}class Hn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.hidden_size/this.num_heads}}class Xn extends Hn{}class Qn extends Hn{}class Kn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_heads,this.num_layers=this.config.n_layers,this.dim_kv=this.config.d_model/this.num_heads}}class Yn extends Kn{}class Zn extends Kn{}class Jn extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class er extends Jn{}class tr extends Jn{}class nr extends L{}class rr extends nr{}class ir extends nr{async _call(e){return new Bo(await super._call(e))}}class sr extends L{}class or extends sr{async _call(e){return new jo(await super._call(e))}}class ar extends L{}class lr extends ar{}class dr extends ar{async _call(e){return new Bo(await super._call(e))}}class ur extends L{}class cr extends ur{}class pr extends ur{}class hr extends L{}class fr extends hr{}class mr extends hr{}class gr extends L{}class _r extends gr{}class wr extends gr{async _call(e){return new Bo(await super._call(e))}}class yr extends L{}class br extends yr{}class vr extends yr{async _call(e){return new Mr(await super._call(e))}}class xr extends yr{async _call(e){return new Tr(await super._call(e))}}class Mr extends D{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class Tr extends D{constructor({logits:e,pred_boxes:t,pred_masks:n}){super(),this.logits=e,this.pred_boxes=t,this.pred_masks=n}}class kr extends L{}class $r extends kr{}class Sr extends kr{async _call(e){return new Cr(await super._call(e))}}class Cr extends Mr{}class Pr extends L{}class Er extends Pr{}class Ar extends Pr{async _call(e){return new Bo(await super._call(e))}}class Fr extends L{}class Ir extends Fr{}class zr extends Fr{async _call(e){return new Bo(await super._call(e))}}class Br extends L{}class Or extends Br{}class Lr extends Br{async _call(e){return new Bo(await super._call(e))}}class Dr extends L{}class Rr extends Dr{}class Nr extends Dr{}class Vr extends L{}class jr extends Vr{}class Ur extends Vr{}class Gr extends L{}class qr extends Gr{}class Wr extends L{}class Hr extends Wr{}class Xr extends Wr{}class Qr extends L{}class Kr extends Qr{}class Yr extends L{}class Zr extends Yr{}class Jr extends Yr{async _call(e){return new Bo(await super._call(e))}}class ei extends L{}class ti extends ei{}class ni extends ei{async _call(e){return new Bo(await super._call(e))}}class ri extends L{}class ii extends ri{}class si extends ri{async _call(e){return new Bo(await super._call(e))}}class oi extends L{}class ai extends oi{}class li extends oi{async _call(e){return new di(await super._call(e))}}class di extends D{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class ui extends L{}class ci extends ui{async get_image_embeddings({pixel_values:e}){return await I(this,{pixel_values:e})}async forward(e){if(e.image_embeddings&&e.image_positional_embeddings||(e={...e,...await this.get_image_embeddings(e)}),!e.input_labels&&e.input_points){const t=e.input_points.dims.slice(0,-1),n=t.reduce(((e,t)=>e*t),1);e.input_labels=new c.Tensor("int64",new BigInt64Array(n).fill(1n),t)}const t={image_embeddings:e.image_embeddings,image_positional_embeddings:e.image_positional_embeddings};return e.input_points&&(t.input_points=e.input_points),e.input_labels&&(t.input_labels=e.input_labels),e.input_boxes&&(t.input_boxes=e.input_boxes),await P(this.sessions.prompt_encoder_mask_decoder,t)}async _call(e){return new pi(await super._call(e))}}class pi extends D{constructor({iou_scores:e,pred_masks:t}){super(),this.iou_scores=e,this.pred_masks=t}}class hi extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class fi extends hi{}class mi extends hi{}class gi extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class _i extends gi{}class wi extends gi{}class yi extends L{}class bi extends yi{}class vi extends yi{async _call(e){return new No(await super._call(e))}}class xi extends yi{async _call(e){return new Bo(await super._call(e))}}class Mi extends yi{async _call(e){return new Lo(await super._call(e))}}class Ti extends L{}class ki extends Ti{}class $i extends Ti{async _call(e){return new No(await super._call(e))}}class Si extends Ti{async _call(e){return new Bo(await super._call(e))}}class Ci extends L{}class Pi extends Ci{}class Ei extends Ci{async _call(e){return new No(await super._call(e))}}class Ai extends Ci{async _call(e){return new Bo(await super._call(e))}}class Fi extends Ci{async _call(e){return new Lo(await super._call(e))}}class Ii extends L{}class zi extends Ii{}class Bi extends Ii{async _call(e){return new No(await super._call(e))}}class Oi extends Ii{async _call(e){return new Bo(await super._call(e))}}class Li extends L{}class Di extends yi{}class Ri extends yi{async _call(e){return new No(await super._call(e))}}class Ni extends yi{async _call(e){return new Bo(await super._call(e))}}class Vi extends L{}class ji extends Vi{}class Ui extends Vi{async _call(e){return new No(await super._call(e))}}class Gi extends Vi{async _call(e){return new Bo(await super._call(e))}}class qi extends Vi{async _call(e){return new Oo(await super._call(e))}}class Wi extends Vi{async _call(e){return new Lo(await super._call(e))}}class Hi extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.hidden_size/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.hidden_size/this.num_encoder_heads}}class Xi extends Hi{}class Qi extends Hi{}class Ki extends Hi{async generate_speech(e,t,{threshold:n=.5,minlenratio:r=0,maxlenratio:i=20,vocoder:s=null}={}){const o={input_ids:e},{encoder_outputs:a,encoder_attention_mask:l}=await I(this,o),d=a.dims[1]/this.config.reduction_factor,u=Math.floor(d*i),p=Math.floor(d*r),h=this.config.num_mel_bins;let f=[],m=null,g=null,_=0;for(;;){++_;const e=A(!!g);let r;r=g?g.output_sequence_out:new c.Tensor("float32",new Float32Array(h),[1,1,h]);let i={use_cache_branch:e,output_sequence:r,encoder_attention_mask:l,speaker_embeddings:t,encoder_hidden_states:a};this.addPastKeyValues(i,m),g=await P(this.sessions.decoder_model_merged,i),m=this.getPastKeyValues(g,m);const{prob:s,spectrum:o}=g;if(f.push(o),_>=p&&(Array.from(s.data).filter((e=>e>=n)).length>0||_>=u))break}const w=(0,c.cat)(f),{waveform:y}=await P(s.sessions.model,{spectrogram:w});return{spectrogram:w,waveform:y}}}class Yi extends L{main_input_name="spectrogram"}class Zi extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_encoder_layers=this.num_decoder_layers=this.config.decoder_layers,this.num_encoder_heads=this.num_decoder_heads=this.config.decoder_attention_heads,this.encoder_dim_kv=this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads}}class Ji extends Zi{}class es extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class ts extends es{}class ns extends es{}class rs extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class is extends rs{}class ss extends rs{}class os extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class as extends os{}class ls extends os{}class ds extends L{}class us extends ds{}class cs extends ds{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class ps extends ds{static async from_pretrained(e,t={}){return t.model_file_name??="audio_model",super.from_pretrained(e,t)}}class hs extends L{}class fs extends hs{async _call(e){return new Uo(await super._call(e))}}class ms extends L{}class gs extends ms{}class _s extends ms{}class ws extends ms{}class ys extends L{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class bs extends ys{}class vs extends ys{}class xs extends L{}class Ms extends xs{}class Ts extends xs{async _call(e){return new Bo(await super._call(e))}}class ks extends L{}class $s extends ks{}class Ss extends ks{}class Cs extends L{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n;const r=e.decoder;this.num_encoder_layers=this.num_decoder_layers=r.num_hidden_layers,this.num_encoder_heads=this.num_decoder_heads=r.num_attention_heads,this.encoder_dim_kv=this.decoder_dim_kv=r.hidden_size/this.num_decoder_heads}_apply_and_filter_by_delay_pattern_mask(e){const[t,n]=e.dims,r=this.config.decoder.num_codebooks,i=n-r;let s=0;for(let t=0;t<e.size;++t){if(e.data[t]===this.config.decoder.pad_token_id)continue;const o=t%n-Math.floor(t/n)%r;o>0&&o<=i&&(e.data[s++]=e.data[t])}const o=Math.floor(t/r),a=s/(o*r);return new c.Tensor(e.type,e.data.slice(0,s),[o,r,a])}prepare_inputs_for_generation(e,t,n){let r=structuredClone(e);for(let e=0;e<r.length;++e)for(let t=0;t<r[e].length;++t)e%this.config.decoder.num_codebooks>=t&&(r[e][t]=BigInt(this.config.decoder.pad_token_id));null!==n.guidance_scale&&n.guidance_scale>1&&(r=r.concat(r));return super.prepare_inputs_for_generation(r,t,n)}async generate(e){const t=await super.generate(e),n=this._apply_and_filter_by_delay_pattern_mask(t).unsqueeze_(0),{audio_values:r}=await P(this.sessions.encodec_decode,{audio_codes:n});return r}}class Ps{static MODEL_CLASS_MAPPINGS=null;static BASE_IF_FAIL=!1;static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:i=null,local_files_only:s=!1,revision:o="main",model_file_name:a=null,subfolder:l="onnx",device:d=null,dtype:u=null,session_options:c={}}={}){let p={progress_callback:t,config:n,cache_dir:i,local_files_only:s,revision:o,model_file_name:a,subfolder:l,device:d,dtype:u,session_options:c};if(n=await r.AutoConfig.from_pretrained(e,p),p.config||(p.config=n),!this.MODEL_CLASS_MAPPINGS)throw new Error("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: "+this.name);for(let t of this.MODEL_CLASS_MAPPINGS){const r=t.get(n.model_type);if(r)return await r[1].from_pretrained(e,p)}if(this.BASE_IF_FAIL)return console.warn(`Unknown model class "${n.model_type}", attempting to construct from base class.`),await L.from_pretrained(e,p);throw Error(`Unsupported model type: ${n.model_type}`)}}const Es=new Map([["bert",["BertModel",V]],["nomic_bert",["NomicBertModel",H]],["roformer",["RoFormerModel",Q]],["electra",["ElectraModel",ae]],["esm",["EsmModel",Le]],["convbert",["ConvBertModel",te]],["camembert",["CamembertModel",he]],["deberta",["DebertaModel",ye]],["deberta-v2",["DebertaV2Model",ke]],["mpnet",["MPNetModel",He]],["albert",["AlbertModel",it]],["distilbert",["DistilBertModel",Ae]],["roberta",["RobertaModel",It]],["xlm",["XLMModel",Rt]],["xlm-roberta",["XLMRobertaModel",qt]],["clap",["ClapModel",us]],["clip",["CLIPModel",ln]],["clipseg",["CLIPSegModel",wn]],["chinese_clip",["ChineseCLIPModel",gn]],["siglip",["SiglipModel",pn]],["mobilebert",["MobileBertModel",je]],["squeezebert",["SqueezeBertModel",Je]],["wav2vec2",["Wav2Vec2Model",bi]],["wav2vec2-bert",["Wav2Vec2BertModel",zi]],["unispeech",["UniSpeechModel",ki]],["unispeech-sat",["UniSpeechSatModel",Pi]],["hubert",["HubertModel",Di]],["wavlm",["WavLMModel",ji]],["audio-spectrogram-transformer",["ASTModel",Yt]],["vits",["VitsModel",fs]],["detr",["DetrModel",br]],["table-transformer",["TableTransformerModel",$r]],["vit",["ViTModel",rr]],["mobilevit",["MobileViTModel",lr]],["owlvit",["OwlViTModel",cr]],["owlv2",["Owlv2Model",fr]],["beit",["BeitModel",_r]],["deit",["DeiTModel",Er]],["convnext",["ConvNextModel",Zr]],["convnextv2",["ConvNextV2Model",ti]],["dinov2",["Dinov2Model",ii]],["resnet",["ResNetModel",Ir]],["swin",["SwinModel",Or]],["swin2sr",["Swin2SRModel",Rr]],["donut-swin",["DonutSwinModel",Kr]],["yolos",["YolosModel",ai]],["dpt",["DPTModel",jr]],["glpn",["GLPNModel",Hr]],["hifigan",["SpeechT5HifiGan",Yi]],["efficientnet",["EfficientNetModel",Ms]]]),As=new Map([["t5",["T5Model",dt]],["longt5",["LongT5Model",pt]],["mt5",["MT5Model",mt]],["bart",["BartModel",wt]],["mbart",["MBartModel",xt]],["marian",["MarianModel",fi]],["whisper",["WhisperModel",en]],["m2m_100",["M2M100Model",_i]],["blenderbot",["BlenderbotModel",St]],["blenderbot-small",["BlenderbotSmallModel",Et]]]),Fs=new Map([["bloom",["BloomModel",Xn]],["gpt2",["GPT2Model",vn]],["gptj",["GPTJModel",En]],["gpt_bigcode",["GPTBigCodeModel",In]],["gpt_neo",["GPTNeoModel",Tn]],["gpt_neox",["GPTNeoXModel",Sn]],["codegen",["CodeGenModel",On]],["llama",["LlamaModel",Rn]],["qwen2",["Qwen2Model",jn]],["phi",["PhiModel",qn]],["mpt",["MptModel",Yn]],["opt",["OPTModel",er]],["mistral",["MistralModel",ts]],["starcoder2",["Starcoder2Model",is]],["falcon",["FalconModel",as]]]),Is=new Map([["speecht5",["SpeechT5ForSpeechToText",Qi]],["whisper",["WhisperForConditionalGeneration",nn]]]),zs=new Map([["speecht5",["SpeechT5ForTextToSpeech",Ki]]]),Bs=new Map([["vits",["VitsModel",fs]],["musicgen",["MusicgenForConditionalGeneration",Cs]]]),Os=new Map([["bert",["BertForSequenceClassification",U]],["roformer",["RoFormerForSequenceClassification",Y]],["electra",["ElectraForSequenceClassification",de]],["esm",["EsmForSequenceClassification",Re]],["convbert",["ConvBertForSequenceClassification",re]],["camembert",["CamembertForSequenceClassification",me]],["deberta",["DebertaForSequenceClassification",ve]],["deberta-v2",["DebertaV2ForSequenceClassification",Se]],["mpnet",["MPNetForSequenceClassification",Qe]],["albert",["AlbertForSequenceClassification",st]],["distilbert",["DistilBertForSequenceClassification",Fe]],["roberta",["RobertaForSequenceClassification",Bt]],["xlm",["XLMForSequenceClassification",Vt]],["xlm-roberta",["XLMRobertaForSequenceClassification",Ht]],["bart",["BartForSequenceClassification",bt]],["mbart",["MBartForSequenceClassification",Tt]],["mobilebert",["MobileBertForSequenceClassification",Ge]],["squeezebert",["SqueezeBertForSequenceClassification",tt]]]),Ls=new Map([["bert",["BertForTokenClassification",G]],["roformer",["RoFormerForTokenClassification",Z]],["electra",["ElectraForTokenClassification",ue]],["esm",["EsmForTokenClassification",Ne]],["convbert",["ConvBertForTokenClassification",ie]],["camembert",["CamembertForTokenClassification",ge]],["deberta",["DebertaForTokenClassification",xe]],["deberta-v2",["DebertaV2ForTokenClassification",Ce]],["mpnet",["MPNetForTokenClassification",Ke]],["distilbert",["DistilBertForTokenClassification",Ie]],["roberta",["RobertaForTokenClassification",Ot]],["xlm",["XLMForTokenClassification",jt]],["xlm-roberta",["XLMRobertaForTokenClassification",Xt]]]),Ds=new Map([["t5",["T5ForConditionalGeneration",ut]],["longt5",["LongT5ForConditionalGeneration",ht]],["mt5",["MT5ForConditionalGeneration",gt]],["bart",["BartForConditionalGeneration",yt]],["mbart",["MBartForConditionalGeneration",Mt]],["marian",["MarianMTModel",mi]],["m2m_100",["M2M100ForConditionalGeneration",wi]],["blenderbot",["BlenderbotForConditionalGeneration",Ct]],["blenderbot-small",["BlenderbotSmallForConditionalGeneration",At]]]),Rs=new Map([["bloom",["BloomForCausalLM",Qn]],["gpt2",["GPT2LMHeadModel",xn]],["gptj",["GPTJForCausalLM",An]],["gpt_bigcode",["GPTBigCodeForCausalLM",zn]],["gpt_neo",["GPTNeoForCausalLM",kn]],["gpt_neox",["GPTNeoXForCausalLM",Cn]],["codegen",["CodeGenForCausalLM",Ln]],["llama",["LlamaForCausalLM",Nn]],["qwen2",["Qwen2ForCausalLM",Un]],["phi",["PhiForCausalLM",Wn]],["mpt",["MptForCausalLM",Zn]],["opt",["OPTForCausalLM",tr]],["mbart",["MBartForCausalLM",kt]],["mistral",["MistralForCausalLM",ns]],["starcoder2",["Starcoder2ForCausalLM",ss]],["falcon",["FalconForCausalLM",ls]],["trocr",["TrOCRForCausalLM",Ji]],["stablelm",["StableLmForCausalLM",vs]]]),Ns=new Map([["bert",["BertForMaskedLM",j]],["roformer",["RoFormerForMaskedLM",K]],["electra",["ElectraForMaskedLM",le]],["esm",["EsmForMaskedLM",De]],["convbert",["ConvBertForMaskedLM",ne]],["camembert",["CamembertForMaskedLM",fe]],["deberta",["DebertaForMaskedLM",be]],["deberta-v2",["DebertaV2ForMaskedLM",$e]],["mpnet",["MPNetForMaskedLM",Xe]],["albert",["AlbertForMaskedLM",at]],["distilbert",["DistilBertForMaskedLM",Be]],["roberta",["RobertaForMaskedLM",zt]],["xlm",["XLMWithLMHeadModel",Nt]],["xlm-roberta",["XLMRobertaForMaskedLM",Wt]],["mobilebert",["MobileBertForMaskedLM",Ue]],["squeezebert",["SqueezeBertForMaskedLM",et]]]),Vs=new Map([["bert",["BertForQuestionAnswering",q]],["roformer",["RoFormerForQuestionAnswering",J]],["electra",["ElectraForQuestionAnswering",ce]],["convbert",["ConvBertForQuestionAnswering",se]],["camembert",["CamembertForQuestionAnswering",_e]],["deberta",["DebertaForQuestionAnswering",Me]],["deberta-v2",["DebertaV2ForQuestionAnswering",Pe]],["mpnet",["MPNetForQuestionAnswering",Ye]],["albert",["AlbertForQuestionAnswering",ot]],["distilbert",["DistilBertForQuestionAnswering",ze]],["roberta",["RobertaForQuestionAnswering",Lt]],["xlm",["XLMForQuestionAnswering",Ut]],["xlm-roberta",["XLMRobertaForQuestionAnswering",Qt]],["mobilebert",["MobileBertForQuestionAnswering",qe]],["squeezebert",["SqueezeBertForQuestionAnswering",nt]]]),js=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",rn]]]),Us=new Map([["llava",["LlavaForConditionalGeneration",on]]]),Gs=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",rn]]]),qs=new Map([["vit",["ViTForImageClassification",ir]],["mobilevit",["MobileViTForImageClassification",dr]],["beit",["BeitForImageClassification",wr]],["deit",["DeiTForImageClassification",Ar]],["convnext",["ConvNextForImageClassification",Jr]],["convnextv2",["ConvNextV2ForImageClassification",ni]],["dinov2",["Dinov2ForImageClassification",si]],["resnet",["ResNetForImageClassification",zr]],["swin",["SwinForImageClassification",Lr]],["segformer",["SegformerForImageClassification",_s]],["efficientnet",["EfficientNetForImageClassification",Ts]]]),Ws=new Map([["detr",["DetrForObjectDetection",vr]],["table-transformer",["TableTransformerForObjectDetection",Sr]],["yolos",["YolosForObjectDetection",li]]]),Hs=new Map([["owlvit",["OwlViTForObjectDetection",pr]],["owlv2",["Owlv2ForObjectDetection",mr]]]),Xs=new Map([["detr",["DetrForSegmentation",xr]],["clipseg",["CLIPSegForImageSegmentation",yn]]]),Qs=new Map([["segformer",["SegformerForSemanticSegmentation",ws]]]),Ks=new Map([["sam",["SamModel",ci]]]),Ys=new Map([["wav2vec2",["Wav2Vec2ForCTC",vi]],["wav2vec2-bert",["Wav2Vec2BertForCTC",Bi]],["unispeech",["UniSpeechForCTC",$i]],["unispeech-sat",["UniSpeechSatForCTC",Ei]],["wavlm",["WavLMForCTC",Ui]],["hubert",["HubertForCTC",Ri]]]),Zs=new Map([["wav2vec2",["Wav2Vec2ForSequenceClassification",xi]],["wav2vec2-bert",["Wav2Vec2BertForSequenceClassification",Oi]],["unispeech",["UniSpeechForSequenceClassification",Si]],["unispeech-sat",["UniSpeechSatForSequenceClassification",Ai]],["wavlm",["WavLMForSequenceClassification",Gi]],["hubert",["HubertForSequenceClassification",Ni]],["audio-spectrogram-transformer",["ASTForAudioClassification",Zt]]]),Js=new Map([["wavlm",["WavLMForXVector",qi]]]),eo=new Map([["unispeech-sat",["UniSpeechSatForAudioFrameClassification",Fi]],["wavlm",["WavLMForAudioFrameClassification",Wi]],["wav2vec2",["Wav2Vec2ForAudioFrameClassification",Mi]]]),to=new Map([["vitmatte",["VitMatteForImageMatting",or]]]),no=new Map([["swin2sr",["Swin2SRForImageSuperResolution",Nr]]]),ro=new Map([["dpt",["DPTForDepthEstimation",Ur]],["depth_anything",["DepthAnythingForDepthEstimation",qr]],["glpn",["GLPNForDepthEstimation",Xr]]]),io=new Map([["clip",["CLIPVisionModelWithProjection",un]],["siglip",["SiglipVisionModel",fn]]]),so=[[Es,m],[As,g],[Fs,y],[Os,m],[Ls,m],[Ds,_],[Is,_],[Rs,y],[Ns,m],[Vs,m],[js,w],[Us,v],[qs,m],[Xs,m],[Qs,m],[to,m],[no,m],[ro,m],[Ws,m],[Hs,m],[Ks,b],[Ys,m],[Zs,m],[zs,_],[Bs,m],[Js,m],[eo,m],[io,m]];for(const[e,t]of so)for(const[n,r]of e.values())M.set(n,t),k.set(r,n),T.set(n,r);const oo=[["MusicgenForConditionalGeneration",Cs,x],["CLIPTextModelWithProjection",dn,m],["SiglipTextModel",hn,m],["ClapTextModelWithProjection",cs,m],["ClapAudioModelWithProjection",ps,m]];for(const[e,t,n]of oo)M.set(e,n),k.set(t,e),T.set(e,t);class ao extends Ps{static MODEL_CLASS_MAPPINGS=so.map((e=>e[0]));static BASE_IF_FAIL=!0}class lo extends Ps{static MODEL_CLASS_MAPPINGS=[Os]}class uo extends Ps{static MODEL_CLASS_MAPPINGS=[Ls]}class co extends Ps{static MODEL_CLASS_MAPPINGS=[Ds]}class po extends Ps{static MODEL_CLASS_MAPPINGS=[Is]}class ho extends Ps{static MODEL_CLASS_MAPPINGS=[zs]}class fo extends Ps{static MODEL_CLASS_MAPPINGS=[Bs]}class mo extends Ps{static MODEL_CLASS_MAPPINGS=[Rs]}class go extends Ps{static MODEL_CLASS_MAPPINGS=[Ns]}class _o extends Ps{static MODEL_CLASS_MAPPINGS=[Vs]}class wo extends Ps{static MODEL_CLASS_MAPPINGS=[js]}class yo extends Ps{static MODEL_CLASS_MAPPINGS=[qs]}class bo extends Ps{static MODEL_CLASS_MAPPINGS=[Xs]}class vo extends Ps{static MODEL_CLASS_MAPPINGS=[Qs]}class xo extends Ps{static MODEL_CLASS_MAPPINGS=[Ws]}class Mo extends Ps{static MODEL_CLASS_MAPPINGS=[Hs]}class To extends Ps{static MODEL_CLASS_MAPPINGS=[Ks]}class ko extends Ps{static MODEL_CLASS_MAPPINGS=[Ys]}class $o extends Ps{static MODEL_CLASS_MAPPINGS=[Zs]}class So extends Ps{static MODEL_CLASS_MAPPINGS=[Js]}class Co extends Ps{static MODEL_CLASS_MAPPINGS=[eo]}class Po extends Ps{static MODEL_CLASS_MAPPINGS=[Gs]}class Eo extends Ps{static MODEL_CLASS_MAPPINGS=[to]}class Ao extends Ps{static MODEL_CLASS_MAPPINGS=[no]}class Fo extends Ps{static MODEL_CLASS_MAPPINGS=[ro]}class Io extends Ps{static MODEL_CLASS_MAPPINGS=[io]}class zo extends D{constructor({logits:e,past_key_values:t,encoder_outputs:n,decoder_attentions:r=null,cross_attentions:i=null}){super(),this.logits=e,this.past_key_values=t,this.encoder_outputs=n,this.decoder_attentions=r,this.cross_attentions=i}}class Bo extends D{constructor({logits:e}){super(),this.logits=e}}class Oo extends D{constructor({logits:e,embeddings:t}){super(),this.logits=e,this.embeddings=t}}class Lo extends D{constructor({logits:e}){super(),this.logits=e}}class Do extends D{constructor({logits:e}){super(),this.logits=e}}class Ro extends D{constructor({start_logits:e,end_logits:t}){super(),this.start_logits=e,this.end_logits=t}}class No extends D{constructor({logits:e}){super(),this.logits=e}}class Vo extends D{constructor({logits:e,past_key_values:t}){super(),this.logits=e,this.past_key_values=t}}class jo extends D{constructor({alphas:e}){super(),this.alphas=e}}class Uo extends D{constructor({waveform:e,spectrogram:t}){super(),this.waveform=e,this.spectrogram=t}}},"./src/ops/registry.js":
/*!*****************************!*\
  !*** ./src/ops/registry.js ***!
