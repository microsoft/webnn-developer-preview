...
/*!***********************!*\
  !*** ./src/models.js ***!
  \***********************/(e,t,n)=>{n.r(t),n.d(t,{ASTForAudioClassification:()=>Kt,ASTModel:()=>Qt,ASTPreTrainedModel:()=>Xt,AlbertForMaskedLM:()=>st,AlbertForQuestionAnswering:()=>it,AlbertForSequenceClassification:()=>rt,AlbertModel:()=>nt,AlbertPreTrainedModel:()=>tt,AutoModel:()=>so,AutoModelForAudioClassification:()=>To,AutoModelForAudioFrameClassification:()=>$o,AutoModelForCTC:()=>Mo,AutoModelForCausalLM:()=>ho,AutoModelForDepthEstimation:()=>Eo,AutoModelForDocumentQuestionAnswering:()=>So,AutoModelForImageClassification:()=>_o,AutoModelForImageFeatureExtraction:()=>Ao,AutoModelForImageMatting:()=>Co,AutoModelForImageSegmentation:()=>wo,AutoModelForImageToImage:()=>Po,AutoModelForMaskGeneration:()=>xo,AutoModelForMaskedLM:()=>fo,AutoModelForObjectDetection:()=>bo,AutoModelForQuestionAnswering:()=>mo,AutoModelForSemanticSegmentation:()=>yo,AutoModelForSeq2SeqLM:()=>lo,AutoModelForSequenceClassification:()=>oo,AutoModelForSpeechSeq2Seq:()=>uo,AutoModelForTextToSpectrogram:()=>co,AutoModelForTextToWaveform:()=>po,AutoModelForTokenClassification:()=>ao,AutoModelForVision2Seq:()=>go,AutoModelForXVector:()=>ko,AutoModelForZeroShotObjectDetection:()=>vo,BartForConditionalGeneration:()=>_t,BartForSequenceClassification:()=>wt,BartModel:()=>gt,BartPretrainedModel:()=>mt,BaseModelOutput:()=>L,BeitForImageClassification:()=>gr,BeitModel:()=>mr,BeitPreTrainedModel:()=>fr,BertForMaskedLM:()=>N,BertForQuestionAnswering:()=>U,BertForSequenceClassification:()=>V,BertForTokenClassification:()=>j,BertModel:()=>R,BertPreTrainedModel:()=>D,BlenderbotForConditionalGeneration:()=>$t,BlenderbotModel:()=>kt,BlenderbotPreTrainedModel:()=>Tt,BlenderbotSmallForConditionalGeneration:()=>Pt,BlenderbotSmallModel:()=>Ct,BlenderbotSmallPreTrainedModel:()=>St,BloomForCausalLM:()=>Hn,BloomModel:()=>Wn,BloomPreTrainedModel:()=>qn,CLIPModel:()=>on,CLIPPreTrainedModel:()=>sn,CLIPSegForImageSegmentation:()=>_n,CLIPSegModel:()=>gn,CLIPSegPreTrainedModel:()=>mn,CLIPTextModelWithProjection:()=>an,CLIPVisionModelWithProjection:()=>ln,CamembertForMaskedLM:()=>pe,CamembertForQuestionAnswering:()=>me,CamembertForSequenceClassification:()=>he,CamembertForTokenClassification:()=>fe,CamembertModel:()=>ce,CamembertPreTrainedModel:()=>ue,CausalLMOutput:()=>Do,CausalLMOutputWithPast:()=>Ro,ChineseCLIPModel:()=>fn,ChineseCLIPPreTrainedModel:()=>hn,ClapAudioModelWithProjection:()=>us,ClapModel:()=>ls,ClapPreTrainedModel:()=>as,ClapTextModelWithProjection:()=>ds,CodeGenForCausalLM:()=>Bn,CodeGenModel:()=>zn,CodeGenPreTrainedModel:()=>In,ConvBertForMaskedLM:()=>ee,ConvBertForQuestionAnswering:()=>re,ConvBertForSequenceClassification:()=>te,ConvBertForTokenClassification:()=>ne,ConvBertModel:()=>J,ConvBertPreTrainedModel:()=>Z,ConvNextForImageClassification:()=>Yr,ConvNextModel:()=>Kr,ConvNextPreTrainedModel:()=>Qr,ConvNextV2ForImageClassification:()=>ei,ConvNextV2Model:()=>Jr,ConvNextV2PreTrainedModel:()=>Zr,DPTForDepthEstimation:()=>Vr,DPTModel:()=>Nr,DPTPreTrainedModel:()=>Rr,DebertaForMaskedLM:()=>we,DebertaForQuestionAnswering:()=>ve,DebertaForSequenceClassification:()=>ye,DebertaForTokenClassification:()=>be,DebertaModel:()=>_e,DebertaPreTrainedModel:()=>ge,DebertaV2ForMaskedLM:()=>Te,DebertaV2ForQuestionAnswering:()=>Se,DebertaV2ForSequenceClassification:()=>ke,DebertaV2ForTokenClassification:()=>$e,DebertaV2Model:()=>Me,DebertaV2PreTrainedModel:()=>xe,DeiTForImageClassification:()=>Pr,DeiTModel:()=>Cr,DeiTPreTrainedModel:()=>Sr,DepthAnythingForDepthEstimation:()=>Ur,DepthAnythingPreTrainedModel:()=>jr,DetrForObjectDetection:()=>yr,DetrForSegmentation:()=>br,DetrModel:()=>wr,DetrObjectDetectionOutput:()=>vr,DetrPreTrainedModel:()=>_r,DetrSegmentationOutput:()=>xr,Dinov2ForImageClassification:()=>ri,Dinov2Model:()=>ni,Dinov2PreTrainedModel:()=>ti,DistilBertForMaskedLM:()=>Ie,DistilBertForQuestionAnswering:()=>Fe,DistilBertForSequenceClassification:()=>Ee,DistilBertForTokenClassification:()=>Ae,DistilBertModel:()=>Pe,DistilBertPreTrainedModel:()=>Ce,DonutSwinModel:()=>Xr,DonutSwinPreTrainedModel:()=>Hr,EfficientNetForImageClassification:()=>xs,EfficientNetModel:()=>vs,EfficientNetPreTrainedModel:()=>bs,ElectraForMaskedLM:()=>oe,ElectraForQuestionAnswering:()=>de,ElectraForSequenceClassification:()=>ae,ElectraForTokenClassification:()=>le,ElectraModel:()=>se,ElectraPreTrainedModel:()=>ie,EsmForMaskedLM:()=>Oe,EsmForSequenceClassification:()=>Le,EsmForTokenClassification:()=>De,EsmModel:()=>Be,EsmPreTrainedModel:()=>ze,FalconForCausalLM:()=>os,FalconModel:()=>ss,FalconPreTrainedModel:()=>is,GLPNForDepthEstimation:()=>Wr,GLPNModel:()=>qr,GLPNPreTrainedModel:()=>Gr,GPT2LMHeadModel:()=>bn,GPT2Model:()=>yn,GPT2PreTrainedModel:()=>wn,GPTBigCodeForCausalLM:()=>Fn,GPTBigCodeModel:()=>An,GPTBigCodePreTrainedModel:()=>En,GPTJForCausalLM:()=>Pn,GPTJModel:()=>Cn,GPTJPreTrainedModel:()=>Sn,GPTNeoForCausalLM:()=>Mn,GPTNeoModel:()=>xn,GPTNeoPreTrainedModel:()=>vn,GPTNeoXForCausalLM:()=>$n,GPTNeoXModel:()=>kn,GPTNeoXPreTrainedModel:()=>Tn,HubertForCTC:()=>Li,HubertForSequenceClassification:()=>Di,HubertModel:()=>Oi,HubertPreTrainedModel:()=>Bi,ImageMattingOutput:()=>No,LlamaForCausalLM:()=>Dn,LlamaModel:()=>Ln,LlamaPreTrainedModel:()=>On,LlavaForConditionalGeneration:()=>rn,LlavaPreTrainedModel:()=>nn,LongT5ForConditionalGeneration:()=>ct,LongT5Model:()=>ut,LongT5PreTrainedModel:()=>dt,M2M100ForConditionalGeneration:()=>gi,M2M100Model:()=>mi,M2M100PreTrainedModel:()=>fi,MBartForCausalLM:()=>Mt,MBartForConditionalGeneration:()=>vt,MBartForSequenceClassification:()=>xt,MBartModel:()=>bt,MBartPreTrainedModel:()=>yt,MPNetForMaskedLM:()=>We,MPNetForQuestionAnswering:()=>Qe,MPNetForSequenceClassification:()=>He,MPNetForTokenClassification:()=>Xe,MPNetModel:()=>qe,MPNetPreTrainedModel:()=>Ge,MT5ForConditionalGeneration:()=>ft,MT5Model:()=>ht,MT5PreTrainedModel:()=>pt,MarianMTModel:()=>hi,MarianModel:()=>pi,MarianPreTrainedModel:()=>ci,MaskedLMOutput:()=>Oo,MistralForCausalLM:()=>es,MistralModel:()=>Ji,MistralPreTrainedModel:()=>Zi,MobileBertForMaskedLM:()=>Ve,MobileBertForQuestionAnswering:()=>Ue,MobileBertForSequenceClassification:()=>je,MobileBertModel:()=>Ne,MobileBertPreTrainedModel:()=>Re,MobileViTForImageClassification:()=>ar,MobileViTModel:()=>or,MobileViTPreTrainedModel:()=>sr,ModelOutput:()=>O,MptForCausalLM:()=>Kn,MptModel:()=>Qn,MptPreTrainedModel:()=>Xn,MusicgenForCausalLM:()=>ks,MusicgenForConditionalGeneration:()=>$s,MusicgenModel:()=>Ts,MusicgenPreTrainedModel:()=>Ms,NomicBertModel:()=>q,NomicBertPreTrainedModel:()=>G,OPTForCausalLM:()=>Jn,OPTModel:()=>Zn,OPTPreTrainedModel:()=>Yn,OwlViTForObjectDetection:()=>ur,OwlViTModel:()=>dr,OwlViTPreTrainedModel:()=>lr,Owlv2ForObjectDetection:()=>hr,Owlv2Model:()=>pr,Owlv2PreTrainedModel:()=>cr,PhiForCausalLM:()=>Gn,PhiModel:()=>Un,PhiPreTrainedModel:()=>jn,PreTrainedModel:()=>B,PretrainedMixin:()=>Ss,QuestionAnsweringModelOutput:()=>Lo,Qwen2ForCausalLM:()=>Vn,Qwen2Model:()=>Nn,Qwen2PreTrainedModel:()=>Rn,ResNetForImageClassification:()=>Fr,ResNetModel:()=>Ar,ResNetPreTrainedModel:()=>Er,RoFormerForMaskedLM:()=>X,RoFormerForQuestionAnswering:()=>Y,RoFormerForSequenceClassification:()=>Q,RoFormerForTokenClassification:()=>K,RoFormerModel:()=>H,RoFormerPreTrainedModel:()=>W,RobertaForMaskedLM:()=>Ft,RobertaForQuestionAnswering:()=>Bt,RobertaForSequenceClassification:()=>It,RobertaForTokenClassification:()=>zt,RobertaModel:()=>At,RobertaPreTrainedModel:()=>Et,SamImageSegmentationOutput:()=>ui,SamModel:()=>di,SamPreTrainedModel:()=>li,SegformerForImageClassification:()=>ms,SegformerForSemanticSegmentation:()=>gs,SegformerModel:()=>fs,SegformerPreTrainedModel:()=>hs,Seq2SeqLMOutput:()=>Fo,SequenceClassifierOutput:()=>Io,SiglipModel:()=>un,SiglipPreTrainedModel:()=>dn,SiglipTextModel:()=>cn,SiglipVisionModel:()=>pn,SpeechT5ForSpeechToText:()=>Hi,SpeechT5ForTextToSpeech:()=>Xi,SpeechT5HifiGan:()=>Qi,SpeechT5Model:()=>Wi,SpeechT5PreTrainedModel:()=>qi,SqueezeBertForMaskedLM:()=>Ze,SqueezeBertForQuestionAnswering:()=>et,SqueezeBertForSequenceClassification:()=>Je,SqueezeBertModel:()=>Ye,SqueezeBertPreTrainedModel:()=>Ke,StableLmForCausalLM:()=>ys,StableLmModel:()=>ws,StableLmPreTrainedModel:()=>_s,Starcoder2ForCausalLM:()=>rs,Starcoder2Model:()=>ns,Starcoder2PreTrainedModel:()=>ts,Swin2SRForImageSuperResolution:()=>Dr,Swin2SRModel:()=>Lr,Swin2SRPreTrainedModel:()=>Or,SwinForImageClassification:()=>Br,SwinModel:()=>zr,SwinPreTrainedModel:()=>Ir,T5ForConditionalGeneration:()=>lt,T5Model:()=>at,T5PreTrainedModel:()=>ot,TableTransformerForObjectDetection:()=>kr,TableTransformerModel:()=>Tr,TableTransformerObjectDetectionOutput:()=>$r,TableTransformerPreTrainedModel:()=>Mr,TokenClassifierOutput:()=>Bo,TrOCRForCausalLM:()=>Yi,TrOCRPreTrainedModel:()=>Ki,UniSpeechForCTC:()=>Ti,UniSpeechForSequenceClassification:()=>ki,UniSpeechModel:()=>Mi,UniSpeechPreTrainedModel:()=>xi,UniSpeechSatForAudioFrameClassification:()=>Ei,UniSpeechSatForCTC:()=>Ci,UniSpeechSatForSequenceClassification:()=>Pi,UniSpeechSatModel:()=>Si,UniSpeechSatPreTrainedModel:()=>$i,ViTForImageClassification:()=>nr,ViTModel:()=>tr,ViTPreTrainedModel:()=>er,VisionEncoderDecoderModel:()=>tn,VitMatteForImageMatting:()=>ir,VitMattePreTrainedModel:()=>rr,VitsModel:()=>ps,VitsModelOutput:()=>Vo,VitsPreTrainedModel:()=>cs,Wav2Vec2BertForCTC:()=>Ii,Wav2Vec2BertForSequenceClassification:()=>zi,Wav2Vec2BertModel:()=>Fi,Wav2Vec2BertPreTrainedModel:()=>Ai,Wav2Vec2ForAudioFrameClassification:()=>vi,Wav2Vec2ForCTC:()=>yi,Wav2Vec2ForSequenceClassification:()=>bi,Wav2Vec2Model:()=>wi,Wav2Vec2PreTrainedModel:()=>_i,WavLMForAudioFrameClassification:()=>Gi,WavLMForCTC:()=>Vi,WavLMForSequenceClassification:()=>ji,WavLMForXVector:()=>Ui,WavLMModel:()=>Ni,WavLMPreTrainedModel:()=>Ri,WhisperForConditionalGeneration:()=>en,WhisperModel:()=>Zt,WhisperPreTrainedModel:()=>Yt,XLMForQuestionAnswering:()=>Vt,XLMForSequenceClassification:()=>Rt,XLMForTokenClassification:()=>Nt,XLMModel:()=>Lt,XLMPreTrainedModel:()=>Ot,XLMRobertaForMaskedLM:()=>Gt,XLMRobertaForQuestionAnswering:()=>Ht,XLMRobertaForSequenceClassification:()=>qt,XLMRobertaForTokenClassification:()=>Wt,XLMRobertaModel:()=>Ut,XLMRobertaPreTrainedModel:()=>jt,XLMWithLMHeadModel:()=>Dt,XVectorOutput:()=>zo,YolosForObjectDetection:()=>oi,YolosModel:()=>si,YolosObjectDetectionOutput:()=>ai,YolosPreTrainedModel:()=>ii});var r=n(/*! ./configs.js */"./src/configs.js"),i=n(/*! ./backends/onnx.js */"./src/backends/onnx.js"),s=n(/*! ./utils/dtypes.js */"./src/utils/dtypes.js"),o=n(/*! ./utils/generic.js */"./src/utils/generic.js"),a=n(/*! ./utils/core.js */"./src/utils/core.js"),l=n(/*! ./utils/hub.js */"./src/utils/hub.js"),d=n(/*! ./generation/logits_process.js */"./src/generation/logits_process.js"),u=n(/*! ./generation/configuration_utils.js */"./src/generation/configuration_utils.js"),c=n(/*! ./utils/tensor.js */"./src/utils/tensor.js"),p=n(/*! ./utils/maths.js */"./src/utils/maths.js"),h=n(/*! ./generation/stopping_criteria.js */"./src/generation/stopping_criteria.js"),f=n(/*! ./generation/logits_sampler.js */"./src/generation/logits_sampler.js");const m=0,g=1,_=2,w=3,y=4,b=5,v=6,x=7,M=new Map,T=new Map,k=new Map;async function $(e,t,n){const r=Object.keys(t),o=await Promise.all(r.map((async r=>async function(e,t,n){let r=n.device;r&&"string"!=typeof r&&(r.hasOwnProperty(t)?r=r[t]:(console.warn(`Device not specified for ${t}. Using the default device.`),r=null));const o=(0,i.deviceToExecutionProviders)(r);let a=n.dtype;if("string"!=typeof a&&(a&&a.hasOwnProperty(t)?a=a[t]:(a=s.DEFAULT_DEVICE_DTYPE_MAPPING[o[0]],console.warn(`Dtype not specified for ${t}. Using the default dtype: ${a}.`))),!s.DEFAULT_DTYPE_SUFFIX_MAPPING.hasOwnProperty(a))throw new Error(`Invalid dtype: ${a}. Should be one of: ${Object.keys(s.DATA_TYPES).join(", ")}`);if(a===s.DATA_TYPES.fp16&&!await(0,s.isFp16Supported)())throw new Error("The device does not support fp16.");const d=s.DEFAULT_DTYPE_SUFFIX_MAPPING[a],u=`${n.subfolder??""}/${t}${d}.onnx`,c=await(0,l.getModelFile)(e,u,!0,n),p={...n.session_options}??{};if(p.executionProviders??=o,void 0!==p.externalData)for(let t=0;t<p.externalData.length;++t){const r=p.externalData[t];if("string"==typeof r.data){const t=await(0,l.getModelFile)(e,r.data,!0,n);r.data=t}}return{buffer:c,session_options:p}}(e,t[r],n)))),a={};for(let e=0;e<r.length;++e){const{buffer:t,session_options:n}=o[e],s=await(0,i.createInferenceSession)(t,n);a[r[e]]=s}return a}async function S(e,t){const n=function(e,t){const n=Object.create(null),r=[];for(const s of e.inputNames){const e=t[s];e instanceof c.Tensor?n[s]=(0,i.isONNXProxy)()?e.clone():e:r.push(s)}if(r.length>0)throw new Error(`An error occurred during model execution: "Missing the following inputs: ${r.join(", ")}.`);const s=Object.keys(t).length,o=e.inputNames.length;if(s>o){let n=Object.keys(t).filter((t=>!e.inputNames.includes(t)));console.warn(`WARNING: Too many inputs were provided (${s} > ${o}). The following inputs will be ignored: "${n.join(", ")}".`)}return n}(e,t);try{const t=Object.fromEntries(Object.entries(n).map((([e,t])=>[e,t.ort_tensor])));let r=await e.run(t);r=C(r);for(const[e,t]of Object.entries(n))e.startsWith("past_key_values")&&t.dispose();return r}catch(e){throw console.error(`An error occurred during model execution: "${e}".`),console.error("Inputs given to model:",n),e}}function C(e){for(let t in e)(0,i.isONNXTensor)(e[t])?e[t]=new c.Tensor(e[t]):"object"==typeof e[t]&&C(e[t]);return e}function P(e){return new c.Tensor("bool",[e],[1])}async function E(e,t){let{encoder_outputs:n,past_key_values:r}=t;if(!n){const r=(0,a.pick)(t,e.sessions.model.inputNames);n=(await A(e,r)).last_hidden_state}const{input_ids:i,decoder_input_ids:s,...o}=t;o.input_ids=s,o.encoder_hidden_states=n,e.sessions.decoder_model_merged.inputNames.includes("encoder_attention_mask")&&(o.encoder_attention_mask=t.attention_mask);return await F(e,o,!0)}async function A(e,t){const n=e.sessions.model,r=Object.create(null);for(const e of n.inputNames)r[e]=t[e];return n.inputNames.includes("token_type_ids")&&!r.token_type_ids&&(r.token_type_ids=new c.Tensor("int64",new BigInt64Array(r.input_ids.data.length),r.input_ids.dims)),await S(n,r)}async function F(e,t,n=!1){const r=e.sessions[n?"decoder_model_merged":"model"],{past_key_values:i,...s}=t;r.inputNames.includes("use_cache_branch")&&(s.use_cache_branch=P(!!i)),e.addPastKeyValues(s,i);const o=(0,a.pick)(s,r.inputNames);return await S(r,o)}function I(e,t,n,r){if(e.sessions.model.inputNames.includes("position_ids")&&n.attention_mask&&!n.position_ids){const[e,t]=n.attention_mask.dims,r=new BigInt64Array(n.attention_mask.data.length);for(let i=0;i<e;++i){const e=i*t;let s=BigInt(0);for(let i=0;i<t;++i){const t=e+i;0n===n.attention_mask.data[t]?r[t]=BigInt(1):(r[t]=s,s+=n.attention_mask.data[t])}}n.position_ids=new c.Tensor("int64",r,n.attention_mask.dims),n.past_key_values&&(n.position_ids=n.position_ids.slice(null,-1).unsqueeze_(-1))}return n}function z(e,t,n,r){const{...i}=n;return n.past_key_values&&(t=t.map((e=>[e.at(-1)]))),i.decoder_input_ids=function(e){if(e instanceof c.Tensor)return e;if(0===e.length)throw Error("items must be non-empty");if(Array.isArray(e[0])){if(e.some((t=>t.length!==e[0].length)))throw Error("Unable to create tensor, you should probably activate truncation and/or padding with 'padding=True' and/or 'truncation=True' to have batched tensors with the same length.");return new c.Tensor("int64",BigInt64Array.from(e.flat().map((e=>BigInt(e)))),[e.length,e[0].length])}return new c.Tensor("int64",BigInt64Array.from(e.map((e=>BigInt(e)))),[1,e.length])}(t),i}class B extends o.Callable{main_input_name="input_ids";forward_params=["input_ids","attention_mask"];constructor(e,t){super(),this.config=e,this.sessions=t;const n=k.get(this.constructor),r=M.get(n);this.can_generate=!1,this._forward=null,this._prepare_inputs_for_generation=null,r===y?(this.can_generate=!0,this._forward=F,this._prepare_inputs_for_generation=I):r===_||r===w||r===x?(this.can_generate=!0,this._forward=E,this._prepare_inputs_for_generation=z):r===g?this._forward=E:r===v?(this.can_generate=!0,console.warn("TODO: Implement visionDecoderForward")):this._forward=A}async dispose(){const e=[];for(let t of Object.keys(this)){let n=this[t];void 0!==n?.handler?.dispose&&e.push(n.handler.dispose())}return await Promise.all(e)}static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:i=null,local_files_only:s=!1,revision:o="main",model_file_name:a=null,subfolder:d="onnx",device:u=null,dtype:c=null,session_options:p={}}={}){let h={progress_callback:t,config:n,cache_dir:i,local_files_only:s,revision:o,model_file_name:a,subfolder:d,device:u,dtype:c,session_options:p};const f=k.get(this),T=M.get(f);let S;return T===y?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:h.model_file_name??"model"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===_||T===w?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===b?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"vision_encoder",prompt_encoder_mask_decoder:"prompt_encoder_mask_decoder"},h)]):T===g?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"encoder_model",decoder_model_merged:"decoder_model_merged"},h)]):T===v?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{embed_tokens:"embed_tokens",vision_encoder:"vision_encoder",decoder_model_merged:"decoder_model_merged"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):T===x?S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:"text_encoder",decoder_model_merged:"decoder_model_merged",encodec_decode:"encodec_decode"},h),(0,l.getModelJSON)(e,"generation_config.json",!1,h)]):(T!==m&&console.warn(`Model type for '${f??n?.model_type}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`),S=await Promise.all([r.AutoConfig.from_pretrained(e,h),$(e,{model:h.model_file_name??"model"},h)])),new this(...S)}async _call(e){return await this.forward(e)}async forward(e){return await this._forward(this,e)}_get_logits_warper(e){const t=new d.LogitsProcessorList;return null!==e.temperature&&1!==e.temperature&&t.push(new d.TemperatureLogitsWarper(e.temperature)),null!==e.top_k&&0!==e.top_k&&t.push(new d.TopKLogitsWarper(e.top_k)),null!==e.top_p&&e.top_p<1&&t.push(new d.TopPLogitsWarper(e.top_p)),t}_get_logits_processor(e,t,n=null){const r=new d.LogitsProcessorList;if(null!==e.repetition_penalty&&1!==e.repetition_penalty&&r.push(new d.RepetitionPenaltyLogitsProcessor(e.repetition_penalty)),null!==e.no_repeat_ngram_size&&e.no_repeat_ngram_size>0&&r.push(new d.NoRepeatNGramLogitsProcessor(e.no_repeat_ngram_size)),null!==e.bad_words_ids&&r.push(new d.NoBadWordsLogitsProcessor(e.bad_words_ids,e.eos_token_id)),null!==e.min_length&&null!==e.eos_token_id&&e.min_length>0&&r.push(new d.MinLengthLogitsProcessor(e.min_length,e.eos_token_id)),null!==e.min_new_tokens&&null!==e.eos_token_id&&e.min_new_tokens>0&&r.push(new d.MinNewTokensLengthLogitsProcessor(t,e.min_new_tokens,e.eos_token_id)),null!==e.forced_bos_token_id&&r.push(new d.ForcedBOSTokenLogitsProcessor(e.forced_bos_token_id)),null!==e.forced_eos_token_id&&r.push(new d.ForcedEOSTokenLogitsProcessor(e.max_length,e.forced_eos_token_id)),null!==e.begin_suppress_tokens){let n=t>1||null===e.forced_bos_token_id?t:t+1;null!==e.forced_decoder_ids&&(n+=e.forced_decoder_ids[e.forced_decoder_ids.length-1][0]),r.push(new d.SuppressTokensAtBeginLogitsProcessor(e.begin_suppress_tokens,n))}return null!==e.guidance_scale&&e.guidance_scale>1&&r.push(new d.ClassifierFreeGuidanceLogitsProcessor(e.guidance_scale)),null!==n&&r.extend(n),r}_prepare_generation_config(e,t){const n=new u.GenerationConfig(this.config);return"generation_config"in this&&Object.assign(n,this.generation_config),e&&Object.assign(n,e),t&&Object.assign(n,(0,a.pick)(t,Object.getOwnPropertyNames(n))),n}_get_stopping_criteria(e,t=null){const n=new h.StoppingCriteriaList;return null!==e.max_length&&n.push(new h.MaxLengthCriteria(e.max_length,this.config.max_position_embeddings??null)),null!==e.eos_token_id&&n.push(new h.EosTokenCriteria(e.eos_token_id)),t&&n.extend(t),n}_validate_model_class(){if(!this.can_generate){const e=[Ls,Ns,Os,As],t=k.get(this.constructor),n=new Set,r=this.config.model_type;for(const t of e){const e=t.get(r);e&&n.add(e[0])}let i=`The current model class (${t}) is not compatible with \`.generate()\`, as it doesn't have a language model head.`;throw n.size>0&&(i+=` Please use the following class instead: ${[...n].join(", ")}`),Error(i)}}prepare_inputs_for_generation(...e){return this._prepare_inputs_for_generation(this,...e)}_update_model_kwargs_for_generation({generated_input_ids:e,outputs:t,model_inputs:n,is_encoder_decoder:r}){return n.past_key_values=this.getPastKeyValues(t,n.past_key_values),n.input_ids=new c.Tensor("int64",e,[e.length,1]),r||(n.attention_mask=(0,c.cat)([n.attention_mask,(0,c.ones)([n.attention_mask.dims[0],1])],1)),n.position_ids=null,n}_prepare_model_inputs({inputs:e,bos_token_id:t,model_kwargs:n}){const r=(0,a.pick)(n,this.forward_params),i=this.main_input_name;if(i in r){if(e)throw new Error("`inputs`: {inputs}` were passed alongside {input_name} which is not allowed. Make sure to either pass {inputs} or {input_name}=...")}else r[i]=e;return{inputs_tensor:r[i],model_inputs:r,model_input_name:i}}async _prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:e,model_inputs:t,model_input_name:n,generation_config:r}){const i=(0,a.pick)(t,this.sessions.model.inputNames);let{last_hidden_state:s}=await A(this,i);return null!==r.guidance_scale&&r.guidance_scale>1&&(s=(0,c.cat)([s,(0,c.full_like)(s,0)],0),"attention_mask"in t&&(t.attention_mask=(0,c.cat)([t.attention_mask,(0,c.zeros_like)(t.attention_mask)],0))),t.encoder_outputs=s,t}_prepare_decoder_input_ids_for_generation({batch_size:e,model_input_name:t,model_kwargs:n,decoder_start_token_id:r,bos_token_id:i,generation_config:s}){let o;if(r=r??i,"musicgen"===this.config.model_type)o=new Array(e*this.config.decoder.num_codebooks).fill(r);else if(Array.isArray(r)){if(r.length!==e)throw new Error(`\`decoder_start_token_id\` expcted to have length ${e} but got ${r.length}`);o=r}else o=new Array(e).fill(r);const a=new c.Tensor("int64",o,[o.length,1]);return n.decoder_attention_mask=(0,c.ones_like)(a),{input_ids:a,model_inputs:n}}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:r=null,streamer:i=null,...s}){this._validate_model_class(),t=this._prepare_generation_config(t,s);let{inputs_tensor:o,model_inputs:a,model_input_name:l}=this._prepare_model_inputs({inputs:e,model_kwargs:s});const d=this.config.is_encoder_decoder;let u;d&&("encoder_outputs"in a||(a=await this._prepare_encoder_decoder_kwargs_for_generation({inputs_tensor:o,model_inputs:a,model_input_name:l,generation_config:t}))),d?({input_ids:u,model_inputs:a}=this._prepare_decoder_input_ids_for_generation({batch_size:a[l].dims.at(0),model_input_name:l,model_kwargs:a,decoder_start_token_id:t.decoder_start_token_id,bos_token_id:t.bos_token_id,generation_config:t})):u=a[l];let p=u.dims.at(-1);null!==t.max_new_tokens&&(t.max_length=p+t.max_new_tokens);const h=this._get_logits_processor(t,p,n),m=this._get_stopping_criteria(t,r),g=a[l].dims.at(0),_=f.LogitsSampler.getSampler(t),w=new Array(g).fill(0),y=u.tolist();for(i&&i.put(y);;){a=this.prepare_inputs_for_generation(y,a,t);const e=await this.forward(a),n=h(y,e.logits.slice(null,-1,null)),r=[];for(let e=0;e<n.dims.at(0);++e){const t=_(n[e]);for(const[n,i]of t){const t=BigInt(n);w[e]+=i,y[e].push(t),r.push(t)}}i&&i.put(y);if(m(y).every((e=>e)))break;a=this._update_model_kwargs_for_generation({generated_input_ids:r,outputs:e,model_inputs:a,is_encoder_decoder:d})}return i&&i.end(),new c.Tensor("int64",y.flat(),[y.length,y[0].length])}addAttentionsToBeam(e,t){if(this.config.is_encoder_decoder){if(!t.cross_attentions||0===t.cross_attentions.length)throw Error("`output_attentions` is true, but the model did not produce cross-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.cross_attentions||(e.cross_attentions=[]),e.cross_attentions.push(t.cross_attentions)}if(!t.decoder_attentions||0===t.decoder_attentions.length)throw Error("`output_attentions` is true, but the model did not produce decoder-attentions. This is most likely because the model was not exported with `output_attentions=True`.");e.decoder_attentions||(e.decoder_attentions=[]),e.decoder_attentions.push(t.decoder_attentions)}groupBeams(e){const t=Object.create(null);for(const n of e)void 0===t[n.id]?t[n.id]=[n]:t[n.id].push(n);return Object.values(t)}getPastKeyValues(e,t){const n=Object.create(null);for(const r in e)if(r.startsWith("present")){let i=r.replace("present","past_key_values");t&&r.includes("encoder")?n[i]=t[i]:n[i]=e[r]}return n}getAttentions(e){const t=Object.create(null);for(const n of["cross_attentions","decoder_attentions"]){const r=[];for(const t in e)if(t.startsWith(n)){r[t.split(".").pop()]=e[t]}t[n]=r}return t}addPastKeyValues(e,t){if(t)Object.assign(e,t);else{const t=1,n="float32",r=[];if(this.config.is_encoder_decoder&&(this.add_encoder_pkv??1)){let i=[t,this.num_encoder_heads,0,this.encoder_dim_kv],s=[t,this.num_decoder_heads,0,this.decoder_dim_kv];for(let t=0;t<this.num_decoder_layers;++t)e[`past_key_values.${t}.encoder.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.encoder.value`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.decoder.key`]=new c.Tensor(n,r,s),e[`past_key_values.${t}.decoder.value`]=new c.Tensor(n,r,s)}else if("falcon"===this.config.model_type){let i=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,i)}else if(this.config.multi_query){let i=[t*this.num_heads,0,2*this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key_value`]=new c.Tensor(n,r,i)}else if("bloom"===this.config.model_type){let i=[t*this.num_heads,this.dim_kv,0],s=[t*this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,s)}else{let i=[t,this.num_heads,0,this.dim_kv];for(let t=0;t<this.num_layers;++t)e[`past_key_values.${t}.key`]=new c.Tensor(n,r,i),e[`past_key_values.${t}.value`]=new c.Tensor(n,r,i)}}}}class O{}class L extends O{constructor({last_hidden_state:e,hidden_states:t=null,attentions:n=null}){super(),this.last_hidden_state=e,this.hidden_states=t,this.attentions=n}}class D extends B{}class R extends D{}class N extends D{async _call(e){return new Oo(await super._call(e))}}class V extends D{async _call(e){return new Io(await super._call(e))}}class j extends D{async _call(e){return new Bo(await super._call(e))}}class U extends D{async _call(e){return new Lo(await super._call(e))}}class G extends B{}class q extends G{}class W extends B{}class H extends W{}class X extends W{async _call(e){return new Oo(await super._call(e))}}class Q extends W{async _call(e){return new Io(await super._call(e))}}class K extends W{async _call(e){return new Bo(await super._call(e))}}class Y extends W{async _call(e){return new Lo(await super._call(e))}}class Z extends B{}class J extends Z{}class ee extends Z{async _call(e){return new Oo(await super._call(e))}}class te extends Z{async _call(e){return new Io(await super._call(e))}}class ne extends Z{async _call(e){return new Bo(await super._call(e))}}class re extends Z{async _call(e){return new Lo(await super._call(e))}}class ie extends B{}class se extends ie{}class oe extends ie{async _call(e){return new Oo(await super._call(e))}}class ae extends ie{async _call(e){return new Io(await super._call(e))}}class le extends ie{async _call(e){return new Bo(await super._call(e))}}class de extends ie{async _call(e){return new Lo(await super._call(e))}}class ue extends B{}class ce extends ue{}class pe extends ue{async _call(e){return new Oo(await super._call(e))}}class he extends ue{async _call(e){return new Io(await super._call(e))}}class fe extends ue{async _call(e){return new Bo(await super._call(e))}}class me extends ue{async _call(e){return new Lo(await super._call(e))}}class ge extends B{}class _e extends ge{}class we extends ge{async _call(e){return new Oo(await super._call(e))}}class ye extends ge{async _call(e){return new Io(await super._call(e))}}class be extends ge{async _call(e){return new Bo(await super._call(e))}}class ve extends ge{async _call(e){return new Lo(await super._call(e))}}class xe extends B{}class Me extends xe{}class Te extends xe{async _call(e){return new Oo(await super._call(e))}}class ke extends xe{async _call(e){return new Io(await super._call(e))}}class $e extends xe{async _call(e){return new Bo(await super._call(e))}}class Se extends xe{async _call(e){return new Lo(await super._call(e))}}class Ce extends B{}class Pe extends Ce{}class Ee extends Ce{async _call(e){return new Io(await super._call(e))}}class Ae extends Ce{async _call(e){return new Bo(await super._call(e))}}class Fe extends Ce{async _call(e){return new Lo(await super._call(e))}}class Ie extends Ce{async _call(e){return new Oo(await super._call(e))}}class ze extends B{}class Be extends ze{}class Oe extends ze{async _call(e){return new Oo(await super._call(e))}}class Le extends ze{async _call(e){return new Io(await super._call(e))}}class De extends ze{async _call(e){return new Bo(await super._call(e))}}class Re extends B{}class Ne extends Re{}class Ve extends Re{async _call(e){return new Oo(await super._call(e))}}class je extends Re{async _call(e){return new Io(await super._call(e))}}class Ue extends Re{async _call(e){return new Lo(await super._call(e))}}class Ge extends B{}class qe extends Ge{}class We extends Ge{async _call(e){return new Oo(await super._call(e))}}class He extends Ge{async _call(e){return new Io(await super._call(e))}}class Xe extends Ge{async _call(e){return new Bo(await super._call(e))}}class Qe extends Ge{async _call(e){return new Lo(await super._call(e))}}class Ke extends B{}class Ye extends Ke{}class Ze extends Ke{async _call(e){return new Oo(await super._call(e))}}class Je extends Ke{async _call(e){return new Io(await super._call(e))}}class et extends Ke{async _call(e){return new Lo(await super._call(e))}}class tt extends B{}class nt extends tt{}class rt extends tt{async _call(e){return new Io(await super._call(e))}}class it extends tt{async _call(e){return new Lo(await super._call(e))}}class st extends tt{async _call(e){return new Oo(await super._call(e))}}class ot extends B{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class at extends ot{}class lt extends ot{}class dt extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class ut extends dt{}class ct extends dt{}class pt extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.num_decoder_layers,this.num_decoder_heads=this.config.num_heads,this.decoder_dim_kv=this.config.d_kv,this.num_encoder_layers=this.config.num_layers,this.num_encoder_heads=this.config.num_heads,this.encoder_dim_kv=this.config.d_kv}}class ht extends pt{}class ft extends pt{}class mt extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class gt extends mt{}class _t extends mt{}class wt extends mt{async _call(e){return new Io(await super._call(e))}}class yt extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class bt extends yt{}class vt extends yt{}class xt extends yt{async _call(e){return new Io(await super._call(e))}}class Mt extends yt{constructor(e,t,n){super(e,t,n),this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Tt extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class kt extends Tt{}class $t extends Tt{}class St extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Ct extends St{}class Pt extends St{}class Et extends B{}class At extends Et{}class Ft extends Et{async _call(e){return new Oo(await super._call(e))}}class It extends Et{async _call(e){return new Io(await super._call(e))}}class zt extends Et{async _call(e){return new Bo(await super._call(e))}}class Bt extends Et{async _call(e){return new Lo(await super._call(e))}}class Ot extends B{}class Lt extends Ot{}class Dt extends Ot{async _call(e){return new Oo(await super._call(e))}}class Rt extends Ot{async _call(e){return new Io(await super._call(e))}}class Nt extends Ot{async _call(e){return new Bo(await super._call(e))}}class Vt extends Ot{async _call(e){return new Lo(await super._call(e))}}class jt extends B{}class Ut extends jt{}class Gt extends jt{async _call(e){return new Oo(await super._call(e))}}class qt extends jt{async _call(e){return new Io(await super._call(e))}}class Wt extends jt{async _call(e){return new Bo(await super._call(e))}}class Ht extends jt{async _call(e){return new Lo(await super._call(e))}}class Xt extends B{}class Qt extends Xt{}class Kt extends Xt{}class Yt extends B{requires_attention_mask=!1;main_input_name="input_features";forward_params=["input_features","attention_mask","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class Zt extends Yt{}class Jt extends u.GenerationConfig{return_timestamps=null;return_token_timestamps=null;num_frames=null;alignment_heads=null;task=null;language=null}class en extends Yt{_retrieve_init_tokens(e){e.decoder_start_token_id;throw new Error("Not implemented yet")}async generate({inputs:e=null,generation_config:t=null,logits_processor:n=null,stopping_criteria:r=null,language:i=null,task:s=null,...o}){throw new Error("WhisperForConditionalGeneration.generate is not yet in Transformers.js v3.")}_extract_token_timestamps(e,t,n=null,r=.02){if(!e.cross_attentions)throw new Error("Model outputs must contain cross attentions to extract timestamps. This is most likely because the model was not exported with `output_attentions=True`.");let i=this.config.median_filter_width;void 0===i&&(console.warn("Model config has no `median_filter_width`, using default value of 7."),i=7);const s=e.cross_attentions.map((e=>{let r=Array.from({length:this.config.decoder_layers},((t,n)=>(0,c.cat)(e.map((e=>e[n])),2))),s=(0,c.stack)(t.map((([e,t])=>n?r[e].slice(null,t,null,[0,n]):r[e].slice(null,t))));s=s.transpose(1,0,2,3);let[o,a]=(0,c.std_mean)(s,-2,0,!0),l=s.clone();for(let e=0;e<l.dims[0];++e){let t=l[e];for(let n=0;n<t.dims[0];++n){let r=t[n];const s=o[e][n][0],l=a[e][n][0];for(let e=0;e<r.dims[0];++e){let t=r[e];for(let e=0;e<t.data.length;++e)t.data[e]=(t.data[e]-l.data[e])/s.data[e];t.data.set((0,p.medianFilter)(t.data,i))}}}return(0,c.mean)(l,1)})),o=[e.sequences.length,e.sequences[0].length],l=new c.Tensor("float32",new Float32Array(o[0]*o[1]),o);for(let e=0;e<o[0];++e){const t=s[e].neg().squeeze_(0);let[n,i]=(0,c.dynamicTimeWarping)(t),o=Array.from({length:n.length-1},((e,t)=>n[t+1]-n[t])),d=(0,a.mergeArrays)([1],o).map((e=>!!e)),u=[];for(let e=0;e<d.length;++e)d[e]&&u.push(i[e]*r);l[e].data.set(u,1)}return l}}class tn extends B{main_input_name="pixel_values";constructor(e,t,n){super(e,t),this.generation_config=n;const r=this.config.encoder,i=this.config.decoder,s=r.model_type;(Cs.get(s)??Ps.get(s))||console.warn(`Model type for encoder '${s}' not found, assuming encoder-only architecture. Please report this at https://github.com/xenova/transformers.js/issues/new/choose.`);const o=Ls.get(i.model_type);if(!o)throw new Error(`Unable to construct \`VisionEncoderDecoder\` due to unsupported decoder: "${this.config.decoder.model_type}"`);const a=new(0,o[1])(i,{},n);this.add_encoder_pkv="num_decoder_layers"in a,this.add_encoder_pkv?(this.num_decoder_layers=a.num_decoder_layers,this.num_decoder_heads=a.num_decoder_heads,this.decoder_dim_kv=a.decoder_dim_kv,this.num_encoder_layers=a.num_encoder_layers,this.num_encoder_heads=a.num_encoder_heads,this.encoder_dim_kv=a.encoder_dim_kv):(this.num_layers=a.num_layers,this.num_heads=a.num_heads,this.dim_kv=a.dim_kv)}}class nn extends B{forward_params=["input_ids","past_key_values","pixel_values","attention_mask"];constructor(e,t,n){super(e,t),this.generation_config=n;const r=this.config.text_config;this.config.pad_token_id=r.eos_token_id,this.num_heads=r.num_attention_heads,this.num_layers=r.num_hidden_layers,this.dim_kv=r.hidden_size/this.num_heads}}class rn extends nn{async encode_image({pixel_values:e}){return(await S(this.sessions.vision_encoder,{pixel_values:e})).image_features}async encode_text({input_ids:e}){return(await S(this.sessions.embed_tokens,{input_ids:e})).inputs_embeds}_merge_input_ids_with_image_features({inputs_embeds:e,image_features:t,input_ids:n,attention_mask:r}){const i=this.config.image_token_index,s=n.tolist().map((e=>e.findIndex((e=>e==i)))),o=s.every((e=>-1===e)),a=s.every((e=>-1!==e));if(!o&&!a)throw new Error("Every input should contain either 0 or 1 image token.");if(o)return{inputs_embeds:e,attention_mask:r,position_ids:null};let l=[],d=[];for(let n=0;n<s.length;++n){const i=s[n],o=e[n],a=t[n],u=r[n];l.push((0,c.cat)([o.slice([0,i]),a,o.slice([i+1,o.dims[0]])],0)),d.push((0,c.cat)([u.slice([0,i]),(0,c.ones)([a.dims[0]]),u.slice([i+1,u.dims[0]])],0))}return{inputs_embeds:(0,c.stack)(l,0),attention_mask:(0,c.stack)(d,0),position_ids:null}}prepare_inputs_for_generation(e,t,n){return t}async forward({input_ids:e=null,attention_mask:t=null,pixel_values:n=null,position_ids:r=null,inputs_embeds:i=null,past_key_values:s=null,generation_config:o=null,logits_processor:a=null,...l}){if(!i)if(i=await this.encode_text({input_ids:e}),n&&1!==e.dims[1]){const s=await this.encode_image({pixel_values:n});({inputs_embeds:i,inputs_embeds:i,attention_mask:t,position_ids:r}=this._merge_input_ids_with_image_features({image_features:s,inputs_embeds:i,input_ids:e,attention_mask:t}))}else if(s&&n&&1===e.dims[1]){const n=e.dims[1],r=Object.values(s)[0].dims.at(-2);t=(0,c.cat)([(0,c.ones)([e.dims[0],r]),t.slice(null,[t.dims[1]-n,t.dims[1]])],1)}return await F(this,{inputs_embeds:i,past_key_values:s,attention_mask:t,generation_config:o,logits_processor:a},!0)}}class sn extends B{}class on extends sn{}class an extends sn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class ln extends sn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class dn extends B{}class un extends dn{}class cn extends dn{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class pn extends sn{static async from_pretrained(e,t={}){return t.model_file_name??="vision_model",super.from_pretrained(e,t)}}class hn extends B{}class fn extends hn{}class mn extends B{}class gn extends mn{}class _n extends mn{}class wn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class yn extends wn{}class bn extends wn{}class vn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_heads,this.num_layers=this.config.num_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class xn extends vn{}class Mn extends vn{}class Tn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class kn extends Tn{}class $n extends Tn{}class Sn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class Cn extends Sn{}class Pn extends Sn{}class En extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class An extends En{}class Fn extends En{}class In extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.n_embd/this.num_heads}}class zn extends In{}class Bn extends In{}class On extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads??this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Ln extends On{}class Dn extends On{}class Rn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads??this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Nn extends Rn{}class Vn extends Rn{}class jn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Un extends jn{}class Gn extends jn{}class qn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_head,this.num_layers=this.config.n_layer,this.dim_kv=this.config.hidden_size/this.num_heads}}class Wn extends qn{}class Hn extends qn{}class Xn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.n_heads,this.num_layers=this.config.n_layers,this.dim_kv=this.config.d_model/this.num_heads}}class Qn extends Xn{}class Kn extends Xn{}class Yn extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class Zn extends Yn{}class Jn extends Yn{}class er extends B{}class tr extends er{}class nr extends er{async _call(e){return new Io(await super._call(e))}}class rr extends B{}class ir extends rr{async _call(e){return new No(await super._call(e))}}class sr extends B{}class or extends sr{}class ar extends sr{async _call(e){return new Io(await super._call(e))}}class lr extends B{}class dr extends lr{}class ur extends lr{}class cr extends B{}class pr extends cr{}class hr extends cr{}class fr extends B{}class mr extends fr{}class gr extends fr{async _call(e){return new Io(await super._call(e))}}class _r extends B{}class wr extends _r{}class yr extends _r{async _call(e){return new vr(await super._call(e))}}class br extends _r{async _call(e){return new xr(await super._call(e))}}class vr extends O{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class xr extends O{constructor({logits:e,pred_boxes:t,pred_masks:n}){super(),this.logits=e,this.pred_boxes=t,this.pred_masks=n}}class Mr extends B{}class Tr extends Mr{}class kr extends Mr{async _call(e){return new $r(await super._call(e))}}class $r extends vr{}class Sr extends B{}class Cr extends Sr{}class Pr extends Sr{async _call(e){return new Io(await super._call(e))}}class Er extends B{}class Ar extends Er{}class Fr extends Er{async _call(e){return new Io(await super._call(e))}}class Ir extends B{}class zr extends Ir{}class Br extends Ir{async _call(e){return new Io(await super._call(e))}}class Or extends B{}class Lr extends Or{}class Dr extends Or{}class Rr extends B{}class Nr extends Rr{}class Vr extends Rr{}class jr extends B{}class Ur extends jr{}class Gr extends B{}class qr extends Gr{}class Wr extends Gr{}class Hr extends B{}class Xr extends Hr{}class Qr extends B{}class Kr extends Qr{}class Yr extends Qr{async _call(e){return new Io(await super._call(e))}}class Zr extends B{}class Jr extends Zr{}class ei extends Zr{async _call(e){return new Io(await super._call(e))}}class ti extends B{}class ni extends ti{}class ri extends ti{async _call(e){return new Io(await super._call(e))}}class ii extends B{}class si extends ii{}class oi extends ii{async _call(e){return new ai(await super._call(e))}}class ai extends O{constructor({logits:e,pred_boxes:t}){super(),this.logits=e,this.pred_boxes=t}}class li extends B{}class di extends li{async get_image_embeddings({pixel_values:e}){return await A(this,{pixel_values:e})}async forward(e){if(e.image_embeddings&&e.image_positional_embeddings||(e={...e,...await this.get_image_embeddings(e)}),!e.input_labels&&e.input_points){const t=e.input_points.dims.slice(0,-1),n=t.reduce(((e,t)=>e*t),1);e.input_labels=new c.Tensor("int64",new BigInt64Array(n).fill(1n),t)}const t={image_embeddings:e.image_embeddings,image_positional_embeddings:e.image_positional_embeddings};return e.input_points&&(t.input_points=e.input_points),e.input_labels&&(t.input_labels=e.input_labels),e.input_boxes&&(t.input_boxes=e.input_boxes),await S(this.sessions.prompt_encoder_mask_decoder,t)}async _call(e){return new ui(await super._call(e))}}class ui extends O{constructor({iou_scores:e,pred_masks:t}){super(),this.iou_scores=e,this.pred_masks=t}}class ci extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class pi extends ci{}class hi extends ci{}class fi extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.d_model/this.num_encoder_heads}}class mi extends fi{}class gi extends fi{}class _i extends B{}class wi extends _i{}class yi extends _i{async _call(e){return new Do(await super._call(e))}}class bi extends _i{async _call(e){return new Io(await super._call(e))}}class vi extends _i{async _call(e){return new Bo(await super._call(e))}}class xi extends B{}class Mi extends xi{}class Ti extends xi{async _call(e){return new Do(await super._call(e))}}class ki extends xi{async _call(e){return new Io(await super._call(e))}}class $i extends B{}class Si extends $i{}class Ci extends $i{async _call(e){return new Do(await super._call(e))}}class Pi extends $i{async _call(e){return new Io(await super._call(e))}}class Ei extends $i{async _call(e){return new Bo(await super._call(e))}}class Ai extends B{}class Fi extends Ai{}class Ii extends Ai{async _call(e){return new Do(await super._call(e))}}class zi extends Ai{async _call(e){return new Io(await super._call(e))}}class Bi extends B{}class Oi extends _i{}class Li extends _i{async _call(e){return new Do(await super._call(e))}}class Di extends _i{async _call(e){return new Io(await super._call(e))}}class Ri extends B{}class Ni extends Ri{}class Vi extends Ri{async _call(e){return new Do(await super._call(e))}}class ji extends Ri{async _call(e){return new Io(await super._call(e))}}class Ui extends Ri{async _call(e){return new zo(await super._call(e))}}class Gi extends Ri{async _call(e){return new Bo(await super._call(e))}}class qi extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_decoder_layers=this.config.decoder_layers,this.num_decoder_heads=this.config.decoder_attention_heads,this.decoder_dim_kv=this.config.hidden_size/this.num_decoder_heads,this.num_encoder_layers=this.config.encoder_layers,this.num_encoder_heads=this.config.encoder_attention_heads,this.encoder_dim_kv=this.config.hidden_size/this.num_encoder_heads}}class Wi extends qi{}class Hi extends qi{}class Xi extends qi{async generate_speech(e,t,{threshold:n=.5,minlenratio:r=0,maxlenratio:i=20,vocoder:s=null}={}){const o={input_ids:e},{encoder_outputs:a,encoder_attention_mask:l}=await A(this,o),d=a.dims[1]/this.config.reduction_factor,u=Math.floor(d*i),p=Math.floor(d*r),h=this.config.num_mel_bins;let f=[],m=null,g=null,_=0;for(;;){++_;const e=P(!!g);let r;r=g?g.output_sequence_out:new c.Tensor("float32",new Float32Array(h),[1,1,h]);let i={use_cache_branch:e,output_sequence:r,encoder_attention_mask:l,speaker_embeddings:t,encoder_hidden_states:a};this.addPastKeyValues(i,m),g=await S(this.sessions.decoder_model_merged,i),m=this.getPastKeyValues(g,m);const{prob:s,spectrum:o}=g;if(f.push(o),_>=p&&(Array.from(s.data).filter((e=>e>=n)).length>0||_>=u))break}const w=(0,c.cat)(f),{waveform:y}=await S(s.sessions.model,{spectrogram:w});return{spectrogram:w,waveform:y}}}class Qi extends B{main_input_name="spectrogram"}class Ki extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_encoder_layers=this.num_decoder_layers=this.config.decoder_layers,this.num_encoder_heads=this.num_decoder_heads=this.config.decoder_attention_heads,this.encoder_dim_kv=this.decoder_dim_kv=this.config.d_model/this.num_decoder_heads}}class Yi extends Ki{}class Zi extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class Ji extends Zi{}class es extends Zi{}class ts extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_key_value_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class ns extends ts{}class rs extends ts{}class is extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.config.num_attention_heads}}class ss extends is{}class os extends is{}class as extends B{}class ls extends as{}class ds extends as{static async from_pretrained(e,t={}){return t.model_file_name??="text_model",super.from_pretrained(e,t)}}class us extends as{static async from_pretrained(e,t={}){return t.model_file_name??="audio_model",super.from_pretrained(e,t)}}class cs extends B{}class ps extends cs{async _call(e){return new Vo(await super._call(e))}}class hs extends B{}class fs extends hs{}class ms extends hs{}class gs extends hs{}class _s extends B{constructor(e,t,n){super(e,t),this.generation_config=n,this.num_heads=this.config.num_attention_heads,this.num_layers=this.config.num_hidden_layers,this.dim_kv=this.config.hidden_size/this.num_heads}}class ws extends _s{}class ys extends _s{}class bs extends B{}class vs extends bs{}class xs extends bs{async _call(e){return new Io(await super._call(e))}}class Ms extends B{}class Ts extends Ms{}class ks extends Ms{}class $s extends B{forward_params=["input_ids","attention_mask","encoder_outputs","decoder_input_ids","decoder_attention_mask","past_key_values"];constructor(e,t,n){super(e,t),this.generation_config=n;const r=e.decoder;this.num_encoder_layers=this.num_decoder_layers=r.num_hidden_layers,this.num_encoder_heads=this.num_decoder_heads=r.num_attention_heads,this.encoder_dim_kv=this.decoder_dim_kv=r.hidden_size/this.num_decoder_heads}_apply_and_filter_by_delay_pattern_mask(e){const[t,n]=e.dims,r=this.config.decoder.num_codebooks,i=n-r;let s=0;for(let t=0;t<e.size;++t){if(e.data[t]===this.config.decoder.pad_token_id)continue;const o=t%n-Math.floor(t/n)%r;o>0&&o<=i&&(e.data[s++]=e.data[t])}const o=Math.floor(t/r),a=s/(o*r);return new c.Tensor(e.type,e.data.slice(0,s),[o,r,a])}prepare_inputs_for_generation(e,t,n){let r=structuredClone(e);for(let e=0;e<r.length;++e)for(let t=0;t<r[e].length;++t)e%this.config.decoder.num_codebooks>=t&&(r[e][t]=BigInt(this.config.decoder.pad_token_id));null!==n.guidance_scale&&n.guidance_scale>1&&(r=r.concat(r));return super.prepare_inputs_for_generation(r,t,n)}async generate(e){const t=await super.generate(e),n=this._apply_and_filter_by_delay_pattern_mask(t).unsqueeze_(0),{audio_values:r}=await S(this.sessions.encodec_decode,{audio_codes:n});return r}}class Ss{static MODEL_CLASS_MAPPINGS=null;static BASE_IF_FAIL=!1;static async from_pretrained(e,{progress_callback:t=null,config:n=null,cache_dir:i=null,local_files_only:s=!1,revision:o="main",model_file_name:a=null,subfolder:l="onnx",device:d=null,dtype:u=null,session_options:c={}}={}){let p={progress_callback:t,config:n,cache_dir:i,local_files_only:s,revision:o,model_file_name:a,subfolder:l,device:d,dtype:u,session_options:c};if(n=await r.AutoConfig.from_pretrained(e,p),p.config||(p.config=n),!this.MODEL_CLASS_MAPPINGS)throw new Error("`MODEL_CLASS_MAPPINGS` not implemented for this type of `AutoClass`: "+this.name);for(let t of this.MODEL_CLASS_MAPPINGS){const r=t.get(n.model_type);if(r)return await r[1].from_pretrained(e,p)}if(this.BASE_IF_FAIL)return console.warn(`Unknown model class "${n.model_type}", attempting to construct from base class.`),await B.from_pretrained(e,p);throw Error(`Unsupported model type: ${n.model_type}`)}}const Cs=new Map([["bert",["BertModel",R]],["nomic_bert",["NomicBertModel",q]],["roformer",["RoFormerModel",H]],["electra",["ElectraModel",se]],["esm",["EsmModel",Be]],["convbert",["ConvBertModel",J]],["camembert",["CamembertModel",ce]],["deberta",["DebertaModel",_e]],["deberta-v2",["DebertaV2Model",Me]],["mpnet",["MPNetModel",qe]],["albert",["AlbertModel",nt]],["distilbert",["DistilBertModel",Pe]],["roberta",["RobertaModel",At]],["xlm",["XLMModel",Lt]],["xlm-roberta",["XLMRobertaModel",Ut]],["clap",["ClapModel",ls]],["clip",["CLIPModel",on]],["clipseg",["CLIPSegModel",gn]],["chinese_clip",["ChineseCLIPModel",fn]],["siglip",["SiglipModel",un]],["mobilebert",["MobileBertModel",Ne]],["squeezebert",["SqueezeBertModel",Ye]],["wav2vec2",["Wav2Vec2Model",wi]],["wav2vec2-bert",["Wav2Vec2BertModel",Fi]],["unispeech",["UniSpeechModel",Mi]],["unispeech-sat",["UniSpeechSatModel",Si]],["hubert",["HubertModel",Oi]],["wavlm",["WavLMModel",Ni]],["audio-spectrogram-transformer",["ASTModel",Qt]],["vits",["VitsModel",ps]],["detr",["DetrModel",wr]],["table-transformer",["TableTransformerModel",Tr]],["vit",["ViTModel",tr]],["mobilevit",["MobileViTModel",or]],["owlvit",["OwlViTModel",dr]],["owlv2",["Owlv2Model",pr]],["beit",["BeitModel",mr]],["deit",["DeiTModel",Cr]],["convnext",["ConvNextModel",Kr]],["convnextv2",["ConvNextV2Model",Jr]],["dinov2",["Dinov2Model",ni]],["resnet",["ResNetModel",Ar]],["swin",["SwinModel",zr]],["swin2sr",["Swin2SRModel",Lr]],["donut-swin",["DonutSwinModel",Xr]],["yolos",["YolosModel",si]],["dpt",["DPTModel",Nr]],["glpn",["GLPNModel",qr]],["hifigan",["SpeechT5HifiGan",Qi]],["efficientnet",["EfficientNetModel",vs]]]),Ps=new Map([["t5",["T5Model",at]],["longt5",["LongT5Model",ut]],["mt5",["MT5Model",ht]],["bart",["BartModel",gt]],["mbart",["MBartModel",bt]],["marian",["MarianModel",pi]],["whisper",["WhisperModel",Zt]],["m2m_100",["M2M100Model",mi]],["blenderbot",["BlenderbotModel",kt]],["blenderbot-small",["BlenderbotSmallModel",Ct]]]),Es=new Map([["bloom",["BloomModel",Wn]],["gpt2",["GPT2Model",yn]],["gptj",["GPTJModel",Cn]],["gpt_bigcode",["GPTBigCodeModel",An]],["gpt_neo",["GPTNeoModel",xn]],["gpt_neox",["GPTNeoXModel",kn]],["codegen",["CodeGenModel",zn]],["llama",["LlamaModel",Ln]],["qwen2",["Qwen2Model",Nn]],["phi",["PhiModel",Un]],["mpt",["MptModel",Qn]],["opt",["OPTModel",Zn]],["mistral",["MistralModel",Ji]],["starcoder2",["Starcoder2Model",ns]],["falcon",["FalconModel",ss]]]),As=new Map([["speecht5",["SpeechT5ForSpeechToText",Hi]],["whisper",["WhisperForConditionalGeneration",en]]]),Fs=new Map([["speecht5",["SpeechT5ForTextToSpeech",Xi]]]),Is=new Map([["vits",["VitsModel",ps]],["musicgen",["MusicgenForConditionalGeneration",$s]]]),zs=new Map([["bert",["BertForSequenceClassification",V]],["roformer",["RoFormerForSequenceClassification",Q]],["electra",["ElectraForSequenceClassification",ae]],["esm",["EsmForSequenceClassification",Le]],["convbert",["ConvBertForSequenceClassification",te]],["camembert",["CamembertForSequenceClassification",he]],["deberta",["DebertaForSequenceClassification",ye]],["deberta-v2",["DebertaV2ForSequenceClassification",ke]],["mpnet",["MPNetForSequenceClassification",He]],["albert",["AlbertForSequenceClassification",rt]],["distilbert",["DistilBertForSequenceClassification",Ee]],["roberta",["RobertaForSequenceClassification",It]],["xlm",["XLMForSequenceClassification",Rt]],["xlm-roberta",["XLMRobertaForSequenceClassification",qt]],["bart",["BartForSequenceClassification",wt]],["mbart",["MBartForSequenceClassification",xt]],["mobilebert",["MobileBertForSequenceClassification",je]],["squeezebert",["SqueezeBertForSequenceClassification",Je]]]),Bs=new Map([["bert",["BertForTokenClassification",j]],["roformer",["RoFormerForTokenClassification",K]],["electra",["ElectraForTokenClassification",le]],["esm",["EsmForTokenClassification",De]],["convbert",["ConvBertForTokenClassification",ne]],["camembert",["CamembertForTokenClassification",fe]],["deberta",["DebertaForTokenClassification",be]],["deberta-v2",["DebertaV2ForTokenClassification",$e]],["mpnet",["MPNetForTokenClassification",Xe]],["distilbert",["DistilBertForTokenClassification",Ae]],["roberta",["RobertaForTokenClassification",zt]],["xlm",["XLMForTokenClassification",Nt]],["xlm-roberta",["XLMRobertaForTokenClassification",Wt]]]),Os=new Map([["t5",["T5ForConditionalGeneration",lt]],["longt5",["LongT5ForConditionalGeneration",ct]],["mt5",["MT5ForConditionalGeneration",ft]],["bart",["BartForConditionalGeneration",_t]],["mbart",["MBartForConditionalGeneration",vt]],["marian",["MarianMTModel",hi]],["m2m_100",["M2M100ForConditionalGeneration",gi]],["blenderbot",["BlenderbotForConditionalGeneration",$t]],["blenderbot-small",["BlenderbotSmallForConditionalGeneration",Pt]]]),Ls=new Map([["bloom",["BloomForCausalLM",Hn]],["gpt2",["GPT2LMHeadModel",bn]],["gptj",["GPTJForCausalLM",Pn]],["gpt_bigcode",["GPTBigCodeForCausalLM",Fn]],["gpt_neo",["GPTNeoForCausalLM",Mn]],["gpt_neox",["GPTNeoXForCausalLM",$n]],["codegen",["CodeGenForCausalLM",Bn]],["llama",["LlamaForCausalLM",Dn]],["qwen2",["Qwen2ForCausalLM",Vn]],["phi",["PhiForCausalLM",Gn]],["mpt",["MptForCausalLM",Kn]],["opt",["OPTForCausalLM",Jn]],["mbart",["MBartForCausalLM",Mt]],["mistral",["MistralForCausalLM",es]],["starcoder2",["Starcoder2ForCausalLM",rs]],["falcon",["FalconForCausalLM",os]],["trocr",["TrOCRForCausalLM",Yi]],["stablelm",["StableLmForCausalLM",ys]]]),Ds=new Map([["bert",["BertForMaskedLM",N]],["roformer",["RoFormerForMaskedLM",X]],["electra",["ElectraForMaskedLM",oe]],["esm",["EsmForMaskedLM",Oe]],["convbert",["ConvBertForMaskedLM",ee]],["camembert",["CamembertForMaskedLM",pe]],["deberta",["DebertaForMaskedLM",we]],["deberta-v2",["DebertaV2ForMaskedLM",Te]],["mpnet",["MPNetForMaskedLM",We]],["albert",["AlbertForMaskedLM",st]],["distilbert",["DistilBertForMaskedLM",Ie]],["roberta",["RobertaForMaskedLM",Ft]],["xlm",["XLMWithLMHeadModel",Dt]],["xlm-roberta",["XLMRobertaForMaskedLM",Gt]],["mobilebert",["MobileBertForMaskedLM",Ve]],["squeezebert",["SqueezeBertForMaskedLM",Ze]]]),Rs=new Map([["bert",["BertForQuestionAnswering",U]],["roformer",["RoFormerForQuestionAnswering",Y]],["electra",["ElectraForQuestionAnswering",de]],["convbert",["ConvBertForQuestionAnswering",re]],["camembert",["CamembertForQuestionAnswering",me]],["deberta",["DebertaForQuestionAnswering",ve]],["deberta-v2",["DebertaV2ForQuestionAnswering",Se]],["mpnet",["MPNetForQuestionAnswering",Qe]],["albert",["AlbertForQuestionAnswering",it]],["distilbert",["DistilBertForQuestionAnswering",Fe]],["roberta",["RobertaForQuestionAnswering",Bt]],["xlm",["XLMForQuestionAnswering",Vt]],["xlm-roberta",["XLMRobertaForQuestionAnswering",Ht]],["mobilebert",["MobileBertForQuestionAnswering",Ue]],["squeezebert",["SqueezeBertForQuestionAnswering",et]]]),Ns=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",tn]]]),Vs=new Map([["llava",["LlavaForConditionalGeneration",rn]]]),js=new Map([["vision-encoder-decoder",["VisionEncoderDecoderModel",tn]]]),Us=new Map([["vit",["ViTForImageClassification",nr]],["mobilevit",["MobileViTForImageClassification",ar]],["beit",["BeitForImageClassification",gr]],["deit",["DeiTForImageClassification",Pr]],["convnext",["ConvNextForImageClassification",Yr]],["convnextv2",["ConvNextV2ForImageClassification",ei]],["dinov2",["Dinov2ForImageClassification",ri]],["resnet",["ResNetForImageClassification",Fr]],["swin",["SwinForImageClassification",Br]],["segformer",["SegformerForImageClassification",ms]],["efficientnet",["EfficientNetForImageClassification",xs]]]),Gs=new Map([["detr",["DetrForObjectDetection",yr]],["table-transformer",["TableTransformerForObjectDetection",kr]],["yolos",["YolosForObjectDetection",oi]]]),qs=new Map([["owlvit",["OwlViTForObjectDetection",ur]],["owlv2",["Owlv2ForObjectDetection",hr]]]),Ws=new Map([["detr",["DetrForSegmentation",br]],["clipseg",["CLIPSegForImageSegmentation",_n]]]),Hs=new Map([["segformer",["SegformerForSemanticSegmentation",gs]]]),Xs=new Map([["sam",["SamModel",di]]]),Qs=new Map([["wav2vec2",["Wav2Vec2ForCTC",yi]],["wav2vec2-bert",["Wav2Vec2BertForCTC",Ii]],["unispeech",["UniSpeechForCTC",Ti]],["unispeech-sat",["UniSpeechSatForCTC",Ci]],["wavlm",["WavLMForCTC",Vi]],["hubert",["HubertForCTC",Li]]]),Ks=new Map([["wav2vec2",["Wav2Vec2ForSequenceClassification",bi]],["wav2vec2-bert",["Wav2Vec2BertForSequenceClassification",zi]],["unispeech",["UniSpeechForSequenceClassification",ki]],["unispeech-sat",["UniSpeechSatForSequenceClassification",Pi]],["wavlm",["WavLMForSequenceClassification",ji]],["hubert",["HubertForSequenceClassification",Di]],["audio-spectrogram-transformer",["ASTForAudioClassification",Kt]]]),Ys=new Map([["wavlm",["WavLMForXVector",Ui]]]),Zs=new Map([["unispeech-sat",["UniSpeechSatForAudioFrameClassification",Ei]],["wavlm",["WavLMForAudioFrameClassification",Gi]],["wav2vec2",["Wav2Vec2ForAudioFrameClassification",vi]]]),Js=new Map([["vitmatte",["VitMatteForImageMatting",ir]]]),eo=new Map([["swin2sr",["Swin2SRForImageSuperResolution",Dr]]]),to=new Map([["dpt",["DPTForDepthEstimation",Vr]],["depth_anything",["DepthAnythingForDepthEstimation",Ur]],["glpn",["GLPNForDepthEstimation",Wr]]]),no=new Map([["clip",["CLIPVisionModelWithProjection",ln]],["siglip",["SiglipVisionModel",pn]]]),ro=[[Cs,m],[Ps,g],[Es,y],[zs,m],[Bs,m],[Os,_],[As,_],[Ls,y],[Ds,m],[Rs,m],[Ns,w],[Vs,v],[Us,m],[Ws,m],[Hs,m],[Js,m],[eo,m],[to,m],[Gs,m],[qs,m],[Xs,b],[Qs,m],[Ks,m],[Fs,_],[Is,m],[Ys,m],[Zs,m],[no,m]];for(const[e,t]of ro)for(const[n,r]of e.values())M.set(n,t),k.set(r,n),T.set(n,r);const io=[["MusicgenForConditionalGeneration",$s,x],["CLIPTextModelWithProjection",an,m],["SiglipTextModel",cn,m],["ClapTextModelWithProjection",ds,m],["ClapAudioModelWithProjection",us,m]];for(const[e,t,n]of io)M.set(e,n),k.set(t,e),T.set(e,t);class so extends Ss{static MODEL_CLASS_MAPPINGS=ro.map((e=>e[0]));static BASE_IF_FAIL=!0}class oo extends Ss{static MODEL_CLASS_MAPPINGS=[zs]}class ao extends Ss{static MODEL_CLASS_MAPPINGS=[Bs]}class lo extends Ss{static MODEL_CLASS_MAPPINGS=[Os]}class uo extends Ss{static MODEL_CLASS_MAPPINGS=[As]}class co extends Ss{static MODEL_CLASS_MAPPINGS=[Fs]}class po extends Ss{static MODEL_CLASS_MAPPINGS=[Is]}class ho extends Ss{static MODEL_CLASS_MAPPINGS=[Ls]}class fo extends Ss{static MODEL_CLASS_MAPPINGS=[Ds]}class mo extends Ss{static MODEL_CLASS_MAPPINGS=[Rs]}class go extends Ss{static MODEL_CLASS_MAPPINGS=[Ns]}class _o extends Ss{static MODEL_CLASS_MAPPINGS=[Us]}class wo extends Ss{static MODEL_CLASS_MAPPINGS=[Ws]}class yo extends Ss{static MODEL_CLASS_MAPPINGS=[Hs]}class bo extends Ss{static MODEL_CLASS_MAPPINGS=[Gs]}class vo extends Ss{static MODEL_CLASS_MAPPINGS=[qs]}class xo extends Ss{static MODEL_CLASS_MAPPINGS=[Xs]}class Mo extends Ss{static MODEL_CLASS_MAPPINGS=[Qs]}class To extends Ss{static MODEL_CLASS_MAPPINGS=[Ks]}class ko extends Ss{static MODEL_CLASS_MAPPINGS=[Ys]}class $o extends Ss{static MODEL_CLASS_MAPPINGS=[Zs]}class So extends Ss{static MODEL_CLASS_MAPPINGS=[js]}class Co extends Ss{static MODEL_CLASS_MAPPINGS=[Js]}class Po extends Ss{static MODEL_CLASS_MAPPINGS=[eo]}class Eo extends Ss{static MODEL_CLASS_MAPPINGS=[to]}class Ao extends Ss{static MODEL_CLASS_MAPPINGS=[no]}class Fo extends O{constructor({logits:e,past_key_values:t,encoder_outputs:n,decoder_attentions:r=null,cross_attentions:i=null}){super(),this.logits=e,this.past_key_values=t,this.encoder_outputs=n,this.decoder_attentions=r,this.cross_attentions=i}}class Io extends O{constructor({logits:e}){super(),this.logits=e}}class zo extends O{constructor({logits:e,embeddings:t}){super(),this.logits=e,this.embeddings=t}}class Bo extends O{constructor({logits:e}){super(),this.logits=e}}class Oo extends O{constructor({logits:e}){super(),this.logits=e}}class Lo extends O{constructor({start_logits:e,end_logits:t}){super(),this.start_logits=e,this.end_logits=t}}class Do extends O{constructor({logits:e}){super(),this.logits=e}}class Ro extends O{constructor({logits:e,past_key_values:t}){super(),this.logits=e,this.past_key_values=t}}class No extends O{constructor({alphas:e}){super(),this.alphas=e}}class Vo extends O{constructor({waveform:e,spectrogram:t}){super(),this.waveform=e,this.spectrogram=t}}},"./src/ops/registry.js":
/*!*****************************!*\
  !*** ./src/ops/registry.js ***!
